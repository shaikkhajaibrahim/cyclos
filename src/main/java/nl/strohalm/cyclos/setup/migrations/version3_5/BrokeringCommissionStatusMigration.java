...
public class BrokeringCommissionStatusMigration implements UntraceableMigration {
    ...
    public void execute(final JDBCWrapper jdbc) throws SQLException {
        final String selectBrokerCommissions = "select id, when_apply, when_count from transaction_fees where subclass = 'B'";
        ...
        final String insertBrokeringCommissionStatus = "insert into brokering_commission_status (brokering_id, broker_commission_id, start_date, end_date, expiry_date, total_count, total_amount) values (?, ?, ?, ?, ?, ?, ?)";
        ...
        while (rsBrokerCommissions.next()) {
            ...
            while (rsBrokerings.next()) {
                ...
                final Object[] brokeringCommissionStatusParams = new Object[] { brokeringId, brokerCommissionId, brokeringStartDate, brokeringCommissionEndDate, expiryDate, count, amount };
