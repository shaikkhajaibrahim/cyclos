...
public class Setup {
    ...
    public static void main(final String... args) throws IOException {
        ...
        setup.configuration = (Configuration) applicationContext.getBean("configuration");
        setup.sessionFactory = (SessionFactory) applicationContext.getBean("sessionFactory");
        setup.execute();
        System.exit(0);
    }
