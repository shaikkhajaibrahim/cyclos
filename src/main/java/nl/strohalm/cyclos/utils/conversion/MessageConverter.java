 ...
 * @author luis
 */
public class MessageConverter implements Converter<Object> {
    ...
    public Object valueOf(final String string) {
        throw new IllegalStateException("MessageConverter cannot parse a string");
    }
}
