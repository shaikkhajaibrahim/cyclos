 ...
 * @author luis
 */
public class CollectionCountConverter implements Converter<Collection<?>> {
    ...
    public Collection<?> valueOf(final String string) {
        throw new IllegalStateException("The CollectionCountConverter cannot parse an object");
    }
