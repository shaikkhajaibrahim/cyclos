 ...
 * @author luis
 */
public class CustomFieldConverter implements Converter<Collection<? extends CustomFieldValue>> {
    ...
    public Collection<? extends CustomFieldValue> valueOf(final String string) {
        throw new IllegalStateException("The CustomFieldConverter cannot parse an object");
    }
}
