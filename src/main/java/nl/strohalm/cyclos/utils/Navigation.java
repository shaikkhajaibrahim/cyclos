...
public class Navigation implements Serializable {
    ...
    /**
     * Find the navigation in the session
     */
    public static Navigation find(final HttpSession session) {
        return (Navigation) session.getAttribute(NAVIGATION_KEY);
    }

    private final LinkedList<ActionMapping> paths = new LinkedList<ActionMapping>();
    private ActionMapping                   lastAction;

    public Navigation(final HttpSession session) {
        session.setAttribute(NAVIGATION_KEY, this);
    }
