...
public class FormatObject {
    ...
    static {
        INTEGER_FORMAT = new DecimalFormat("#,##0", new DecimalFormatSymbols(Locale.getDefault()));
        FLOAT_FORMAT = new DecimalFormat("#,##0.00", new DecimalFormatSymbols(Locale.getDefault()));
    ...
    public static String formatVO(final Object vo) {
        return formatVO(vo, "password", "transactionPassword", "pin");
    }
