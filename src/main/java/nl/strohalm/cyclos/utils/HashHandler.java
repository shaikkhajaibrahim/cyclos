 ...
 * @author luis
 */
public class HashHandler implements InitializingBean {
    ...
    public HashHandler() {
        passwordHash = PasswordHash.SHA2_SALT;
    }

    public HashHandler(final PasswordHash passwordHash) {
        this.passwordHash = passwordHash;
    }

    public void afterPropertiesSet() throws Exception {
        passwordHash = applicationService.getPasswordHash();
    }
    ...
    public String newSalt() {
        if (passwordHash != PasswordHash.SHA2_SALT) {
            return null;
        }
