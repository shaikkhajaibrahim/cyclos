...
/**
 * Wrapper arround an entity with custom fields, allowing, through a Map interface, access to properties and custom fields
 */
public class EntityWithCustomFieldsWrapper extends AbstractMap<String, Object> {
    ...
    private final EntityWithCustomFields<?, ?>      entity;
    private Set<Map.Entry<String, Object>>          cachedEntrySet;

    public EntityWithCustomFieldsWrapper(final EntityWithCustomFields<?, ?> entity, final Collection<? extends CustomField> customFields) {
        this.entity = entity;
    ...
    private Set<Map.Entry<String, Object>> createEntrySet() {
        ...
        final Collection<String> basicProperties = EntityHelper.propertyNamesFor(entity);
    ...
    private Map<String, String> resolveCustomValues() {
        if (cachedCustomValues == null) {
            cachedCustomValues = EntityHelper.getFields(entity);
        }
