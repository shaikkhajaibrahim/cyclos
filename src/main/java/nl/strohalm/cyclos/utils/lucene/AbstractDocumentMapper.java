...
public abstract class AbstractDocumentMapper<E extends Entity & Indexable> implements DocumentMapper {
    ...
    public final Document map(final Indexable indexable) {
        ...
        final DocumentBuilder document = new DocumentBuilder();
    ...
    /**
     * Fetches the given entity, returning the implementation, not the proxy
     */
    @SuppressWarnings("unchecked")
    protected <T extends Entity> T fetch(final Entity entity) {
        return (T) (entity == null ? null : fetchDao.fetch(entity));
    }
