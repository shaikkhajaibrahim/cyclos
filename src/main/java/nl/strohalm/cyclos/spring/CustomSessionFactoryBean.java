...
/**
 * Custom session factory bean used to setup Hibernate, as well as Hibernate Search (integration with Lucene)
 * @author luis
 */
public class CustomSessionFactoryBean extends LocalSessionFactoryBean {
    ...
    protected SessionFactory newSessionFactory(final Configuration config) throws HibernateException {
        ...
        final DataBaseConfiguration dataBaseConfiguration = new DataBaseConfiguration(config);
