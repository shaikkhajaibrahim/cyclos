...
/**
 * Notifies the cyclos model about the context shutdown
 * @author luis
 */
public class ApplicationShutdown implements ContextFinalization {
    ...
    public void destroy(final ServletContext context) {
        if (applicationService != null) {
            ...
            context.log(settings.getApplicationName() + " shutdown");
        }
    }
