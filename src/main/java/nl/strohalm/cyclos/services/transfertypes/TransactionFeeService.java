...
public interface TransactionFeeService extends Service {
     ...
     * @return A Map where the key is the transaction fee and the value is the fee amount
     */
     ...
     */
    TransactionFeePreviewDTO preview(AccountOwner from, AccountOwner to, TransferType transferType, BigDecimal amount, BigDecimal aRate, BigDecimal dRate);
