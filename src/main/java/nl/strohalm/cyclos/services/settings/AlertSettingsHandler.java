 ...
 * @author luis
 */
public class AlertSettingsHandler extends BaseSettingsHandler<AlertSettings> {
    ...
    protected Map<String, Converter<?>> createConverters() {
        ...
        alertConverters.put("alertNewPendingMembers", CoercionConverter.instance(Boolean.TYPE));
