 ...
 * @author luis
 */
public class AccessSettingsHandler extends BaseSettingsHandler<AccessSettings> {
    ...
    protected Validator createValidator() {
        ...
        accessValidator.property("usernameLength.min").required().between(1, 10);
        accessValidator.property("usernameLength.max").required().between(3, 30);
        accessValidator.property("adminTimeout.number").between(0, 999);
        accessValidator.property("adminTimeout.field").required();
        accessValidator.property("usernameGeneration").required();
        accessValidator.property("generatedUsernameLength").between(3, 30);
        accessValidator.property("memberTimeout.number").between(0, 999);
        accessValidator.property("memberTimeout.field").required();
        accessValidator.property("poswebTimeout.number").between(0, 999);
        accessValidator.property("poswebTimeout.field").required();
