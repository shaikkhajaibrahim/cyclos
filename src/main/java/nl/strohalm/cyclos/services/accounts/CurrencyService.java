...
public interface CurrencyService extends Service {
     ...
     */
    @AdminAction(@Permission(module = "systemCurrencies", operation = "view"))
    Currency load(Long id, Relationship... fetch);
     ...
     */
    @AdminAction(@Permission(module = "systemCurrencies", operation = "manage"))
    int remove(Long... ids);
     ...
     */
    @AdminAction(@Permission(module = "systemCurrencies", operation = "manage"))
    Currency save(Currency currency, boolean enableARate, boolean enableDRate);

    /**
     * Validate the specified currency
     */
    @DontEnforcePermission(traceable = true)
    void validate(Currency currency, boolean enableARate, boolean enableDRate);
