...
public interface StatisticalActivityService extends StatisticalService {
    ...
    /**
     * Get the number of members in a group according to a period (member historical search in groups)
     * @param queryParameters
     * @return an int representing the number members in groups in a period.
     */
    Map<String, Integer> getNumberOfMembersPerGroupPerPeriod(StatisticalActivityQuery queryParameters);
