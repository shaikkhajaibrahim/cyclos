...
public class LoginTimesPerMemberStats extends MemberStats {

    private final LoginHistoryDAO loginHistoryDao;

    public LoginTimesPerMemberStats(final StatisticalActivityQuery queryParameters, final Period period, final LoginHistoryDAO loginHistoryDao, final ElementDAO elementDao) {
    ...
    /**
     * gets a list with <code>Pair</code>s, where the first element of each pair is the member id, and the second element is the number of times
     * that member logged in.
    ...
    /**
     * gets a list with <code>Pair</code>s, where the first element of each pair is the member id, and the second element is the number of times
     * that member logged in. Same as <code>getLoginTimesPerMember</code> except that this list has the zero results skipped, as needed by the top
     * ten.
     * @return a list with member id's and login times.
     */
