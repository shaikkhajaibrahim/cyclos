...
public class MessageSettings extends DataObject {
    ...
    public enum MessageSettingsEnum {
        ...
        LOAN_EXPIRATION(MessageSettingsCategoryEnum.MEMBER,
                "Loan has expired",
                "A loan granted at #grantDate# (#amount#) has expired.<br>#link# for more details",
                "A loan granted at #grantDate# (#amount#) has expired"),
        ...
        EXTERNAL_CHANNEL_PAYMENT_REQUEST_EXPIRED_PAYER(MessageSettingsCategoryEnum.MEMBER,
                ...
                "The #channel# payment of #amount# requested by #toMemberName# (#toMemberUsername#) has expired.<br>#link# for more details",
                "The #channel# payment of #amount# requested by #toMemberUsername# has expired"),

        EXTERNAL_CHANNEL_PAYMENT_REQUEST_EXPIRED_RECEIVER(MessageSettingsCategoryEnum.MEMBER,
                "External channel payment request expired",
                "The #channel# payment of #amount# you requested to #fromMemberName# (#fromMemberUsername#) has expired.<br>#link# for more details",
                "The #channel# payment of #amount# you requested to #fromMemberUsername# has expired"),
        ...
        CERTIFICATION_ISSUED(MessageSettingsCategoryEnum.MEMBER,
                ...
                "A new certification of #amount# was issued by #issuerName# (#issuerUsername#).<br>#link# for more details",
                "A new certification of #amount# was issued by #issuerUsername#"),

        CERTIFICATION_STATUS_CHANGED(MessageSettingsCategoryEnum.MEMBER,
                "The status of a certification has changed",
                "The status of the certification of #amount# issued by #issuerName# (#issuerUsername#) has changed to \"#status#\".<br>#link# for more details",
                "The status of the certification of #amount# issued by #issuerUsername# has changed to \"#status#\"."),

        EXPIRED_CERTIFICATION(MessageSettingsCategoryEnum.MEMBER,
                "A certification has expired",
                "The certification of #amount# issued to #buyerName# (#buyerUsername#) has expired.<br>#link# for more details",
                "The certification of #amount# issued to #buyerUsername# has expired."),

        EXPIRED_GUARANTEE(MessageSettingsCategoryEnum.MEMBER,
                "A guarantee has expired",
                "The guarantee of #amount# issued to #buyerName# (#buyerUsername#) has expired.<br>#link# for more details",
                "The guarantee of #amount# issued to #buyerUsername# has expired."),

        BUYER_ONLY_GUARANTEE_STATUS_CHANGED(MessageSettingsCategoryEnum.MEMBER,
                "The status of a guarantee has changed",
                "The status of the guarantee of #amount# issued by #issuerName# (#issuerUsername#) has changed to \"#status#\".<br>#link# for more details",
                "The status of the guarantee of #amount# issued by #issuerUsername# has changed to \"#status#\"."),

        GUARANTEE_STATUS_CHANGED(MessageSettingsCategoryEnum.MEMBER,
                "The status of a guarantee has changed",
                "The status of the guarantee of #amount# has changed to \"#status#\".<br>Issuer: #issuerName# (#issuerUsername#)<br>Buyer: #buyerName# (#buyerUsername#)<br>Seller: #sellerName# (#sellerUsername#)<br>#link# for more details",
                "The status of the guarantee of #amount# has changed to \"#status#\". issuer: #issuerUsername#, buyer: #buyerUsername#, seller: #sellerUsername#"),

        PENDING_BUYER_ONLY_GUARANTEE_ISSUER(MessageSettingsCategoryEnum.MEMBER,
                "New pending guarantee awaiting authorization",
                "A new guarantee was requested and is awaiting your authorization.<br>Buyer: #buyerName# (#buyerUsername#)<br>Amount: #amount#<br>#link# for more details",
                "A new guarantee was requested and is awaiting your authorization. Buyer: #buyerUsername#, amount: #amount#"),

        PENDING_GUARANTEE_ISSUER(MessageSettingsCategoryEnum.MEMBER,
                "New pending guarantee awaiting authorization",
                "A new guarantee was requested and is awaiting your authorization.<br>Buyer: #buyerName# (#buyerUsername#)<br>Seller: #sellerName# (#sellerUsername#)<br>Amount: #amount#<br>#link# for more details",
                "A new guarantee was requested and is awaiting your authorization. Buyer: #buyerUsername#, seller: #sellerUsername#, amount: #amount#"),

        PAYMENT_OBLIGATION_REGISTERED(MessageSettingsCategoryEnum.MEMBER,
                "A new payment obligation was issued",
                "A new payment obligation of #amount# was issued by #buyerName# (#buyerUsername#).<br>#link# for more details",
                "A new payment obligation of #amount# was issued by #buyerUsername#"),

        PAYMENT_OBLIGATION_REJECTED(MessageSettingsCategoryEnum.MEMBER,
                "A payment obligation was rejected",
                "The payment obligation of #amount# was rejected by #sellerName# (#sellerUsername#). <br>#link# for more details",
                "The payment obligation of #amount# was rejected by #sellerUsername#."),

        ADMIN_PENDING_BUYER_ONLY_GUARANTEE(MessageSettingsCategoryEnum.ADMIN,
                "New pending guarantee awaiting authorization",
                "A new guarantee was requested and is awaiting authorization.<br>Issuer: #issuerName# (#issuerUsername#)<br>Buyer: #buyerName# (#buyerUsername#)<br>Amount: #amount#<br>#link# for more details"),

        ADMIN_PENDING_GUARANTEE(MessageSettingsCategoryEnum.ADMIN,
                "New pending guarantee awaiting authorization",
                "A new guarantee was requested and is awaiting authorization.<br>Issuer: #issuerName# (#issuerUsername#)<br>Buyer: #buyerName# (#buyerUsername#)<br>Seller: #sellerName# (#sellerUsername#)<br>Amount: #amount#<br>#link# for more details"),
        ...
        TOKEN_GENERATED_SMS(MessageSettingsCategoryEnum.GENERAL, "Token with id #tokenId# was generated by #sender# for #amount#"),

        TOKEN_REDEEMED_RECIPIENT_SMS(MessageSettingsCategoryEnum.GENERAL, "Token with id #tokenId# was successfully redeemed"),
