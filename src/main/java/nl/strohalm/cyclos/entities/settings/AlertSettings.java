...
public class AlertSettings extends DataObject {
    ...
    private boolean           alertNewPendingMembers = true;
    ...
    public boolean isAlertNewPendingMembers() {
        return alertNewPendingMembers;
    }

    public void setAlertNewPendingMembers(final boolean alertNewPendingMembers) {
        this.alertNewPendingMembers = alertNewPendingMembers;
    }
