...
public class Transfer extends Payment {
    ...
    public static enum Relationships implements Relationship {
        ACCOUNT_FEE_LOG("accountFeeLog"), CHILDREN("children"), CHARGED_BACK_BY("chargedBackBy"), FROM("from"), LOAN_PAYMENT("loanPayment"), PARENT("parent"), CHARGEBACK_OF("chargebackOf"), TO("to"), BY("by"), TRANSACTION_FEE("transactionFee"), TYPE("type"), RECEIVER("receiver"), EXTERNAL_TRANSFER("externalTransfer"), AUTHORIZATIONS("authorizations"), NEXT_AUTHORIZATION_LEVEL("nextAuthorizationLevel"), SCHEDULED_PAYMENT("scheduledPayment"), CUSTOM_VALUES("customValues");
