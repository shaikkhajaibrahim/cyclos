 ...
 * @author luis
 */
public abstract class Payment extends Entity implements EntityWithCustomFields<PaymentCustomField, PaymentCustomFieldValue> {
    ...
    protected void appendVariableValues(final Map<String, Object> variables, final LocalSettings localSettings) {
        ...
        if (from.getOwner() instanceof Member) {
            ...
            variables.put("fromMemberName", fromMember.getName());
            variables.put("fromMemberUsername", fromMember.getUsername());
        }
        if (to.getOwner() instanceof Member) {
            final Member toMember = (Member) to.getOwner();
            variables.put("toMemberName", toMember.getName());
            variables.put("toMemberUsername", toMember.getUsername());
        }
