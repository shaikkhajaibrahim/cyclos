 ...
 * 
 */
public class DRateParameters extends RateParameters {
    ...
    public DRateParameters() {
        super();
    }

    public DRateParameters(final DRateParameters copyFrom) {
        super(copyFrom);
        interest = copyFrom.interest;
        baseMalus = copyFrom.baseMalus;
        minimalD = copyFrom.minimalD;
    }
