...
public abstract class Ticket extends Entity {
    ...
    protected void appendVariableValues(final Map<String, Object> variables, final LocalSettings localSettings) {
        ...
        variables.put("fromMemberName", from.getName());
        variables.put("fromMemberUsername", from.getUsername());
        variables.put("toMemberName", to.getName());
        variables.put("toMemberUsername", to.getUsername());
    }
