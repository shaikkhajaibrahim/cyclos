...
public class ARateConfigSimulationAction extends BaseFormAction implements LocalSettingsChangeListener {
    ...
    protected ActionForward handleSubmit(final ActionContext context) throws Exception {
        ...
        final StatisticalResultDTO rawDataObject = aRateService.getARateConfigGraph(dto);
    ...
    protected void prepareForm(final ActionContext context) throws Exception {
        ...
        tt = getFetchService().fetch(tt, TransferType.Relationships.TRANSACTION_FEES);
        ...
        if (tt != null && (firstTime || form.isReloadData())) {
            TransactionFee fee = getFetchService().fetch(dto.getTransactionFee(), TransactionFee.Relationships.ORIGINAL_TRANSFER_TYPE);
        ...
        if (firstTime) {
            dto.setStartA(0);
            dto.setEndA(arateRelation == ARateRelation.ASYMPTOTICAL ? 100 : 30);
        }
    ...
    protected void validateForm(final ActionContext context) {
        ...
        aRateService.validate(dto, aRateRelation);
    }
    ...
    private DataBinder<ARatedFeeDTO> getDataBinder() {
        if (dataBinder == null) {
            ...
            binder.registerBinder("startA", PropertyBinder.instance(Integer.class, "startA"));
            binder.registerBinder("endA", PropertyBinder.instance(Integer.class, "endA"));
            dataBinder = binder;
        }
        return dataBinder;
    }
