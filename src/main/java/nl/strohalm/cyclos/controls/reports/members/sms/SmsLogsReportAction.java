...
public class SmsLogsReportAction extends BaseQueryAction implements LocalSettingsChangeListener {
    ...
    protected QueryParameters prepareForm(final ActionContext context) {
        final HttpServletRequest request = context.getRequest();
        final Administrator admin = getFetchService().fetch((Administrator) context.getElement(), RelationshipHelper.nested(Element.Relationships.GROUP, AdminGroup.Relationships.MANAGES_GROUPS));
        ...
        RequestHelper.storeEnum(request, SmsType.class, "smsTypes");
        ...
        query.setMemberGroups(getFetchService().fetch(query.getMemberGroups()));
        return query;
    }
