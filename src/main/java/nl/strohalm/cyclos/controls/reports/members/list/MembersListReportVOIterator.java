            ...
            for (final AccountType accountType : accountTypes) {
                ...
                try {
                    ...
                    if (dto.isAccountsBalances()) {
                        final GetTransactionsDTO transactionDto = new GetTransactionsDTO();
                        transactionDto.setAccount(account);
                        transactionDto.setPeriod(period);
                        final BigDecimal balance = accountService.getBalance(transactionDto);
