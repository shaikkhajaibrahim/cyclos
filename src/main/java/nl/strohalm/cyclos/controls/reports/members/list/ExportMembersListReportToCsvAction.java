...
public class ExportMembersListReportToCsvAction extends BaseCsvAction {
    ...
    public MembersListReportHandler getReportHandler() {
        if (reportHandler == null) {
            reportHandler = new MembersListReportHandler(SettingsHelper.getLocalSettings(getServlet().getServletContext()));
    ...
    @Override
    protected CSVWriter<MembersReportVO> initCsvWriter(final ActionContext context) {
