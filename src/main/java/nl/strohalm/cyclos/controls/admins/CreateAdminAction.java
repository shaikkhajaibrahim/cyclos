...
public class CreateAdminAction extends CreateElementAction<Administrator> {
    ...
    protected ActionForward create(final Element element, final ActionContext context) {
        ...
        administrator = getElementService().registerAdmin(administrator, form.isForceChangePassword());
        String paramName;
        Object paramValue;
    ...
    protected void prepareForm(final ActionContext context) throws Exception {
        ...
        final AdminGroup group = (AdminGroup) groupService.load(groupId);

        // Get the custom fields visible to that group
        final List<AdminCustomField> customFields = CustomFieldHelper.onlyForGroup((List<AdminCustomField>) customFieldService.listByNature(CustomField.Nature.ADMIN), group);
