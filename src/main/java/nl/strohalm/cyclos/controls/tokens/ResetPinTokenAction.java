...
public class ResetPinTokenAction extends BaseTokenAdminAction {

    @Override
    ActionForward tokenSubmit(BaseTokenForm token, ActionContext context) {
...
//        request.setAttribute("canResetTokenPin", getPermissionService().checkPermission("adminMemberTokens", "resetTokenPin"));
    }
