...
public abstract class BaseTokenAdminAction<T> extends BaseFormAction implements LocalSettingsChangeListener {
    ...
    protected final ActionForward handleSubmit(ActionContext context) throws Exception {
        ...
        try {
            return tokenSubmit(baseTokenForm, context);
    ...
    abstract ActionForward tokenSubmit(BaseTokenForm token, ActionContext actionContext) throws Exception;
