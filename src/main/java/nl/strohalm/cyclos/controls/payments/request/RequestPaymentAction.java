...
public class RequestPaymentAction extends BaseFormAction implements LocalSettingsChangeListener {
    ...
    protected void formAction(final ActionContext context) throws Exception {
        ...
        try {
            ...
            throw new ValidationException("paymentRequest.error.member");
    ...
    protected void prepareForm(final ActionContext context) throws Exception {
        ...
        final MemberGroup group = getFetchService().fetch(member.getMemberGroup(), MemberGroup.Relationships.REQUEST_PAYMENT_BY_CHANNELS);
