...
public class SelfPaymentAction extends BasePaymentAction {
    ...
    /**
     * Gets the group of the account owner. This is made a method because it is overridden in the child class SelfPaymentForMemberByAdminAction.
     * @param context
     * @return the group
     */
    protected Group getGroup(final ActionContext context) {
    ...
    protected MemberGroup getMemberGroup(final ActionContext context) {
        ...
        final Member member = (Member) getFromOwner(context);
    ...
    protected TransferTypeQuery resolveTransferTypeQuery(final ActionContext context) {
        ...
        if (memberId != null) {
            ...
            query.setGroup(getGroup(context));
        }
        return query;
    }
}
