...
public abstract class BaseFormAction extends BaseAction {
    ...
    protected ActionForward handleValidation(final ActionContext context) {
        try {
            ...
            ResponseHelper.writeValidationSuccess(context.getRequest(), context.getResponse());
        } catch (final PermissionDeniedException e) {
            ResponseHelper.writeValidationErrors(context.getRequest(), context.getResponse(), new ValidationException("error.permissionDenied"));
