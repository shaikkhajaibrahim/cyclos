...
public class EditGroupFilterCustomizedFileAction extends BaseFormAction {
    ...
    protected ActionForward handleSubmit(final ActionContext context) throws Exception {
        ...
        final GroupFilter groupFilter = getFetchService().fetch(file.getGroupFilter());
        ...
        file = customizedFileService.saveForGroupFilter(file);
    ...
    protected void prepareForm(final ActionContext context) throws Exception {
        ...
        final boolean editable = getPermissionService().checkPermission("systemGroupFilters", "manageCustomizedFiles");
