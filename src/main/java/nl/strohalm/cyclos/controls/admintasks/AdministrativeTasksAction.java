...
public class AdministrativeTasksAction extends BaseAction {
    ...
    protected ActionForward executeAction(final ActionContext context) throws Exception {
        ...
        final boolean canViewIndexes = getPermissionService().checkPermission("systemTasks", "manageIndexes");
        if (canViewIndexes) {
        ...
        final boolean canManageOnlineState = getPermissionService().checkPermission("systemTasks", "onlineState");
