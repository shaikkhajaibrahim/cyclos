...
public class RepayLoanAction extends LoanDetailsAction {
    ...
    private static final Relationship FETCH = RelationshipHelper.nested(Loan.Relationships.TRANSFER, Transfer.Relationships.TYPE, TransferType.Relationships.FROM, AccountType.Relationships.CURRENCY);
    ...
    protected ActionForward handleSubmit(final ActionContext context) throws Exception {
        ...
        try {
            ...
            final UnitsConverter nc = SettingsHelper.getLocalSettings(getServlet().getServletContext()).getUnitsConverter(accountType.getCurrency().getPattern());
    ...
    protected ActionForward handleValidation(final ActionContext context) {
        try {
            ...
            loan = getFetchService().fetch(loan, FETCH);
