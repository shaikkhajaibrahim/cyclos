...
public class ConfirmLoanAction extends BaseFormAction {
    ...
    protected ActionForward handleSubmit(final ActionContext context) throws Exception {
        ...
        try {
            if (dto.getDate() == null) {
                ...
                loan = loanService.grantWithDate(dto);
            }
    ...
    protected void prepareForm(final ActionContext context) throws Exception {
        ...
        // Fetch related data
        final Member member = getFetchService().fetch(loan.getMember(), Element.Relationships.USER);
        final TransferType transferType = getFetchService().fetch(loan.getTransferType(), RelationshipHelper.nested(TransferType.Relationships.FROM, AccountType.Relationships.CURRENCY), TransferType.Relationships.TO);
        final LoanGroup loanGroup = getFetchService().fetch(loan.getLoanGroup(), LoanGroup.Relationships.MEMBERS);
