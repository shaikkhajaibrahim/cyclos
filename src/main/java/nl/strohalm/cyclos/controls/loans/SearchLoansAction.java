...
public class SearchLoansAction extends BaseQueryAction {
    ...
    protected QueryParameters prepareForm(final ActionContext context) {
        ...
        query.fetch(Loan.Relationships.PAYMENTS, RelationshipHelper.nested(Loan.Relationships.TRANSFER, Transfer.Relationships.TO, MemberAccount.Relationships.MEMBER, Element.Relationships.USER));
        ...
        if (!getPermissionService().checkPermission("adminMemberLoans", "viewAuthorized")) {
