...
public class ManageTransactionPasswordAction extends BaseFormAction {
    ...
    protected ActionForward handleSubmit(final ActionContext context) throws Exception {
        ...
        if (user instanceof AdminUser) {
            getAccessService().resetAdminTransactionPassword(dto);
        } else if (user instanceof MemberUser) {
            getAccessService().resetMemberTransactionPassword(dto);
        } else { // user instanceof OperatorUser
            getAccessService().resetOperatorTransactionPassword(dto);
        }
