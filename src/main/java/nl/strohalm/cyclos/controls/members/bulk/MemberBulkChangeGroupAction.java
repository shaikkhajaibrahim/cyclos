...
public class MemberBulkChangeGroupAction extends BaseFormAction implements LocalSettingsChangeListener {
    ...
    public static void prepare(final ActionContext context) {
        ...
        final GroupService groupService = SpringHelper.bean(context.getServletContext(), "groupService");
    ...
    protected void formAction(final ActionContext context) throws Exception {
        ...
        final MemberGroup newGroup = (MemberGroup) groupService.load(CoercionHelper.coerce(Long.class, bean.get("newGroup")));
