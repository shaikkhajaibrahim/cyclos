...
public class PendingMemberProfileAction extends BaseFormAction {
    ...
    protected void prepareForm(final ActionContext context) throws Exception {
        ...
        final List<MemberCustomField> customFields = CustomFieldHelper.onlyForGroup((List<MemberCustomField>) customFieldService.listByNature(CustomField.Nature.MEMBER), pendingMember.getMemberGroup());
        ...
        if (context.isAdmin()) {
            editable = getPermissionService().checkPermission("adminMembers", "managePending");
        } else if (context.isBroker()) {
            editable = getPermissionService().checkPermission("brokerMembers", "managePending");
        }
