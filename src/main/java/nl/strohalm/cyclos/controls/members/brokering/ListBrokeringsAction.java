    ...
    protected QueryParameters prepareForm(final ActionContext context) {
        ...
        if (form.getMemberId() <= 0 || loggedElement.getId().equals(form.getMemberId())) {
            ...
            if (context.isAdmin()) {
                ...
                canChangeBroker = getPermissionService().checkPermission("adminMemberBrokerings", "changeBroker");
            }
        }
        ...
        brokerGroup = getFetchService().fetch(brokerGroup, BrokerGroup.Relationships.POSSIBLE_INITIAL_GROUPS);
        ...
        RequestHelper.storeEnum(request, BrokeringQuery.Status.class, "status");
        return query;
    }
