...
public class ImportedMembersDetailsAction extends BaseQueryAction {
    ...
    protected QueryParameters prepareForm(final ActionContext context) {
        ...
        final MemberImport memberImport = getFetchService().fetch(query.getMemberImport(), RelationshipHelper.nested(MemberImport.Relationships.ACCOUNT_TYPE, AccountType.Relationships.CURRENCY));
