...
public class SearchMemberRecordsAction extends BaseQueryAction implements LocalSettingsChangeListener {
    ...
    protected QueryParameters prepareForm(final ActionContext context) {
        ...
        if (context.isAdmin()) {
            ...
            adminGroup = getFetchService().fetch(adminGroup, AdminGroup.Relationships.CREATE_MEMBER_RECORD_TYPES, AdminGroup.Relationships.MODIFY_MEMBER_RECORD_TYPES, AdminGroup.Relationships.DELETE_MEMBER_RECORD_TYPES, AdminGroup.Relationships.CREATE_ADMIN_RECORD_TYPES, AdminGroup.Relationships.MODIFY_ADMIN_RECORD_TYPES, AdminGroup.Relationships.DELETE_ADMIN_RECORD_TYPES);
            if (global) {
                canCreate = (permissionService.checkPermission("adminMemberRecords", "create") && adminGroup.getCreateMemberRecordTypes().contains(type)) || (permissionService.checkPermission("adminAdminRecords", "create") && adminGroup.getCreateAdminRecordTypes().contains(type));
                canModify = (permissionService.checkPermission("adminMemberRecords", "modify") && adminGroup.getModifyMemberRecordTypes().contains(type)) || (permissionService.checkPermission("adminAdminRecords", "modify") && adminGroup.getModifyAdminRecordTypes().contains(type));
                canDelete = (permissionService.checkPermission("adminMemberRecords", "delete") && adminGroup.getDeleteMemberRecordTypes().contains(type)) || (permissionService.checkPermission("adminAdminRecords", "delete") && adminGroup.getDeleteAdminRecordTypes().contains(type));
            ...
            brokerGroup = getFetchService().fetch(brokerGroup, BrokerGroup.Relationships.BROKER_MEMBER_RECORD_TYPES, BrokerGroup.Relationships.BROKER_CREATE_MEMBER_RECORD_TYPES, BrokerGroup.Relationships.BROKER_MODIFY_MEMBER_RECORD_TYPES, BrokerGroup.Relationships.BROKER_DELETE_MEMBER_RECORD_TYPES);
