...
public class SearchBrokerCommissionContractsAction extends BaseQueryAction {
    ...
    public static DataBinder<BrokerCommissionContractQuery> prepareQueryDataBinder(final ServletContext servletContext) {
    ...
    private DataBinder<BrokerCommissionContractQuery> getDataBinder() {
        if (dataBinder == null) {
            dataBinder = prepareQueryDataBinder(getServlet().getServletContext());
        }
        return dataBinder;
    }
