...
public class ListMemberRecordTypesAction extends BaseAction {
    ...
    protected ActionForward executeAction(final ActionContext context) throws Exception {
        ...
        final List<MemberRecordType> memberRecordTypes = memberRecordTypeService.list();
        request.setAttribute("memberRecordTypes", memberRecordTypes);
        request.setAttribute("editable", getPermissionService().checkPermission("systemMemberRecordTypes", "manage"));
