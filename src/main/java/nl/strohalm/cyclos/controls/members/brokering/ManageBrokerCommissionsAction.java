...
public class ManageBrokerCommissionsAction extends BaseQueryAction implements LocalSettingsChangeListener {
    ...
    public DataBinder<BrokerCommissionContractQuery> getDataBinder() {
        if (dataBinder == null) {
            dataBinder = SearchBrokerCommissionContractsAction.prepareQueryDataBinder(getServlet().getServletContext());
        }
        return dataBinder;
    }
    ...
    protected QueryParameters prepareForm(final ActionContext context) {
        ...
        final Member broker = (Member) elementService.load(brokerId, Element.Relationships.GROUP);
