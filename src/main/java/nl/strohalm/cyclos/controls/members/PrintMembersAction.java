...
public class PrintMembersAction extends SearchMembersAction {
    ...
    protected QueryParameters prepareForm(final ActionContext context) {
        ...
        final List<MemberCustomField> customFields = new LinkedList<MemberCustomField>((Collection<? extends MemberCustomField>) getCustomFieldService().listByNature(CustomField.Nature.MEMBER));
        ...
        if (context.isAdmin()) {
            if (query instanceof FullTextMemberQuery) {
                ...
                final Collection<GroupFilter> groupFilters = getFetchService().fetch(memberQuery.getGroupFilters());
            ...
            final Collection<? extends Group> groups = getFetchService().fetch(query.getGroups());
