...
public class RemoveReferenceAction extends BaseAction {
    ...
    protected ActionForward executeAction(final ActionContext context) throws Exception {
        ...
        if (reference.getFrom().equals(context.getAccountOwner())) {
            referenceService.removeMyReference(reference.getId());
        } else {
            referenceService.removeMemberReference(reference.getId());
        }
