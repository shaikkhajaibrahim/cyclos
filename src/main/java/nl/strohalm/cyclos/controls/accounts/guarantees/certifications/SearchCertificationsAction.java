...
public class SearchCertificationsAction extends BaseQueryAction {
    ...
    protected QueryParameters prepareForm(final ActionContext context) {
        ...
        final boolean hasViewPermission = getPermissionService().checkPermission("adminMemberGuarantees", "viewCertifications");
        ...
        if (isIssuer) {
            ...
            query.setIssuer(getFetchService().fetch(query.getIssuer()));
        }
