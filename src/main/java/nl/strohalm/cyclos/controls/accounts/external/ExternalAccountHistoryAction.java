...
public class ExternalAccountHistoryAction extends BaseQueryAction implements LocalSettingsChangeListener {
    ...
    protected QueryParameters prepareForm(final ActionContext context) {
        ...
        final boolean process = getPermissionService().checkPermission("systemExternalAccounts", "processPayment");
        final boolean check = getPermissionService().checkPermission("systemExternalAccounts", "checkPayment");
        final boolean managePayment = getPermissionService().checkPermission("systemExternalAccounts", "managePayment");
