...
public class EditCurrencyAction extends BaseFormAction implements LocalSettingsChangeListener {
    ...
    protected ActionForward handleSubmit(final ActionContext context) throws Exception {
        ...
        currency = currencyService.save(currency, form.isEnableARate(), form.isEnableDRate());
        if (isInsert) {
    ...
    protected void prepareForm(final ActionContext context) throws Exception {
        ...
        boolean editable = getPermissionService().checkPermission("systemCurrencies", "manage");
        Currency currency;
        if (isInsert) {
    ...
    protected void validateForm(final ActionContext context) {
        ...
        currencyService.validate(currency, form.isEnableARate(), form.isEnableDRate());
    }
