...
public class EditAccountTypeAction extends BaseFormAction implements LocalSettingsChangeListener {
    ...
    protected void prepareForm(final ActionContext context) throws Exception {
        ...
        final boolean editable = getPermissionService().checkPermission("systemAccounts", "manage");
        ...
        if (isInsert) {
            ...
            final AccountType accountType = accountTypeService.load(id, SystemAccountType.Relationships.ACCOUNT);
