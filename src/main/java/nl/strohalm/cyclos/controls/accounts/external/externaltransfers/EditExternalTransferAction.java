...
public class EditExternalTransferAction extends BaseFormAction implements LocalSettingsChangeListener {
    ...
    public DataBinder<ExternalTransfer> getDataBinder() {
        if (dataBinder == null) {
            ...
            externalTransferBinder.registerBinder("date", PropertyBinder.instance(Calendar.class, "date", settings.getRawDateConverter()));
            externalTransferBinder.registerBinder("amount", PropertyBinder.instance(BigDecimal.class, "amount", settings.getNumberConverter()));
    ...
    protected void prepareForm(final ActionContext context) throws Exception {
        ...
        final boolean editable = getPermissionService().checkPermission("systemExternalAccounts", "managePayment") && externalTransfer.getStatus() == ExternalTransfer.Status.PENDING;
