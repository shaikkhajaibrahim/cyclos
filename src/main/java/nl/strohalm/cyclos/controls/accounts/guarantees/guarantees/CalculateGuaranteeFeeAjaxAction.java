...
public class CalculateGuaranteeFeeAjaxAction extends BaseAjaxAction {
    ...
    protected void renderContent(final ActionContext context) throws Exception {
        ...
        guaranteeType = getFetchService().fetch(guaranteeType, GuaranteeType.Relationships.CURRENCY);
        ...
        try {
            ...
            try {
                ...
                ResponseHelper.writeStatus(context.getRequest(), context.getResponse(), ResponseHelper.Status.SUCCESS, values);
