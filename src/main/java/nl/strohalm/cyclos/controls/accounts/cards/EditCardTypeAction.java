 ...
 * @author rodrigo
 */
@AdminAction( { @Permission(module = "systemCardTypes", operation = "manage"), @Permission(module = "systemCardTypes", operation = "view") })
public class EditCardTypeAction extends BaseFormAction {
    ...
    protected void prepareForm(final ActionContext context) throws Exception {
        ...
        editable = permissionService.checkPermission("systemCardTypes", "manage");
        CardType cardType;
        ...
        if (isInsert) {
            ...
            hasCardGenerated = cardTypeService.searchWithCardType(cardTypeId);
        }
