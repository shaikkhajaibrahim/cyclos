...
public class TransfersAwaitingAuthorizationAction extends BaseTransferAuthorizationSearchAction {
    ...
    protected void executeQuery(final ActionContext context, final QueryParameters queryParameters) {
        ...
        final List<Transfer> list = transferAuthorizationService.searchTransfersAwaitingMyAuthorization(query);
    ...
    protected QueryParameters prepareForm(final ActionContext context) {
        ...
        query.fetch(RelationshipHelper.nested(Transfer.Relationships.FROM, MemberAccount.Relationships.MEMBER));
        if (context.isAdmin() || context.isBroker()) {
            query.fetch(RelationshipHelper.nested(Transfer.Relationships.TO, MemberAccount.Relationships.MEMBER));
        }
