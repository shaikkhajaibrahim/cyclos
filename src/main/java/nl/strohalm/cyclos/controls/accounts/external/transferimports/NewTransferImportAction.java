 ...
 * @author luis
 */
public class NewTransferImportAction extends BaseAction implements LocalSettingsChangeListener {
    ...
    protected ActionForward executeAction(final ActionContext context) throws Exception {
        if (settings == null) {
            settings = SettingsHelper.getLocalSettings(getServlet().getServletContext());
        }
