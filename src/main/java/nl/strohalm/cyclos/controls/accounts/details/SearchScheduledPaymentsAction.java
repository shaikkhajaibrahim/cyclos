...
public class SearchScheduledPaymentsAction extends BaseQueryAction {
    ...
    protected QueryParameters prepareForm(final ActionContext context) {
        ...
        query.fetch(ScheduledPayment.Relationships.TRANSFERS, RelationshipHelper.nested(ScheduledPayment.Relationships.FROM, MemberAccount.Relationships.MEMBER), RelationshipHelper.nested(ScheduledPayment.Relationships.TO, MemberAccount.Relationships.MEMBER));
