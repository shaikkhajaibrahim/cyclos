...
public class EditAlertSettingsAction extends BaseFormAction {
    ...
    public DataBinder<AlertSettings> getDataBinder() {
        if (dataBinder == null) {
            ...
            binder.registerBinder("alertNewPendingMembers", PropertyBinder.instance(Boolean.TYPE, "alertNewPendingMembers"));
    ...
    protected void formAction(final ActionContext context) throws Exception {
        ...
        SettingsHelper.storeAlertSettings(getServlet().getServletContext(), settings);
