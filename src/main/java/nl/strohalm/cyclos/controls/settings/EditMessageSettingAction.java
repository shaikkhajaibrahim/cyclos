...
import nl.strohalm.cyclos.services.settings.MessageSettingsHandler;
...
public class EditMessageSettingAction extends BaseFormAction {
    ...
    protected ActionForward handleSubmit(final ActionContext context) throws Exception {
        ...
        SettingsHelper.storeMessageSettings(getServlet().getServletContext(), messageSettings);
    ...
    protected void validateForm(final ActionContext context) {
        ...
        if (form.isHasGeneral()) {
            validator.property("value").required().maxLength(MessageSettingsHandler.MAX_SUBJECT_SIZE);
        }
        if (form.isHasSubject()) {
            validator.property("subject").required().maxLength(MessageSettingsHandler.MAX_SUBJECT_SIZE);
        }
        if (form.isHasBody()) {
            validator.property("body").required().maxLength(MessageSettingsHandler.MAX_BODY_SIZE);
        }
        if (form.isHasSms()) {
            validator.property("sms").required().maxLength(MessageSettingsHandler.MAX_SMS_SIZE);
        }
