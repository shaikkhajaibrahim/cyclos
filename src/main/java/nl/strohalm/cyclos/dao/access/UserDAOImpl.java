...
public class UserDAOImpl extends BaseDAOImpl<User> implements UserDAO {
    ...
    public User load(final String username, final Relationship... fetch) throws EntityNotFoundException, DaoException {
        ...
        final User user = uniqueResult("select u from User u left join fetch u.element e where u.username = :username and e.class in (:admin, :member) and e.group.status <> :removed", namedParameters);
        if (user == null) {
