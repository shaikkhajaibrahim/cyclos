...
public interface SmsMailingDAO extends BaseDAO<SmsMailing>, InsertableDAO<SmsMailing>, UpdatableDAO<SmsMailing> {
    ...
    /**
     * Returns the next member which should receive the sms mailing, or null if all members have already received their messages
     */
    Member getNextMemberToSend(SmsMailing smsMailing);
