...
public interface IndexedDAO<E extends Entity & Indexable> {
     ...
     */
    IndexStatus getIndexStatus(Class<? extends E> entityType);

    /**
     * Optimizes the index for the given entity type
     */
    void optimizeIndex(Class<? extends E> entityType);

    /**
     * Rebuilds the entire index for the given entity type
     */
    void rebuildIndex(Class<? extends E> entityType);
