...
public interface ElementDAO extends BaseDAO<Element>, InsertableDAO<Element>, UpdatableDAO<Element>, DeletableDAO<Element>, IndexedDAO<Element> {
    ...
    /**
     * Returns an iterator with all member which didn't accept the given registration agreement, and are in the given group
     */
    Iterator<Member> resolveMemberWhichDidntAccept(MemberGroup group, RegistrationAgreement registrationAgreement);
