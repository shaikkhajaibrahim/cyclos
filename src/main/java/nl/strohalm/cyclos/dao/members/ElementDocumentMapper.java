...
public abstract class ElementDocumentMapper<E extends Element> extends AbstractDocumentMapper<E> {
    ...
    @Override
    protected void process(final DocumentBuilder document, final E element) {
        ...
        document.add("customValues", resolveFieldValues(element));
    }

    protected abstract Collection<? extends CustomFieldValue> resolveFieldValues(E element);
}
