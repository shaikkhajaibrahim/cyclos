...
public class AccountFeeLogDAOImpl extends BaseDAOImpl<AccountFeeLog> implements AccountFeeLogDAO {
    ...
    public List<AccountFeeLog> search(final AccountFeeLogQuery query) {
        ...
        HibernateHelper.addInParameterToQuery(hql, namedParameters, "l.status", query.getStatusCollection());
        ...
        if (!query.isReturnScheduled()) {
            HibernateHelper.addParameterToQueryOperator(hql, namedParameters, "l.status", "<>", AccountFeeLog.Status.SCHEDULED);
        }
