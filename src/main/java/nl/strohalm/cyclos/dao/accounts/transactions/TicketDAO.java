...
public interface TicketDAO extends BaseDAO<Ticket>, UpdatableDAO<Ticket>, InsertableDAO<Ticket> {
     ...
     * <code>Ticket.getTicket()</code>. If there's is no ticket with the given <code>code</code>, returns false. If any exception is thrown by
     * the underlying implementation, wrapped it in a DaoException.
     * 
     * @throws DaoException
     * 
     */
    ...
    /**
     * Retrieves the ticket identified by the attribute <code>code</code>, as returned by <code>Ticket.getTicket()</code>. If no ticket can be
     * found, throws EntityNotFoundException. If any exception is thrown by the underlying implementation, wrapped it in a DaoException.
     * 
     * @throws DaoException
     */
    Ticket load(String ticket, Relationship... fetch) throws EntityNotFoundException, DaoException;
