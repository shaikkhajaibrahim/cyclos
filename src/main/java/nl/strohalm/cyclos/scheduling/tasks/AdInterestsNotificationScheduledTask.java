...
public class AdInterestsNotificationScheduledTask extends BaseScheduledTask {

    private AdInterestService adInterestService;

    public AdInterestsNotificationScheduledTask() {
        super("Ad interests notification", false);
    }
    ...
    protected void doRun(final Calendar time) {
        adInterestService.notifyInterestedMembers(time);
    }
