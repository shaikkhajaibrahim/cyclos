    ...
    public synchronized <T> T proxyFor(final Class<T> serviceInterface) {
        ...
        if (username != null || password != null) {
            http.setAuthSupplier(new HttpBasicAuthSupplier() {
                @Override
                public UserPass getPreemptiveUserPass(final String conduitName, final URL currentURL, final Message message) {
                    return getUserPassForRealm(conduitName, currentURL, message, null);
                }

                @Override
                public UserPass getUserPassForRealm(final String conduitName, final URL currentURL, final Message message, final String realm) {
