...
public class MenuTag extends TagSupport {
    ...
    public int doStartTag() throws JspException {
        ...
        if (module != null) {
            granted = permissionService.checkPermission(module, operation);
        }
        ...
        if (StringUtils.isEmpty(label) && StringUtils.isNotEmpty(key)) {
            label = MessageHelper.message(pageContext.getServletContext(), key);
        }
    ...
    public void setPageContext(final PageContext pageContext) {
        ...
        permissionService = (PermissionService) pageContext.getAttribute("permissionService", PageContext.APPLICATION_SCOPE);
    }
    ...
    private void renderDiv(final Menu menu, final int index, final String divId) throws IOException, JspException {
        ...
        if (StringUtils.isNotEmpty(url)) {
            ...
            if (StringUtils.isNotEmpty(confirmationKey)) {
                out.print(" confirmationMessage=\"" + StringEscapeUtils.escapeHtml(MessageHelper.message(pageContext.getServletContext(), confirmationKey)) + "\"");
            }
        }
        out.print(">");
