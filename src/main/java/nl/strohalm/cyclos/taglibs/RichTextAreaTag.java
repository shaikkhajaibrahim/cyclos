    ...
    public int doEndTag() throws JspException {
        ...
        try {
            ...
            if (disabled) {
                ...
                sb.append("<div style='position:relative;padding-right:6px;'><div id='textOfField_").append(id).append("' class='fakeFieldDisabled' style='width:100%;height:200px;overflow:auto;'><table cellpadding='0' cellspacing='0' border='0' width='100%'><tr><td style='padding:0px'>");
