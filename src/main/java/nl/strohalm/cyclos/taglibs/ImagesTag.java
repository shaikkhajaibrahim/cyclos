...
public class ImagesTag extends TagSupport {
    ...
    public int doStartTag() throws JspException {
        ...
        final LocalSettings localSettings = SettingsHelper.getLocalSettings(pageContext.getServletContext());
        ...
        if (!imageOnly) {
            ...
            if (editable && !images.isEmpty()) {
                ...
                sb.append(MessageHelper.message(request, "image.details"));
                sb.append("</a></div>\n");
                ...
                sb.append(MessageHelper.message(request, "image.remove"));
                sb.append("</a></div>\n");
            }
        }
        sb.append("</div>\n");
