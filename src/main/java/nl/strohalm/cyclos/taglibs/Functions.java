...
public class Functions {
     ...
     */
    public static boolean granted(final String module, final String operation) {
        try {
            final ApplicationContext context = LoggedUser.getAttribute("applicationContext");
            final PermissionService permissionService = SpringHelper.bean(context, "permissionService");
            return permissionService.checkPermission(LoggedUser.group(), module, operation);
