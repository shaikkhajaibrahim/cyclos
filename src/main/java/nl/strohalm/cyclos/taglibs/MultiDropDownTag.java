...
public class MultiDropDownTag extends TagSupport {
    ...
    public int doEndTag() throws JspException {
        try {
            ...
            if (emptyLabelKey != null) {
                emptyLabel = MessageHelper.message(pageContext.getServletContext(), emptyLabelKey);
            }
            if (emptyLabel != null) {
    ...
    public int doStartTag() throws JspException {
        ...
        try {
            ...
            out.println("<script>");
            out.println("var mddNoItemsMessage = \"" + StringEscapeUtils.escapeJavaScript(MessageHelper.message(pageContext.getServletContext(), "multiDropDown.noItemsMessage")) + "\";");
            out.println("var mddSingleItemsMessage = \"" + StringEscapeUtils.escapeJavaScript(MessageHelper.message(pageContext.getServletContext(), "multiDropDown.singleItemMessage")) + "\";");
            out.println("var mddMultiItemsMessage = \"" + StringEscapeUtils.escapeJavaScript(MessageHelper.message(pageContext.getServletContext(), "multiDropDown.multiItemsMessage")) + "\";");
