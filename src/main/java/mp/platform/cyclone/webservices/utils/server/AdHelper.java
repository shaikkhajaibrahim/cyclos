...
import mp.platform.cyclone.webservices.ads.AbstractAdSearchParameters;
import mp.platform.cyclone.webservices.ads.AdResultPage;
import mp.platform.cyclone.webservices.ads.AdSearchParameters;
import mp.platform.cyclone.webservices.ads.FullTextAdSearchParameters;
import mp.platform.cyclone.webservices.ads.AbstractAdSearchParameters.AdVOStatus;
import mp.platform.cyclone.webservices.ads.AbstractAdSearchParameters.AdVOTradeType;
import mp.platform.cyclone.webservices.model.AdCategoryVO;
import mp.platform.cyclone.webservices.model.AdVO;
import mp.platform.cyclone.webservices.model.DetailedAdCategoryVO;
import mp.platform.cyclone.webservices.model.FieldValueVO;
import mp.platform.cyclone.webservices.model.TimePeriodVO;
