 ...
 * @author luis
 */
public class CustomFaultInterceptor extends AbstractSoapInterceptor implements ServletContextAware {
    ...
    public void handleMessage(final SoapMessage message) throws Fault {
        ...
        if (!WebServiceHelper.isFromCyclos(fault)) {
            final Throwable exception = fault.getCause();
    ...
    private String message(final ValidationException e) {
            ...
            if (!errors.isEmpty()) {
                ...
                if (StringUtils.isEmpty(propertyLabel)) {
                    ...
                    if (StringUtils.isNotEmpty(propertyKey)) {
                        ...
                        propertyLabel = MessageHelper.message(servletContext, e.getPropertyKey(propertyName));
                    } else {
        ...
        return MessageHelper.message(servletContext, key, args.toArray());
    }
}
