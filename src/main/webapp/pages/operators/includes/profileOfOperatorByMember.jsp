        ...
        <td colspan="2" align="left" class="tdContentTableForms">
			<cyclos:layout className="defaultTable" columns="4">
	    	    ...
	    	    <c:if test="${isLoggedIn}">
                    ...
                    <cyclos:cell align="left"><input type="button" class="linkButton" linkURL="disconnectUser?backToProfile=true&userId=${operator.id}" value="<bean:message key="global.submit"/>"></cyclos:cell>
		        </c:if>
            </cyclos:layout>
       	</td>
   	</tr>
