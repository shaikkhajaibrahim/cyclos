...
Behaviour.register({
	...
	'#parentValueSelect': function(select) {
		select.onchange = function() {
			self.location = pathPrefix + "/editCustomField?nature=" + getValue("nature") + "&fieldId=" + getValue("fieldId") + "&parentValueId=" + getValue(select); 
		}
	},
	
	'#backButton': function(button) {
		button.onclick = function() {
			var nature = getValue("nature");
			if (nature == 'MEMBER_RECORD') {
				...
				self.location = pathPrefix + "/listCustomFields?nature=" + getValue("nature");
			}
		}
	},
	...
	'img.removePossibleValue': function(img) {
		...
		img.onclick = function() {
			if (confirm(removePossibleValueConfirmationMessage)) {
				self.location = pathPrefix + "/removeCustomFieldPossibleValue?fieldId=" + getValue("fieldId") + "&possibleValueId=" + img.getAttribute("possibleValueId");
			}
		}
	},
	...
	'#movePossibleValue': function(select) {
		select.onchange = function() {
			...
			if (confirm(msg)) {
				self.location = pathPrefix + "/moveCustomFieldPossibleValue?oldValueId=" + oldId + "&newValueId=" + option.value;
			} else {
