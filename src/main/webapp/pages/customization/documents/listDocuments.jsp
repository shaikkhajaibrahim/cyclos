            ...
            <table class="defaultTable">
                ...
                <c:forEach var="document" items="${documents}">
                	<c:choose><c:when test="${cyclos:name(document.nature) == 'DYNAMIC'}">
                		...
                		<c:set var="operation" value="manageDynamic" />
                		...
                		<c:set var="operation" value="manageStatic" />
                	</c:when><c:otherwise>
                		<c:set var="detailsClass" value="staticDocumentDetails" />
                		<c:set var="previewClass" value="staticPreview" />
                		<c:set var="operation" value="manageMember" />
	                ...
	                <tr class="<t:toggle>ClassColor1|ClassColor2</t:toggle>">
	                    ...
	                    <td align="center" nowrap="nowrap">
	                    	...
	                    	<c:choose><c:when test="${cyclos:granted('adminMemberDocuments', operation)}">
...
<table class="defaultTableContentHidden">
	<tr>
		<td align="right">
			<c:if test="${cyclos:granted('adminMemberDocuments', 'manageDynamic')}">
			...
			<c:if test="${cyclos:granted('adminMemberDocuments', 'manageStatic')}">
