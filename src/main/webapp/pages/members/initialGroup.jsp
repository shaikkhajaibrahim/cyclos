...
<table class="defaultTableContent" cellspacing="0" cellpadding="0" style="${public ? 'width:560px' : ''}">
    <tr>
        ...
        <td colspan="2" align="center" class="tdContentTableLists">
				...
				<div class="loadingMessage" style="padding:5px;text-align:justify;width:90%;">
					<cyclos:escapeHTML brOnly="true">
						<bean:message key="createMember.initialGroup.preface.${public ? 'public' : 'byBroker'}" />
					</cyclos:escapeHTML>
				</div>
				<br>
...
<table class="defaultTableContentHidden" cellspacing="0" cellpadding="0" style="${public ? 'width:560px' : ''}">
	<tr>
