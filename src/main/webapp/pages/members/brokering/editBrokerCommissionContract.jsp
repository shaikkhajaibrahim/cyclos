...
<table class="defaultTableContent" cellspacing="0" cellpadding="0">
    <tr>
        ...
        <c:choose>
	        ...
	        <c:otherwise>
		        <bean:message key="brokerCommissionContract.title.modify"/></td>
    ...
    <tr>
        <td colspan="2" align="left" class="tdContentTableForms">
            <table class="defaultTable">
				...
				<tr>
					<td align="left">
						<c:if test="${editable and not isInsert}">
							<input type="button" id="removeButton" class="button" value="<bean:message key="brokerCommissionContract.action.remove"/>">
						</c:if>
