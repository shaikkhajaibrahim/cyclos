    ...
    <tr>
        <td colspan="2" align="left" class="tdContentTableLists">
			<c:choose><c:when test="${empty brokerCommissionContracts}">
	            ...
	            <table class="defaultTable">
	                <tr>
	                    <th class="tdHeaderContents" width="55%"><bean:message key='brokerCommissionContract.brokerCommission'/></th>
	                ...
	                <c:set var="canManage" value="${cyclos:granted('brokerCommissionContracts', 'manage')}"/>             
...
<c:if test="${not myContracts and cyclos:granted('brokerMembers', 'manageContracts')}">
