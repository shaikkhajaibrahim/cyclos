...
<table class="defaultTableContent" cellspacing="0" cellpadding="0">
    <tr>
        ...
        <cyclos:help page="notifications#notification_preferences"/>
    </tr>
    <tr>
            ...
            <table class="defaultTable">
				...
				<c:forEach var="type" items="${types}">
	                ...
	                <tr class="<t:toggle>ClassColor1|ClassColor2</t:toggle>">
	                    ...
	                    <c:if test="${smsEnabled && hasSmsMessages}">
                ...
                <c:if test="${not hasEmail}">
                    <tr>
	                    <div class="fieldDecoration">
    	                	<td colspan="3" align="center"><bean:message key="notificationPreferences.hasntEmail"/></td>
                    	</div>
                    </tr>
                </c:if>
                <c:if test="${smsEnabled}">
