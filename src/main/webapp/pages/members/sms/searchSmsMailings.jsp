...
<table class="defaultTableContent" cellspacing="0" cellpadding="0">
    <tr>
        ...
        <cyclos:help page="reports#sms_mailings"/>
    </tr>
    <tr>
        <td colspan="2" align="left" class="tdContentTableForms">
            <table class="defaultTable">
       			<tr>
         			<td class="label"><bean:message key="smsMailing.sendType"/></td>
         			<td>
         				<label>
				...
				<tr>
          		...
          		<tr>
          			<td>
          				<c:if test="${canSend}">
          					<input type="button" id="newButton" class="button" value="<bean:message key="smsMailing.new"/>">
          				</c:if>
          			</td>
		...
		<table class="defaultTableContent" cellspacing="0" cellpadding="0">
		    <tr>
		        ...
		        <td class="tdHelpIcon" align="right" width="13%" valign="middle" nowrap="nowrap">
			        <cyclos:help page="reports#sms_mailings_results" td="false"/>
		        </td>
		    </tr>
		    <tr>
