...
<table class="defaultTableContent" cellspacing="0" cellpadding="0">
    <tr>
        ...
        <cyclos:help page="reports#send_sms_mailing"/>
    </tr>
    <tr>
        <td colspan="2" align="left" class="tdContentTableForms">
            <table class="defaultTable">
                <tr>
                    ...
                    <td>
                       	<label><html:radio property="singleMember" styleId="toGroup" value="false"/> <bean:message key="smsMailing.sendType.group"/></label>
                    	&nbsp;&nbsp;&nbsp;
