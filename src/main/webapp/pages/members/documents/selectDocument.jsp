                ...
                <c:forEach var="document" items="${documents}">
	                ...
	                <tr class="<t:toggle>ClassColor1|ClassColor2</t:toggle>">
	                    ...
	                    <td align="left" nowrap="nowrap">
	                    	...
	                    	<c:if test="${!removed and (cyclos:name(document.nature) == 'MEMBER' and (adminCanManage or (byBroker and (visibility == 'MEMBER' or visibility == 'BROKER'))))}">
...
<c:if test="${!removed && (adminCanManage or byBroker)}">
