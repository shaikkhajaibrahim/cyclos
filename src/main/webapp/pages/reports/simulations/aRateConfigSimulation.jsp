            	...
            	<fieldset><legend><bean:message key="global.range"/></legend>
		            <table class="defaultTable">
		            	<tr>
		            		...
		            		<td>
			            		<html:text styleId="startA" property="simulation(startA)" styleClass="number tiny InputBoxEnabled" />
		            	...
		            	<tr>
							...
							<td>
		            			<html:text styleId="endA" property="simulation(endA)" styleClass="number tiny InputBoxEnabled" />
