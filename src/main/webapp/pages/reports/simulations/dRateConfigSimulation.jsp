            	...
            	<fieldset><legend><bean:message key="global.range"/></legend>
		            <table class="defaultTable">
		            	<tr>
		            		...
		            		<td>
		            			<html:text property="simulation(startD)" styleClass="number medium InputBoxEnabled" />
		            		</td>
		            	</tr>
		            	<tr>
		            		<td class="label" valign="top"><bean:message key="reports.simulations.dRateConfigSimulation.endD"/></td>
		            		<td>
		            			<html:text property="simulation(endD)" styleClass="number medium InputBoxEnabled" /> 
		            		</td>
		            	</tr>
					</table>
				</fieldset>
