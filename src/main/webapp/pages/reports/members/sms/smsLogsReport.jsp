						...
						<div class="smsLogType smsLogType-SMS_OPERATION" style="display:none">
							<cyclos:multiDropDown varName="smsTypes" name="query(smsTypes)" emptyLabelKey="global.search.all">
								<c:forEach var="smsType" items="${smsTypes}">
									<c:set var="label"><bean:message key="sms.type.${smsType}"/></c:set>
									<cyclos:option value="${smsType}" text="${label}" selected="${cyclos:contains(query.smsTypes, smsType)}" />
								</c:forEach>					
							</cyclos:multiDropDown>
			                ...
			                <tr class="<t:toggle>ClassColor1|ClassColor2</t:toggle>">
			                    ...
			                    <td align="center">			
			                    	...
			                    	<c:choose>
			                    		...
			                    		<c:when test="${not empty log.smsType}">(<bean:message key="sms.type.${log.smsType}"/>)</c:when>
			                    	</c:choose>
			                    </td>
			                    <td align="center">
