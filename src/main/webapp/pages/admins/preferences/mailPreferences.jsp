...
<ssl:form method="post" action="${formAction}">
	...
	<table class="defaultTableContent" cellspacing="0" cellpadding="0">
	    <tr>
	        ...
	        <cyclos:help page="notifications#email_notifications"/>
	    </tr>
	    <tr>
	        <td colspan="2" align="right" class="tdContentTableForms">
	            <table class="defaultTable">
	            	<c:if test="${not empty initialGroups}">
		          		<tr>
		            		...
		            		<td>
		            			<cyclos:multiDropDown name="adminNotificationPreference(newMembers)" minWidth="340">
		            				<c:forEach var="group" items="${initialGroups}">
	            	...
	            	<c:if test="${cyclos:granted('systemAlerts', 'viewSystemAlerts')}">
		          		<tr>
		            		...
		            		<td>
		            			<cyclos:multiDropDown name="adminNotificationPreference(systemAlerts).type"  minWidth="340">
	            	...
	            	<c:if test="${cyclos:granted('systemAlerts', 'viewMemberAlerts')}">
		          		<tr>
		            		...
		            		<td>
		            			<cyclos:multiDropDown name="adminNotificationPreference(memberAlerts).type" minWidth="340">
					...
					<c:if test="${cyclos:granted('adminMemberInvoices', 'view')}">
		          		<tr>
