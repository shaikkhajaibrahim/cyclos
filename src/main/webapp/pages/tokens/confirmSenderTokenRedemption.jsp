...
<ssl:form method="post" action="${formAction}">
    ...
    <table class="defaultTableContent" cellspacing="0" cellpadding="0">
        <tr>
            <td class="tdHeaderTable"><bean:message key="tokens.senderTokenRedemptionConfirm.title"/></td>
            <cyclos:help page="tokens#senderTokenRedemption_confirm"/>
        </tr>
        <tr>
                ...
                <table class="defaultTable">
                    <tr>
                        <td colspan="2" class="label" style="text-align:center;padding-bottom:5px">
                            <cyclos:escapeHTML><bean:message key="tokens.senderTokenRedemptionConfirm.header"/></cyclos:escapeHTML>
                        </td>
                    </tr>
