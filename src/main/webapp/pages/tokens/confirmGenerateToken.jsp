...
<ssl:form method="post" action="${formAction}">
    ...
    <table class="defaultTableContent" cellspacing="0" cellpadding="0">
        <tr>
            <td class="tdHeaderTable"><bean:message key="tokens.generateTokenConfirm.title"/></td>
            <cyclos:help page="tokens#generate_confirm"/>
        </tr>
        <tr>
            <td colspan="2" align="left" class="tdContentTable">
                <table class="defaultTable">
                    ...
                    <tr>
                        <td class="headerLabel" width="35%"><bean:message key='tokens.generateToken.tokenRecipient'/></td>
                        <td>
                                ${token.recipientMobilePhone}
                        </td>
                    </tr>
                    <tr>
                        <td class="headerLabel"><bean:message key='tokens.generateToken.amount'/></td>
