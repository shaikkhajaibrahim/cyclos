...
<c:choose>
	<c:when test="${cyclos:name(principal) == 'USER'}">
		<c:set var="principalLabel"><bean:message key="posweb.client.username"/></c:set>
	</c:when>
	<c:when test="${cyclos:name(principal) == 'CARD'}">
		<c:set var="principalLabel"><bean:message key="posweb.client.card"/></c:set>
	</c:when>
	<c:when test="${cyclos:name(principal) == 'ANY'}">
		<c:set var="principalLabel"><bean:message key="posweb.client.any"/></c:set>
	</c:when>
</c:choose>
<script>
