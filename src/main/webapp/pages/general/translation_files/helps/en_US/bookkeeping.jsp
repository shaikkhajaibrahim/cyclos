...
<p class="head_description">The bookkeeping function can be used to link
(mirror) &quot;external accounts&quot; like bank accounts or accounts from other
currency systems with accounts in a Cyclos system.
<p>Because the bookkeeping function allows to have a complete mirror of the
...
<p>A typical use of the bookkeeping module is to control the balances of
...
<p>It is possible to generate automatically specific types of (Cyclos)
...
bookkeeping module.
<p>The controlling of the &quot;backing&quot; is just an example of a use of
...
<p>Before being able to import new external transactions in cyclos, you must
...
<P>When you see this window for the first time there will be no fields in
...
order.
<p>Once there are items in the list you can do several things.
<ul>
...
<p>The window works in a very simple way. You can just click on a field
...
<p>Note: Only the transactions that are the result of the search of the top
...
<p>The window gives an overview of the processable payments. In each item, the above
