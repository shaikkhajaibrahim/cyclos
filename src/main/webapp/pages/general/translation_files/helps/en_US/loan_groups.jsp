...
<a name="top"></a>
<p class="head_description">Loan Groups allow members to be collectively
...
<p>After you filled in the necessary fields, you should click &quot;search&quot;
...
<p>The newly created group will show up in your next screen, which is the
...
is only possible if there are no open loans for the loan group.<p>
