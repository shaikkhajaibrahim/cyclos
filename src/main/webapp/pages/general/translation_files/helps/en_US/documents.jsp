...
<a name="top"></a>
<p class="head_description">Documents are pages with information which can
show up in the Member section of Cyclos.<br> 
...
to an individual member or a member group.</li><br> 
...
<p>For each created document, the visibility has to be set in the group
...
<p>The document file can be in any format. In case you chose to change an
...
<p><b>Beware</b>: Just creating a document doesn't mean that your
...
<p>Note 2: There are examples available of dynamic documents in the
...
<p>A document is usually an organizational document. If specified by the
