...
<a NAME="top"></a>
<p class="head_description">Member records are user-defined units of
...
<span class="admin"><p>This manual has a small <a href="#guidelines"><u>guideline</u></a>
...
<span class="broker">
<p>These member records are additional information associated with each
...
<p>In addition to modifying the properties of the record, you should also
