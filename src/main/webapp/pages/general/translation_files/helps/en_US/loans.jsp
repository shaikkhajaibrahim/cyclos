...
<a name="top"></a>
<p class="head_description">Loans can provide the basic credit
...
function for micro finance projects.</p>

<span class="admin">
<p><i>Where to find it / how to get it working.</i><br>
...
<ol>
	...
	interests too.
	<p>A new transaction type for <b>paying back the loans</b> is created as
	follows:
	<ul>
...
button)</i>
<p>If you checked the &quot;is loan&quot; checkbox it means that the <a
...
<p>There are three different <a href="#loan_types"><u>loan types</u></a>
...
<a name="loan_types"></a>
<h3>Loan types</h3>
<p>There are three different <a href="#top"><u>loan</u></a> types available:
...
<p>The following fields need to be filled in to grant the loan:
<ul>
...
<p>Note: It is possible to create <a href="${pagePrefix}custom_fields"><u>extra
...
<p>The print icon (<img border="0" src="${images}/print.gif" width="16"
...
<p>If the loan is a loan with <a href="#loan_types"><u>multiple
...
<p><span class="admin">Use either one of the buttons to repay or
...
<a name="component"></a>
<b>Component of a loan</b>
<p>One of a number of successive payments in settlement of a debt. When a
...
<b>CSV</b>
files
<p>CSV means &quot;comma separated values&quot;; it is the format for the
