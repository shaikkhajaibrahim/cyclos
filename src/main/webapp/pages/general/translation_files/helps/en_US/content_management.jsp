...
<p class="head_description">Cyclos allows you to change the User
...
and the looks can be manipulated.</p>
...
<p>Note that you can not only set customized files at the system
...
<p>The function permits to modify the following static files (this
...
location.
<p>You may also insert <a href="#insert_images"><u>images</u></a> in
...
<p>To avoid problems Cyclos will always keep a copy of the <a
...
<p>Cyclos the following style sheet files:
<ul>
	<li><b>style.css</b><br>
...
<p>In order to view the effects of the css file modification you
...
browser.
<p>If you want to use a new css file you can just copy the whole
content and put it over the existing style sheet (in the style sheet
edit window) and refresh the page as described above.
<p>If you have managed to make a nice css file you are welcome to
...
%&gt;</i>
<p>And the image location will be like this:
<p><i>&lt;img src="&lt;html:rewrite
page="/pages/images/some_image.jpg"/&gt;"&gt;</i>
<p>The page only needs the 'html:rewrite' tag for the image
...
<p>This window shows a list with files that have been <a href="#top"><u>customized</u></a>.
...
.
<p>In this window you can re-modify a file which you customized
...
<p>When you save a changed customized file the original contents
...
<p>When you stop customizing a file (by removing it from the list)
...
<h3>System images</h3>
<p>This window will show a list with the current system <a
...
update window</u></a> below.</p>
<hr class="help">

<A NAME="custom_images"></A>
<h3>Custom images</h3>
<p>This window will show a list with the custom <a href="#images"><u>images</u></a>
...
<p>You can delete an image selecting the <img border="0"
...
<p>Style sheet images are <a href="#images"><u>images</u></a> that
...
image in a pop-up window. You can add a custom image in the <a
	href="#images_upload"><u> update window</u></a> below.</p>
<hr class="help">

<A NAME="images_upload"></A>
<h3>Images upload</h3>
<p>In case of a <a href="#system_images"><u>system image</u></a>,
...
image will appear in the list window above.</p>
<hr class="help">
...
<p>To select another <a href="#themes"><u>theme</u></a> you have to
...
first.
<p>When you click the submit button labeled &quot;Remove&quot; the
...
<p>With this function you can import a <a href="#themes"><u>theme</u></a>.
...
<p>If you made your own <a href="#themes"><u>theme</u></a> (by
...
<p><i>If you do develop your own theme, please consider
