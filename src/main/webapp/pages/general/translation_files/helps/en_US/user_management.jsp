...
information about member status.</p>
...
<p>If there exists a broker group that has broker permissions to the group
...
<p>After filling in the data you have the option to save the member and
...
directly the <a href="${pagePrefix}profiles"><u>profile</u></a> of the new
member (button &quot;Save and open profile&quot;).
<p>For registering a new member, you might receive an automatic <a
...
<p>If you want to search for a member you can fill in various search fields
...
the search result.
<p>You have the option to print the search result by clicking the print icon
...
<p>Another possibility is to download the results in a file by clicking the
...
the columns.
<p>Note: In the reports function you will be able to retrieve more specific
...
<p>At this page you can search for pending members. You can search by name,
...
<p>The form is very simple: you can only specify a keyword, and/or limit the
search to a specific admin group. If you just click the &quot;Search&quot;
button without entering anything in the fields you will get a list of all the
administrators.<br>
<p>In order to register a new administrator you will have to use the drop
...
the organization. 
<p>The form is pretty simple
and straightforward. Any field with a red asterix (*) is obligatory.
<p><p>After filling in the data you have the option to save the admin and
...
<p><A NAME="contacts"></A>
<h3>Contacts</h3>
<p class="head_description">These screens let you manage your contacts.</p>
