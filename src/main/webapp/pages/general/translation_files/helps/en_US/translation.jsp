...
<p>If you're not content with a translation as it appears in the browser
...
<p>You can also add or delete complete key/value pairs from the file. This
...
<p>It is also possible to add a new translation key; if you want to do so,
...
the check boxes, and then use the &quot;remove selected&quot;. button. <p>
...
there are any).
<p>First, you will need to decide on &quot;What to do&quot;. There are four
options:
<ul>
...
<p>Note: It is not necessary that the file to import contains all keys -
...
<p>In cyclos, for each language there is a language file. This file contains
...
<p>The translation keys are placed in the application pages; when these
...
<p>Translation values are the words and terms in your own language which you
