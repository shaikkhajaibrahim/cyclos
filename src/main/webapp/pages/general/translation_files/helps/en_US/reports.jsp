...
<a href="${pagePrefix}references"><u>references</u></a>
, and on
...
&quot;Reports Current State&quot; enables you to view a report of the
present state of the system. <a href="#current_result"><u>Click
here</u></a> for an overview of what will be shown.
<p>Use the checkboxes to select what you want to view, and then
...
<ul>
	...
	<p>For all different reference categories, the table shows how
...
<p>If you check a lot of checkboxes, it could take a few seconds to
make the calculations. So please have patience.
<p>At the bottom of the page, you can <a href="#results"><u>print
...
<p>NOTE that you have to go through the form in the given order,
from top to bottom. The payment filter box may for example be empty if
you do not first select an account type.
<p>At the bottom of the page, you can <a href="#results"><u>print
or download</u></a> the results.
<p>On the form, you may specify the following elements:
<ul>
	...
	<li><b>Member groups</b>: here you can specify which <a
		href="${pagePrefix}groups"><u>member group(s)</u></a> you want to
	view.
...
<ul>
	...
	results in <a href="${pagePrefix}loans#csv"><u>csv format</u></a>.
</ul>
<hr class="help">
</span>
...
<p>This window allows you to get an overview of SMS messages sent.
