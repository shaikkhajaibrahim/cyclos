...
<p class="head_description">Cyclos has a categorization of users in
...
A part from the permissions a group can also have specific group <a
	href="#edit_member_group"><u>Settings</u></a> that define behaviour of
...
<p>The fact that a Member can only be in one group does not mean
...
<p>Cyclos ships with a set of standard groups. Normally, these
...
<p><span class="admin"> <i>Where to find it.</i><br>
...
<p><i>How to get it working.</i><br>
...
<ul>
	<li><a href="#member_groups"><u>member groups</u></a> - ordinary
	members having access to the member section of cyclos.
	<li><a href="#broker_groups"><u>broker groups</u></a> - a sort of
	&quot;super-members&quot;, members allowed some administrative
	functions for a set of other members.
	<li><a href="#admin_groups"><u>admin groups</u></a> - users with
	administrative functions.
</ul>
This separation in main categories is for security reasons, so that it
is impossible to give a member some admin
<a href="#permissions"><u>permissions</u></a>
by accident.
<br>
All of the groups come with default permissions, but it is possible to
modify these.
</p>
<hr>
...
Members of these groups have access to the member section of Cyclos. The
system comes with the following standard Member Groups:
<ul>
	<li><a href="#inactive_members"><u>Inactive Members</u></a> : If
	this group is set as initial group users cannot login but need to be
	&quot;activated&quot; (placed in an active member group) by an
	administrator before being able to log in.
	<li><a href="#full_members"><u>Full Members</u></a> :&nbsp; A
	normal member.
	<li><a href="#disabled_members"><u>Disabled Members</u></a>
	:&nbsp; Temporary inactive members.
	<li><a href="#removed_members"><u>Removed Members</u></a> :&nbsp;
	Members who definitely left the system.
</ul>
</p>
The default groups are not fixed or &quot;hard coded&quot; but have been
...
be found at this
<a href="#group_details"><u>Help section</u></a>
.
<hr class="help">
...
The reason to move a Member into the &quot;Removed Members&quot; group
is that the Member has left the system. Once in the Removed group one
cannot get back into any other group. The data will still be in the
Database and viewable by administrators but it only serves as a backup
function.
<br>
Any data (Ads, profile) from the Removed Member will not be viewable by
other members. Only the transaction history will show the past
transactions with this Member. If in this case an active Member selects
the Member name from an old transaction history record he will receive a
message that this member has been removed instead of showing the
profile. If Members still have a Removed Member in their contact list
they will receive the same alert message.
<p>The Removed group acts merely as an archive function. If after
some years the system needs a clean up, the administrator will know that
the data from the Removed group can be deleted (backed-up) safely. <br>
<b>Note:</b> There is an exception to this rule. A member that never
belonged to a group that had accounts can be removed permanently from
the system. There is a separate administration permission for this. <br>
<hr>
...
<p>See the <a href="${pagePrefix}brokering"><u>broker
...
<p>Click here for an overview of <a href="#member_groups"><u>member
groups</u></a>.
<p>After you have submitted the change of group, it is placed in the
...
function.
<p>Some remarks on changing groups:
<ul>
...
your text.
<p>After you have submitted the change, it is placed in the history
...
<p>This way the administrators can have a quick overview of what
...
<p>In this window there is also the possibility to remove an
...
create new groups.
<p>You can click the following icons for each of the listed groups:
...
<p>Note that you cannot set permissions here; group properties and
...
<p>The following group settings are availible:
<ul>
...
overview</u></a>, but you may also use the shortcut button below the window
labeled &quot;Group Permissions&quot;.<br>
<p>Member group settings are ordered by category. The following
...
<ul>
	...
	payment settings</u></a></b> are settings about <a
...
<h3>Group Details</h3>
Here you can set some general group settings. The following settings are
available:
<ul>
	...
	customized the login page for this group (in customized files window
	below). The customized (group) login page can be accessed by putting
	the login page name after the &quot;global&quot; login page with an
	interrogation character. The login page name cannot have spaces. An
	example would be:<br>
	...
	- Local settings</u></a> but just for this group. In this field you would need
	to put the page that opens the iframe or frame-set that includes
	Cyclos. for example: http://www.yourgroupdomain.org/cycloswrapper.php<br>
...
<ul>
	...
	the user will receive the password by e-mail after registration. If
	this option is not checked the user (and broker / admin depending on
	the permissions) can define the password at the registration form. <br>
	<br>
...
<ul>
	...
	e.g. notifications)
	<li><b>SMS charge amount:</b> This is the amount that will be
	charged for each outgoing SMS
</ul>
Most list items are pretty obvious and self explanatory. This help only
picks out items which might need further clarification. <br>
...
&quot; form.
<p>All of these settings refer to the <a
...
overview</u></a>, but you may also use the shortcut button below the window
labeled &quot;Group Permissions&quot;.<br>
<p>Broker group settings are ordered by category. The following
categories are availible; you may click the links to get details about
the fields in these categories:
<ul>
	<li><b><a href="#group_details"><u>Group details</u></a></b> gives
...
<p>Note: After creating a group it is not possible to change the
...
<p>You can modify account settings by clicking the <img border="0"
...
<p>You can also detach an account type for this group by clicking
...
<p>You may also associate a new account type to this group, by
...
&quot;Customized Files&quot;.
<p>This window gives an overview of customized files for this group.
...
.
<p>Note: When you want to include pictures in the static files they
...
<p class="sub_description">In cyclos, permissions are organized per
...
administrators of vouchers/scrip, etc.. </p>
...
<ul>
	...
	<li><b>Show quick access</b>: This option (only available for
	member and broker groups) will show a window at the home page with
	quick access icons to most used functions.
</ul>
<hr class="help">
...
<p>The permissions structure is quite straightforward. Most
...
<ul>
	...
	<br>
	<li><b><a href="${pagePrefix}custom_fields"><u>Customd
	...
	Customized files</u></a> :</b> Allows the admin to set customized files on a system
	wide level (as oposed to customized file per group). This affects the
	...
	<br>
	<li><b><a href="${pagePrefix}groups"><u>Permission
	Groups:</u></a></b> allows to <a href="#manage_groups"><u>manage</u></a> different
...
delete.
<p>In the first select box (&quot;Manages groups:&quot;) you can
...
<p>The following permissions can be set - you may want to use the
...
<ul>
	...
	<ul>
		...
		webshops.
		<li><b>Change channels access:</b> change the access methods to
	...
	<li><b>Guarantees:</b> Various permissions concerning the <a
		href="${pagePrefix}guarantees"><u> guarantees</u></a> system. Contains
	...
	<ul>
		...
		account.
		<li><b>Show member payment in menu:</b> allows the admin to
		perform a system to member payment from the main menu.
	...
	<ul>
		<li><b>View:</b> if this is not selected, the admin cannot view
		members
...
The &quot;Manage&quot; option gives the permission to create, edit and
delete.
<p>If the function has specific permissions (apart from manage and
...
<ul>
	...
	<br>
	<br>
	<li><b>Commissions</b>: If &quot;view&quot; is checked, it allows
	the member to view the <a href="${pagePrefix}brokering#commission"><u>
	...
	<br>
	<br>
	<li><b>Invoices:</b> In this section you can define if a member
	can send <a href="${pagePrefix}invoices"><u>invoices</u></a> to other
	members, either from a user profile or directly form the
	&quot;Account&quot; menu. When the &quot;System invoices&quot; is
	selected a member can send invoices to system accounts from the
	&quot;Account menu&quot;.<br>
	<br>
	...
	system of Cyclos. For more than one categorie to show up in the &quot;
	Send to Administration&quot; drop down, you will need to <a
		href="${pagePrefix}messages#categories"><u>define</u></a> those
	categories first.<br>
	...
	depends on how many payment types you defined.
	<ul>
		...
		<li><b>Member payment option from menu:</b> If this option is
		checked the members can perform payments to other members directly
		...
		<li><b>Authorize payment:</b> allows the member to <a
	...
	<ul>
		<li><b>Notifications</b> allows the member to manage their e-mail
		<a href="${pagePrefix}notifications"><u> notifications</u></a>.
		<li><b></b> allows the member to manage their <a
			href="${pagePrefix}ads_interest"><u>advertisement interests</u></a>.
		
	</ul>
	<br>
	<li><b>Member profile:</b> Here you can specify the members that
	will show up in the <a
		href="${pagePrefix}user_management#search_member_by_member"><u>
	&quot;Search members&quot;</u></a> of this member group. Normally all groups
...
<ul>
	...
	<br>
	<br>
	<li><b>Products and Services:</b> allows a broker's viewing or
	managing permission to the advertisements of the brokered member.<br>
	<br>
	...
	to all of his brokered members.<br>
	<br>
	...
	<ul>
		<li><b>View:</b> if this is selected the broker can view the <a
			href="${pagePrefix}reports#member_reports"><u>reports pages</u></a>
		of his brokered members.
		<li><b>Show Account information:</b> if you select an account
		type here, the broker can also view account information (balances) of
		his members in these reports.
	</ul>
	<br>
	<br>
</ul>
