...
<p><span class="member">Payments in the main web access page can be
...
<p>A broker can also <a href="#authorized"><u>authorize</u></a> payments of
...
<p>After submitting you will be asked for a confirmation. The Units are
...
system account.
<p><a href="#payments"><u>Click here</u></a> for a general description of
the payment windows.
<hr class="help">
</span>
...
<p>Scheduled payments can be searched via the &quot;Menu: Accounts >
Scheduled payments&quot;.
</span>
...
window.
<p>The &quot;scheduling&quot; drop down has three possible values:
<ul>
...
<p>If you have the permissions, two buttons may be available at the bottom
of the window:
<ul>
...
<p>Authorized payments can be enabled as follows:
<ol>
...
<span class="member">
<p>Authorization for members simply means that the receiver will have to
...
<p>You can find authorized payments at the following locations in the
software:
<ul>
...
authorization.
<p>You can specify the following search criteria:
<ul>
...
<p>Click the view <img border="0" src="${images}/view.gif" width="16"
...
<p>It works like this: when putting a member in the (autocomplete) login
...
<p>The result window will show the payment request according to the search
...
icon), it will present a printable version of your search result with ${localSettings.maxIteratorResults}
transactions and a summary report. <span class="admin">You can change the number of transaction it will show you in Local Settings %gt; limits.</span>
...
<p>The first (top) section of the window shows the following informaiton:
<ul>
...
below this window.
<p><span class="broker admin"> In case the transaction needs to be authorized you
