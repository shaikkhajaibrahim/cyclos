...
<a name="top"></a>
<p class="head_description">Messages in cyclos can be used on many different occasions
...
which contains a &quot;send e-mail&quot; button in each member profile.</p>
...
.
<p>The icon will show the status of the message, either:
<ul>
...
<span class="admin"> 
	...
	<p>If you send a message to a group, the form will change, and their will be 
