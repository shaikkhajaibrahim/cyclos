...
<p>Most items are pretty straightforward. If you're viewing the profile of
...
<span class="member">
<p>Of course, the profile of other members cannot be modified, and the
...
<p>Some general information on the form:
<ul>
...
<p>The form is pretty straightforward, and most items are self-explanatory.
...
<p>The help windows give a summary of maximal available actions, that is:
...
<p>Actions and profiles for operators are discussed in the helpfile of operators. 
<hr>
...
readable.
<p>The following sections exist. Click on the links to move to the
...
<ul>
	...
	<li><b>Manage cards:</b> gives you access to the <a
		href="${pagePrefix}cards#search_card_results"><u> Manage cards</u></a>, where will be listed every members card.
</ul>
<hr class="help">
</span>
