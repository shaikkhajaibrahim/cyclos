...
经纪可以与每个会员成立佣金的 <a href="#commission_contracts"><u>合同</u></a>。
...
<h3>删除会员</h3>
此视窗的标题可能有点令人震惊，但唯一会发生的事情，如果您单击提交的话，是会员已不再注册他的经纪。因此，会员是删除了指定的经纪。<br>
...
<ul>
	...
	如果是经纪 <a href="#commission_contract"><u>合同</u></a>，经纪佣金价值可以由经纪改变。在这种情况下，价值数额将用作佣金合同的默认值。
...
这些设置将应用于所有新注册会员，除非它们被经纪的设置所推翻，或由经纪和会员之间的个别 <a href="#commission_contract"><u>合同</u></a> 推翻。
...
<br>请注意，任何您设置给您的会员的个别 <a href="#commission_contract"><u>合同</u></a>，将再次推翻这里改变的设置。
<p>
