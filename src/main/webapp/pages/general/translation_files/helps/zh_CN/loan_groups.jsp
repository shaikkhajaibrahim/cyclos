...
要查看此项目，管理员需要有正确的 <a href="${pagePrefix}groups#manage_group_permissions_admin_member"><u>权限</u></a>（贷款小组区块）。<p>
...
<p>当您填写需要的字段后，您应该点击 &quot;搜索&quot;，小组将会显示在下面的 <a href="#search_loans_group_result"><u>搜索结果视窗</u></a>。
<p>
...
<p>新增的小组将显示在您的下一个视窗，即是 <a href="#search_loans_group_result"><u>搜索贷款结果</u></a> 视窗。
