...
<p class="sub_description">
<h2>税及费用</h2>
在这里，您可以指定想要计算的税费统计。这些统计给您任何收到的税或费用的结果。（可能仍在建设中）
</p>
请 <a href="#forms"><u>点击这里</u></a> 以取得表单的描述。
<hr>
...
<ul>
	...
	在这种情况下，您不能继续进行统计计算。这只有两种解决方法：<b>或</b>选择另一组别，<b>或</b>给这组别新增一个付款筛选器。<!-- Put this below in the section on payment filters, in another file -->
	<p>要新增统计的付款筛选器：
	<ol>
		<li>转到主菜单的 &quot;账户&quot; > &quot;管理账户&quot; 
		<li>然后点击 &quot;会员账户&quot; 编辑图标
