...
<ul>
	...
	<li><b>通过您的联系人：</b> 通过 &quot;菜单：个人 > 联系人&quot;，使用您的 <a href="${pagePrefix}contacts"><u>联系人列表</u></a> 以转到会员的个人资料。
</ul>
</span> 
...
<p>大多数项目都相当简单。如果您正在查看另一管理员的个人资料，页面会显示该管理员所属的组别。
<hr class="help">
</span>
...
<span class="member">
<p>当然，其他会员的个人资料是不能修改的，而且会员可以选择一些使其他会员看不见的资料。因此，这帮助的其余部份主要是有关您自己可更改的个人资料。
</span>
<p>一些表格内的一般资料：
<ul>
...
<p>表格相当简单，多数项目都是不解自明的。有以下一些特定字段的备注（请注意，可能看不见所提及的字段，这取决于您组织选择的配置）：
<ul>
	<span class="admin">
...
<p>帮助视窗给予最多可用行动的摘要，即：可能出现在您视窗的所有行动。您很可能将不会看到所有这些行动，这是取决于您的配置和使用权限。
如需要行动的更详细解释，您可以参阅帮助；当您点击帮助内的按钮，便可到达特定的行动视窗。
您也可以跟随链接，它将给您多一些有关这题目的一般解释。（讨论项目是从左至右，一行行从上到下。）
<p>在操作员的帮助会讨论操作员的行动和个人资料。
<hr>
...
<UL>
	...
	<LI><b>发送 <a href="${pagePrefix}invoices"><u>发票</u></a></b>
	<li><b>查看 <a href="${pagePrefix}advertisements"><u>广告</u></a></b>
	<li><b>发送电邮</b>
	...
	<LI><b>新增 <a href="${pagePrefix}contacts"><u>联系人</u></a></b>
</UL>
<hr class="help">
</span>
...
<ul>
	...
	<li><b>管理卡：</b> 让您 <a href="${pagePrefix}cards#search_card_results"><u>管理卡</u></a>，它会显示每个会员的卡。
</ul>
<hr class="help">
</span>
