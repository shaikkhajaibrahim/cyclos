...
<p><i>在哪里可以找到它？</i><br>
<p><span class="member">付款在主要网络接入页可以从三个地点开始。从菜单中：这有两个版本：
<ul>
...
<h3>代表会员付款给会员</h3>
在此视窗中，您可以代表会员从会员账户付款给另一会员的账户。<p>
请 <a href="#payments"><u>点击这里</u></a> 以取得一般的付款视窗描述。
<hr class="help">
</span>
...
<ol>
	<li><b>权限：</b> 首先，您需要设置所有会员组别的 <a
		href="${pagePrefix}groups#manage_group_permissions_member"><u>权限</u></a>。在写作此刻，有三种可启用的会员组别权限，但是您可能不想把它们全部都启用。
...
<h3>预定付款</h3>
这帮助项目是有关 <a href="#scheduled"><u>预定付款</u></a> 的，并描述了它在 <a href="#payments"><u>付款</u></a> 视窗内的特殊字段。
<p>在 &quot;预定&quot; 下拉框有三个可能值：
<ul>
...
<span class="member">
<p>会员授权简单指收款人在交易进行之前将要接受来自对方的付款。收款人有可能拒绝该笔付款（例如：没有产品）。
收款人和付款人都将收到通知。此配置与发票的使用相似，并且相当罕见。在同一系统中，最好不要同时使用收款人授权和发票。
</span>
<p>在软件内，您可以在下列的位置找到授权付款：
<ul>
	<li><b>菜单：账户 > 等待授权</b> 提供需要您授权付款的概况。只有当您有权限来授权收到的付款时，这项目单才可用。
	<li><b>菜单：账户 > 授权</b> 让您可以搜索任何过去或现在，已授权、拒绝或取消的授权。所有您过去完成的授权行动可以通过这个视窗找到。
	在这里，您可以搜索所有在系统进行的授权行动，因此，不仅是管理员的授权付款。<br>
...
如果您点击打印图标 <img border="0" src="${images}/print.gif"
	width="16" height="16">&nbsp;（位在頂部帮助图标的旁边），将会出现您的搜索结果的打印版，当中包含所有交易和一份摘要报表。
...
<p><span class="broker admin"> 如果交易需要得到授权，您将可以选择接受或拒绝该交易。您也将需要输入评论。
...
但是，只有交易已经发生了不太久，这个按钮才能看得见。您可以在 &quot;菜单：设置 > <a href="${pagePrefix}settings#local"><u>本地设置 > 退单</u></a>&quot; 定义交易类型的最大退单时限。
<hr class="help">
</span>
