...
讯息是通过联环系统的内部讯息系统发送的。这意味着当收件人一旦登录，便看到您发送的讯息。联环系统可 <a
	href="${pagePrefix}notifications"><u>配置</u></a> 为这些讯息也通过电邮发送 - 但是，是否允许这做法是收件人的责任。
...
<span class="broker">作为经纪发送讯息（给您的所有会员），您可以使用
&quot;菜单：个人 > 讯息&quot;，但您也可以使用 &quot;菜单：经纪 > 发送讯息&quot; 选项。
</span>
另一种方法发送讯息是到会员的 <a href="${pagePrefix}profiles"><u>个人资料</u></a>，
<span class="admin">在 &quot;会员讯息&quot; 节内，</span>
<span class="admin">点击 &quot;发送讯息&quot; 按钮。
...
<p>为了发送新的讯息，您必须点击标记为 &quot;发送新讯息&quot; 的提交按钮。
<hr class="help">
