...
组别是用来授予 <a href="#permissions"><u>权限</u></a> 给软件的用户。如果他的组别不允许，用户便无法获得联环系统的功能。
...
<p class="sub_description">
<h2>标准会员组别</h2>
这些组别的会员有机会访问联环系统会员节。系统具有以下标准会员组别：
<ul>
...
<br>
由于不活跃会员没有相关的帐户，意味着可以完全由系统删除会员。一旦会员已在
&quot;活跃&quot; 组别（拥有帐户），便不能删除该会员了，
...
如果在这种情况下，活跃会员从旧的交易历史记录选择了删除会员的名，他将收到一条消息，显示该会员已被删除，而非显示个人资料。
如果会员仍然有删除会员在他们的联络名单，他们将获得同样的警告消息。
<p>
...
<ul>
	...
	<li><b>激活组别</b> 此选项只有在没有帐户的组别才会显示。如果在该组别的会员不应被其他会员看得见，您应该让这个选择为空白。<br>
	在某些情况下，即使当会员没有帐户，您也想把他们显示给其他用户，这样的话，您应该拣选这个选项。
...
（或者，如果是管理员/经纪注册，将是管理员或经纪所选择的组别的一部分）。
	...
	<br><li><b>通过电邮发送密码：</b> 当拣选这个选项，用户在注册后将会通过电邮收到密码。如果不选择此选项，用户（和经纪/管理员，这取决于权限）可以在注册表格中定义密码。
	<br><br>
...
此视窗显示注册协议的列表。更多有关注册协议的资料可在修改协议的 <a
	href="#group_registration_agreement"><u>帮助</u></a> 找到。<br>
...
<ul>
	...
	<br>
	<li><b>个人密码长度：</b> 对于一些付款渠道，如：短讯和网上商店，可以设置使用个人密码（只限数字）。在这选项，您可以定义最大和最小的密码长度。<br><br>
...
大部份列出的项目是很明显和不解自明的。这帮助只选出可能需要进一步澄清的项目。<br>
 <a href="${pagePrefix}notifications#notification_preferences"><u>通知帮助</u></a> 将提供更多有关特定选项的资料。
<hr class="help">
</span>
...
<p>您可以修改账户设置，请单击 <img border="0"src="${images}/edit.gif" width="16" height="16">&nbsp;修改图标。<br>
<b>注意</b>：要使这账户能够付款和收款，只是新增或修改是不够的；您还需要设置组别的 <a href="#permissions"><u>权限</u></a>，否则账户无法使用。
<p>您也可以拆离这组别的账户类型，请单击 <img border="0" src="${images}/delete.gif" width="16" height="16">&nbsp;删除图标。
...
<p>注意：当您要在静态文件中包含图片，将需要 <a href="${pagePrefix}content_management#custom_images"><u>上载</u></a> 图片。
<hr class="help">
</span>
...
<ul>
	...
	<li><b>显示快速访问</b>：此选项（仅适用于会员和经纪组别）将在主页中显示一个视窗，该视窗具有快速访问图标以到达最常用的职能。
</ul>
<hr class="help">
...
<ul>
	...
	<br>
		<li><b><a href="${pagePrefix}content_management"><u>自订文件</u></a>：</b> 允许管理员设置全系统级别的自订文件（与每一组别的自订文件不同）。
		这会影响下列 &quot;内容管理&quot; 主要菜单中的项目名单：
	<ul>
		<li>静态文件
		<li>帮助文件
		<li>样式表文件
	...
	<br>
	<li><b><a href="${pagePrefix}alerts_logs#error_log"><u>错误日志</u></a>：</b> 查看和管理错误日志。<br>
	<br>
	...
	<br>
	<li><b><a href="${pagePrefix}groups"><u>权限组别</u></a>：</b> 允许 <a href="#manage_groups"><u>管理</u></a> 不同的 <a href="#group_categories"><u>组别类别</u></a>。<br>
	<br>
	...
	<ul>
		<li><b><a href="${pagePrefix}reports#current_state"><u>现状</u></a></b>
	...
	<br>
	<li><b><a href="${pagePrefix}settings#web_services_clients"><u>联网服务客户端</u></a>：</b> 定义外部软件连接联环系统联网服务的访问级别。<br>
	<br>
	...
	<ul>
		...
		<li><b><a href="${pagePrefix}settings#channels"><u>管理渠道</u></a></b>
		<li><b><a href="${pagePrefix}settings#web_services_clients"><u>管理联网服务客户端</u></a></b>
	...
	<ul>
		...
		<li><b>查看在线经纪：</b> 运作相同。管理员将只能查看他拥有查看权限的 <a href="#broker_groups"><u>经纪组别</u></a> 的在线经纪。
		<li><b>查看在线操作员：</b> 运作相同。它会显示操作员及其所属的会员。
	</ul>
	<br>
	<li><b>管理任务：</b> 允许管理员管理系统状态：
	<ul>
		<li><b>设定系统可用性：</b> 管理员可拣选
		<a href="${pagePrefix}settings#system_availability"><u>系统可用性</u></a>
		<li><b>管理索引：</b> 管理员可拣选
		<a href="${pagePrefix}settings#search_indexes"><u>管理索引</u></a>
	</ul>
	<br>
	<li><b>主题：</b> 管理 <a href="${pagePrefix}content_management"><u>内容管理</u></a> 菜单下的 <a href="${pagePrefix}content_management#themes"><u>主题</u></a>。<br>
	<br>
	<li><b>翻译：</b> 允许访问 <a href="${pagePrefix}translation"><u>翻译</u></a> 主菜单，当中可以查看/管理用您的语言做的翻译。
</ul>
<hr class="help">
</span>
...
<ul>
	...
	还有允许 <a href="${pagePrefix}advertisements#import_ads"><u>导入广告</u></a> 的权限。
	<br>
	<br>
	...
	<ul>
		...
		<li><b>查看 <a href="${pagePrefix}documents"><u>动态</u></a> 文件</b>
		<li><b>查看 <a href="${pagePrefix}documents"><u>静态</u></a> 文件</b>
		<li><b>查看 <a href="${pagePrefix}documents#member_document"><u>会员</u></a> 文件</b>
	</ul>
	<br>
	<li><b>会员组别：</b>
	<ul>
	...
	<br>
	<li><b>担保：</b> 有关 <a href="${pagePrefix}guarantees"><u>担保</u></a> 系统的不同权限。包含以下分项：
	<ul>
		<%-- TO DO --%>
		<li><b>查看付款义务：</b>
		<li><b>查看认证：</b>
	...
	<ul>
		...
		<li><b><a href="${pagePrefix}loans#discard"><u>舍弃贷款</u></a>：</b> 允许通过把贷款的总余额变为零来 &quot;取消&quot; 贷款。
		<li><b>偿还贷款：</b> 允许管理员代表会员偿还贷款。
		<li><b>在过去的日期偿还贷款：</b> 与前一项目相同，但允许管理员设置还款日期为在过去的一个日期。
	...
	<ul>
		...
		<li><b>显示会员付款项目单：</b> 允许管理员从主菜单执行系统付款给会员。
	...
	<br>
	<li><b><a href="${pagePrefix}reports#member_activities"><u>活动报表</u></a>：</b> 是有关特定会员活动的报表，它可从会员个人资料下方的行动按钮进入。分项目是不解自明的。<br>
	<br>
	...
	<ul>
		...
		<li><b>管理待激活会员：</b> 管理员可以查看已注册、但尚未（用电邮）验证注册的会员。<br>
		更多资料可在 <a href="${pagePrefix}user_management#search_pending_member"><u>帮助</u></a> 中找到。		
	</ul>
</ul>
<hr class="help">
</span>
...
<ul>
	...
	<br>
	<li><b>佣金</b>: 如果拣选 &quot;查看&quot;，它允许会员查看自己经纪的 <a href="${pagePrefix}brokering#commission"><u>佣金</u></a>。<br>
	<br>
	...
	<ul>
		...
		<li><b>发行认证：</b> <%-- ?? LATER DOOR HUGO ?? --%>
		<li><b>新增担保（作为签发者）：</b> <%-- ?? LATER DOOR HUGO ?? --%>
		<li><b>以付款义务出售的组别：</b> <%-- ?? LATER DOOR HUGO ?? --%>
	</ul>
	<br>
	<li><b>发票：</b> 在这节中，您可以定义会员是否可以发送 <a href="${pagePrefix}invoices"><u>发票</u></a> 给其他会员，无论是从用户的个人资料，或直接从 &quot;账户&quot; 菜单发送。
	当选择 &quot;系统发票&quot;，会员可以从 &quot;账户菜单&quot; 发送发票给系统账户。<br>
	<br>
	...
	<br>
	<li><b>讯息：</b> 在这节中，您可以定义会员可使用联环系统的 <a href="${pagePrefix}messages"><u>讯息</u></a> 系统的程度。要超过一种类别显示在 &quot;发送给管理员&quot; 下拉框，您首先需要 <a
		href="${pagePrefix}messages#categories"><u>定义</u></a> 这些类别。<br>
	...
	<li><b>付款：</b> 在这里，您可以指定允许这会员组别的 <a
		href="${pagePrefix}account_management#transaction_type_details"><u>付款方式</u></a>。您多数只会选择一种或几种方式。可用的方式取决于您定义了多少种付款方式。
	<ul>
		<li><b>自我付款：</b> 如果选择这个选项，会员可以在自己的账户之间进行付款。在下拉框，您可以指定可能的交易类型。此选项只适用于拥有一个以上会员账户的组别。
		<li><b>付款给会员：</b> 在这里，您可以选择会员付款给另一会员时可以使用的付款方式。
		<li><b>项目单有会员付款选项：</b> 如果拣选这个选项，会员可以直接从 &quot;账户&quot; 菜单中执行付款给其他会员。
		...
		<li><b>授权接收时付款：</b> 允许会员 <a	href="${pagePrefix}payments#authorized"><u>授权</u></a> 付款，如果他是收款人。
		<br>
		注意：此选项允许收款人发送确认。它的运作方式与发票类似，因此，不应该和发票联合起来。		
	...
	<ul>
		<li><b>通知</b> 允许会员管理他们的电邮 <a href="${pagePrefix}notifications"><u>通知</u></a>。
		<li><b>广告兴趣<</b> 允许会员管理他们的 <a href="${pagePrefix}ads_interest"><u>广告兴趣</u></a>。
	</ul>
	<br>
	<li><b>会员个人资料：</b> 在这里，您可以指定在这会员组别的 <a href="${pagePrefix}user_management#search_member_by_member"><u>&quot;搜索会员&quot;</u></a> 所显示的会员。
	通常选择所有组别（删除或禁用组别除外）。在您想组别在系统中独立运作的情况下，才会允许查看特定的组别。
	例如：消费者和商业组别不能看到对方。如果您使用特定的组别来查看，您将需要设置与查看广告权限相同的权限。<br>
	<br>
	...
	<br>
	<li><b>会员报表：</b> 如果拣选 &quot;查看&quot;，会员组别可以查看其他会员的 <a href="${pagePrefix}reports#member_reports"><u>报表</u></a>。
	如果您在 &quot;查看账户资料&quot; 选择账户类型，会员还可以在这些报表中查看其他会员的账户资料（余额）。<br>
	<br>
...
<ul>
	...
	<br>
	<li><b>产品和服务：</b> 允许经纪查看或管理其经纪会员的广告的权限。<br>
	<br>
	...
	<ul>
		...
		<li><b>更改个人密码：</b> 允许经纪更改 <a
			href="${pagePrefix}passwords#pin"><u>个人密码</u></a>，这是一个数字密码以访问某些 <a href="${pagePrefix}settings#channels"><u>渠道</u></a>，如：网上商店。
		<li><b>更改访问渠道：</b> 更改访问 <a href="${pagePrefix}settings#channels"><u>渠道</u></a> 的方法，如：联网、通过手机等。
		<li><b>解除封锁个人密码：</b> 当会员超过允许的尝试后，解除封锁了的个人密码。<br><br>
	</ul>
	<br>
	...
	<ul>
		...
		为了使此设置有效，交易类型的配置也必须允许封锁预定付款。
		<li><b>代表会员自我付款：</b> 允许经纪从会员的一个账户付款给相同会员的另一个账户，犹如他是会员。
	</ul>
	<br>
	<li><b><a href="${pagePrefix}member_records"><u>会员记录</u></a>：</b>
	允许管理员管理会员记录－这让您定义将搜集到的会员资料。分项目是不解自明的。<br>
	<br>
	<li><b><a href="${pagePrefix}reports#sms_log"><u>短讯日志</u></a>：</b> 提供访问为经纪会员发送的短讯日志。系统可以配置在多个情况下发送短讯。<br>
	<br>	
	<li><b>经纪代理：</b>
	<ul>
		<li><b>注册：</b> 允许经纪注册新会员。
		<li><b>修改资料：</b> 允许经纪更改其经纪会员的 <a
			href="${pagePrefix}profiles"><u>个人资料</u></a>。
		<li><b>管理默认佣金：</b> 允许经纪自己设置 <a href="${pagePrefix}brokering#commission"><u>佣金</u></a> 的默认值。
		<li><b>管理合同：</b> 如果拣选这项，经纪可以管理会员的佣金 <a href="${pagePrefix}brokering#commission_contract"><u>合同</u></a>。
		这可以通过在 <a href="${pagePrefix}profiles"><u>个人资料</u></a> 下面的按钮完成。
		<li><b>管理待激活会员：</b> 经纪可以查看已注册、但尚未（用电邮）验证注册的会员。<br>
		更多资料可在 <a href="${pagePrefix}user_management#search_pending_member"><u>帮助</u></a> 中找到。	</ul>
	<br>
	...
	<br>
	<li><b>报表：</b><ul>
		<li><b>查看：</b> 如果选择这项，经纪可以查看其经纪会员的 <a href="${pagePrefix}reports#member_reports"><u>报表</u></a>。
		<li><b>查看账户资料：</b> 如果您在这里选择账户类型，该经纪还可以在这些报表中查看其会员的账户资料（余额）。
	</ul>
	<br>
</ul>
<hr class="help">
