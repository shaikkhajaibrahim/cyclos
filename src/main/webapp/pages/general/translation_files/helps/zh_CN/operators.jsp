...
操作员也可以给予访问销售点网络模块（销售点网络的资料可以在渠道 <a href="${pagePrefix}payments#accesing_channels"><u>帮助</u></a> 中找到）。
<br>
...
<p><b>注1：</b> 如果您自定登录页，请务必保存代码，它是用来使操作员能够登录的。否则，操作员的登录链接可能看不见。
<p><b>注2：</b> 操作员模块和操作完全是会员负责的。管理员不可能为会员而管理操作员。管理员唯一可以做的管理工作是从 <a
...
然后点击 &quot;搜索&quot; 以显示您的搜索结果。
<p>您也可以新增一个操作员，通过在此视窗下面的下拉框中，选择操作员组别（&quot;新增操作员&quot;）。这下拉框只有在没有搜索结果视窗时才可见。
<hr class='help'>
</span>
...
<span class="member notOperator">
<p>当您拣选此视窗时，如果该操作员也在线，他将得到通知。&quot;上次登录&quot; 字段将显示（红色）&quot;在线&quot; 的字句。
<hr class='help'>
</span>
...
<p>属于该组别的操作员可能会收到这些权限（根据系统设置和您自己的权限）：
<p>
<b>会员账户</b>
...
<ul>
	...
	<li><b>付款给系统：</b> 如果选择了它，操作员可以付款给系统帐户。如果没有拣选此选项，项目单 &quot;系统付款&quot; 不会显示。
...
<br>
<p>点击 &quot;永久删除&quot; 选项，将删除操作员。这只限于从来没有执行任何交易的操作员。<br>
