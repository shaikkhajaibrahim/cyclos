...
有两种文件类型：&quot;静态&quot; 和 &quot;动态&quot; 文件。静态文件只是档案，就像一个 pdf 档案，可以被分配给个别的会员或会员组别。
动态文件是 HTML 文件，可以被分配到一个或多个组别；这些文件对于会员可能做到个人化，因为它可以从查看它的会员的个人资料取出字段。</p>
<span class="admin">
...
<p>对于每个已新增文件，其可见性要在 &quot;文件&quot; 区块的组别 <a href="${pagePrefix}groups#manage_group_permissions_member"><u>权限</u></a> 中设置。
因此，这意味着文件是被指定到某些会员组别。可以设置文件只供管理员查看，只有管理员和经纪可查看，和只有管理员、经纪和会员自己（会员可永远看不到对方的文件）可查看。<br>
<b>注1：</b> 联环系统不存在管理员文件这样的东西。
</span>
<span class="member">
<p><i>在哪里可以找到它？</i><br>
文件可以在 &quot;菜单：个人 > 文件&quot; 查看。
...
完成后，点击 &quot;提交&quot; 按钮以储存该文件。
<p>文件档案可以是任何格式。如果您选择更改现有的档案，现时的档案被放在 &quot;当前文件&quot; 的链接，您可以点击此链接查看当前版本的文件。
<p><b>请注意</b>：只是新增文件并不意味着您的会员/用户可以查看它。文件新增后，您应该设置 <a
...
<p>注2：在联环系统的 wiki 有提供动态文件的例子，它在 &quot;设置-自定文件&quot; 下面。见 
