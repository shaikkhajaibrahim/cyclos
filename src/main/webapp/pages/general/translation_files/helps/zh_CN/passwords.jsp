...
<h2>交易密码</h2>
交易密码是要求用户在每次想要进行付款时提供的一种密码。</p>
<span class="admin">
根据系统（访问）设置（&quot;菜单：设置 > 访问设置&quot;），可以在正常的表格字段中输入数字的交易密码，或使用虚拟键盘。您也可以选择将用作为交易密码一部分的字符。
<p>可以通过用户管理页面（&quot;个人资料 > 访问 > 管理密码&quot;）来管理交易密码。该选项只适用于已启用交易密码的组别（在组别权限）。
</span>
<hr>

<a NAME="transaction_password_generation"></a>
<h3>交易密码</h3>
在这里，您可以领取您的个人 <a href="#transaction_password"><u>交易密码</u></a>。在点击 &quot;领取交易密码&quot; 之后，您的密码会显示出来。
