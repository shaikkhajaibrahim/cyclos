...
<p class="head_description">All configurations relating to accounts and
transactions can be done in the accounts management functions.</p>
...
transaction type.
<p>Note1: The permissions of a transaction type are defined per group and
