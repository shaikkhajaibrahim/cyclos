...
<p>Note that you cannot set permissions here; group properties and settings
...
<p>The permissions structure is quite straightforward. Most functions have
...
<p>The following permissions can be set - you may want to use the links for
more information:
<ul>
...
<p>If the function has specific permissions (apart from manage and view) the
