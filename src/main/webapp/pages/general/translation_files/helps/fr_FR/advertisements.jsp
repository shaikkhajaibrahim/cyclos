...
<p class="head_description">A member can publish advertisements and search for
...
automatically on the organization web site (if this option is enabled).</p>
...
returned.<p>The advertisement search will search in all advertisement fields (so
...
specified in the window above. <p>
...
<p>Most fields are self explanatory. We will shortly comment on some fields:
<ul>
...
a new advertisement.
<p><b>Note: </b>There is a maximum number of advertisements you can
...
might start asking questions about this.<p>
