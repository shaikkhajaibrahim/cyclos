...
<p class="head_description">Cyclos permite la categorización de
...
<p>El hecho de que un Miembro pueda pertenecer solamente a un grupo
...
<p>Cyclos cuenta con una configuración de grupos por defecto.
...
<p><span class="admin"> <i> ¿Dónde los encuentro? </i><br>
...
<p>El grupo de Eliminados actúa con el mero propósito de archivo
...
<p>Véase la <a href="${pagePrefix}brokering"><u>sección de
...
"Aceptar".
<p>Haga click aquí para una visión general de <a
	href="#member_groups"><u>grupos de miembros</u></a>.
<p>Luego de haber aceptado el cambio de grupo, el mismo es ingresado
...
<p>algunas observaciones sobre el cambio de grupo:
<ul>
...
<p>Luego de aceptar el cambio, el mismo es ingresado en la casilla
...
<p>De esta forma los administradores pueden ver que paso con la
...
<p>En esta ventana existe también la posibilidad de eliminar un
...
<p>Usted puede hacer click sobre los siguientes íconos para cada uno
...
<p>Advierta que aquí no es posible configurar sus permisos; los
...
<p>Los siguientes campos están disponibles para establecer la <b>Configuración
...
<p>Advierta que aquí no es posible configurar permisos; propiedades
...
de grupos</u></a>, o utilizando el botón de atajo "Permisos de Grupo" ubicado en
la parte inferior izquierda de esta ventana.
<p>Las configuraciones de grupo de Miembro son ordenadas por
categoría. <br>
...
<ul>
	...
	Es definido al <a href="#insert_group"><u>definir el grupo</u></a> y no puede ser modificado.
	...
	Esta opción sólo se mostrará si usted ha personalizado la página de acceso (login) para este grupo.<br>
	A la página de acceso personalizada (para el grupo) se puede acceder ingresando el nombre de la página de acceso luego (a continuación) 
	de la página de acceso (login) "global", con un signo de interrogación.
	El nombre de la página de acceso no puede poseer espacios.<br>
	Un ejemplo sería: http://www.suDominio.org/cyclos?<b>suPaginaPersonalizada</b>
	<br>
	Tenga en cuenta que también es posible especificar una página de acceso (login) 
...
<ul>
	<li><b>Grupo inicial:</b> Seleccione esta opción si usted desea
	que el grupo sea un "grupo inicial", en el cual serán ingresados los
	miembros luego de haberse registrado desde la página de registro
	público.<br>
	Puede existir uno o más grupos iniciales en el sistema (por ejemplo:
	"empresas pendientes", "personas pendientes").<br>
	<br>
	Al seleccionar esta opción, se mostrará el campo <b><i>"Mostrar como"</i></b>, donde
	usted puede especificar un nombre diferente para cada grupo inicial
	existente.<br>
...
<hr class="help">
</span> <span class="admin"> <a name="group_scheduled_payment_settings"></a>
<h3>Configuración de pagos agendados para el grupo</h3>
Son las configuraciones del grupo relacionadas a los <a
	href="${pagePrefix}payments#scheduled"><u>pagos agendados</u></a>.<br>
Esta configuración es parte del formulario "<a href="#edit_member_group"><u>modificar
grupo miembro</u></a>".
<p>Todas estas configuraciones refieren a los <a
...
de grupos</u></a>, o utilizando el botón de atajo "Permisos de Grupo" ubicado en
la parte inferior izquierda de esta ventana.
<p>Las configuraciones del grupo Broker son ordenadas por categoría.<br>
Las siguientes categorías están disponibles; usted puede hacer click en
los enlaces correspondientes para obtener más detalles sobre los campos
existentes en cada categoría:
<ul>
...
<p>Nota: Luego de crear un grupo no es posible cambiar el tipo ni el
estado del grupo.
<hr class="help">
...
<p>Esta ventana ofrece una vista general de los archivos
...
<p>Nota: Si desea incluir fotos en el archivo estático, las mismas
...
administrador de cuenta, de sistema, de contabilidad, de vales, etc. </p>
...
<p>La mayoría de las funciones poseen los permisos de <b>Ver</b> y <b>Administrar</b>:
<ul>
...
<p>Los siguientes permisos pueden ser configurados (utilice los
...
<ul>
	...
	<ul>
		...
		<li><b>Procesar préstamos de garantías</b>.
		<li><b>Registrar garantías</b>.
		<li><b>Cancelar obligaciones de pago</b>.
		<li><b>Cancelar certificaciones</b>.
		<li><b>Rechazar/Cancelar garantías</b>.
		<li><b>Aceptar garantías</b>.</li>
	</ul>
	<br>
...
<ul>
	...
	<li><b>Garantías:</b> Permisos correspondientes al módulo de <a
		href="${pagePrefix}guarantees"><u>garantías</u></a> de Cyclos, donde
	cada saldo de cuenta se encuentra garantizado con un respaldo en dinero
	físico.<br>
	Usted puede establecer los siguientes permisos:
	<ul>
		<li><b>Comprar con obligaciones de pago:</b> Aquí usted puede
		seleccionar los grupos de miembros autorizados para comprar con <a
			href="${pagePrefix}guarantees"><u>obligaciones de pago</u></a>.
		<li><b>Emitir certificaciones:</b> Aquí puede seleccionar los
		grupos de usuarios a los cuales es posible emitirles certificaciones.
		<%-- ?? LATER DOOR HUGO ?? --%>
		<li><b>Crear garantías (como emisor):</b> Permite seleccionar los
		tipos de transacción correspondientes a la emisión de garantías. <%-- ?? LATER DOOR HUGO ?? --%>
		<li><b>Vender con obligaciones de pago:</b> Si esta opción es
		seleccionada, los miembros del grupo podrán vender con obligaciones de
		pago. <%-- ?? LATER DOOR HUGO ?? --%>
	</ul>
	<br>
