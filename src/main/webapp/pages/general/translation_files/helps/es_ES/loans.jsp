...
(cuotas), sus intereses, y permite a los administradores aplicar una variedad de tasas.</p>

<span class="admin">
<p><i> ¿Dónde los encuentro? ¿Cómo hacerlos funcionar? </i> <br>
<br>
...
<p> Un nuevo tipo de transacción <b><i> para el pago de los préstamos </i></b> se crea de la siguiente forma:<br>
	<ul>
...
<p> <i> ¿Dónde los encuentro? </i> <br>
	...
	<p> Si usted marcó la casilla de verificación "¿Es un préstamo?" significa que el <a
...
<p> Existen tres(3) tipos de préstamos diferentes disponibles:
<ul>
...
<h3> Otorgamiento de préstamos </h3>
	...
	<p> Los siguientes campos deben ser completados al otorgar un préstamo:
	<ul>
...
<p>Nota: Es posible crear <a href="${pagePrefix}custom_fields"><u> campos personalizados </u></a> 
