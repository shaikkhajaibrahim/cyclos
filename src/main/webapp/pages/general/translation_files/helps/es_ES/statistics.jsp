...
Las estadísticas son para tratar de cuantificar que tan exactos son tus resultados.</p>
...
<p>Si pasa el ratón por encima de una barra de la gráfica, el valor numérico correspondiente a los
...
<p>Las siguientes filas son mostradas en esta tabla:
<ul>
...
Por favor vea la <a href="#results"><u>sección general en resultados</u></a> para convenciones
generales en estadísticas de cyclos.
<p>La única fila muestra el <a href="#grossProduct"><u>Producto Bruto</u></a>
...
Por favor vea la <a href="#results"><u>sección general en resultados</u></a> para convenciones
generales en estadísticas de cyclos.
<p>La única fila muestra el <a href="#numberOfTransactions"><u>número de
...
Por favor vea la <a href="#results"><u>sección general en resultados</u></a> para convenciones
generales en estadísticas de cyclos.
<p>La única fila muestra el monto <a href="#median"><u>medio</u></a> por transacción 
...
Por favor vea la <a href="#results"><u>sección general en resultados</u></a> para convenciones
generales en estadísticas de cyclos.
<p>La única fila muestra el monto máximo por transacción de acuerdo a los
...
Por favor vea la <a href="#results"><u>sección general en resultados</u></a> para convenciones
generales en estadísticas de cyclos.
<p>Se muestran las siguientes filas:
<ul>
...
<p>Note que los tres primeros ítems son <i>al final del período</i>,
...
Por favor vea la <a href="#results"><u>sección general en resultados</u></a> para convenciones
generales en estadísticas de Cyclos.
<p>Si selecciono &quot;a través del tiempo&quot; se mostrara un vista histórica general
...
Por favor vea la <a href="#results"><u>sección general en resultados</u></a> para convenciones
generales en estadísticas de cyclos.
<p>Esta tabla muestra la <a href="#median"><u>mediana</u></a> del <a href="#grossProduct">
...
<p>Para &quot;comparar períodos&quot;, las columnas muestran el resultado para ambos períodos, 
...
Por favor vea la <a href="#results"><u>sección general en resultados</u></a> para convenciones
generales en estadísticas de cyclos.
<p>Esta tabla muestra la <a href="#median"><u>mediana</u></a> del <a
...
Por favor vea la <a href="#results"><u>sección general en resultados</u></a> para convenciones
generales en estadísticas de cyclos.
<p>Se muestra solo una fila, que indica el porcentaje de los miembros que no comercializaron o
...
Por favor vea la <a href="#results"><u>sección general en resultados</u></a> para convenciones
generales en estadísticas de cyclos.
<p>Se muestra solo una fila, indicando el número de accesos por miembro para el <a
...
Por favor vea la <a href="#results"><u>sección general en resultados</u></a> para convenciones
generales en estadísticas de cyclos.
<p>Esta tabla le brinda una vista de la <a href="#median"><u>mediana</u></a> del <a
...
Por favor vea la <a href="#results"><u>sección general en resultados</u></a> para convenciones
generales en estadísticas de cyclos.
<p>Esta tabla muestra la <a href="#median"><u>mediana</u></a> de <a
...
Por favor vea la <a href="#results"><u>sección general en resultados</u></a> para convenciones
generales en estadísticas de cyclos.
<p>Esta tabla da una vista general del porcentaje de miembros que no comercializaron durante el
 <a href="#periods"><u>período</u></a>, sobre el rango de tiempo especificado.
<p>Se considera que un miembro &quot;no comercializa&quot; si no realizó ninguna transacción
...
Por favor vea la <a href="#results"><u>sección general en resultados</u></a> para convenciones
generales en estadísticas de cyclos.
<p>Esta tabla da una vista histórica del número <a href="#median"><u>mediana</u></a> de accesos
...
Por favor vea la <a href="#results"><u>sección general en resultados</u></a> para convenciones
generales en estadísticas de cyclos.
<p>Esta gráfica proporciona un <a href="#histo"><u>histograma</u></a> del <a
...
Por favor vea la <a href="#results"><u>sección general en resultados</u></a> para convenciones
generales en estadísticas de cyclos.
<p>Esta gráfica proporciona un <a href="#histo"><u>histograma</u></a> de los accesos al sistema
...
Por favor vea la <a href="#results"><u>sección general en resultados</u></a> para convenciones
generales en estadísticas de cyclos.
<p>Esta tabla muestra los diez miembros con el mayor <a href="#grossProduct"><u>producto bruto</u>
...
Por favor vea la <a href="#results"><u>sección general en resultados</u></a> para convenciones
generales en estadísticas de cyclos.
<p>Esta tabla muestra los diez miembros con el mayor <a
...
Por favor vea la <a href="#results"><u>sección general en resultados</u></a> para convenciones
generales en estadísticas de cyclos.
<p>Esta tabla muestra los diez miembros con el mayor número de accesos al sistema durante
...
Por favor vea la <a href="#results"><u>sección general en resultados</u></a> para convenciones
generales en estadísticas de cyclos.
<p>Esta tabla muestra una vista general de los pagos recibidos y realizados para la cuenta de
sistema especificada. La columna final muestra la diferencia entre gastos e ingresos.
<p>Los <a href="#filters"><u>filtros</u></a> de pago especificados son desplegados en la tabla,
...
<p>Si selecciona solamente un filtro de pago, entonces este filtro se divide entre los tipos de
...
Por favor vea la <a href="#results"><u>sección general en resultados</u></a> para convenciones
generales en estadísticas de cyclos.
<p>Esta tabla o gráfica da una vista general de los ingresos (en caso de haber seleccionado
...
<p>Es aconsejable no seleccionar demasiados filtros de pago para generar la tabla o gráfica.<br>
<hr class="help">
...
Por favor vea la <a href="#results"><u>sección general en resultados</u></a> para convenciones
generales en estadísticas de cyclos.
<p>Esta tabla muestra una vista general de los ingresos (o egresos) a través del tiempo. Le 
...
<p>Los intervalos de confianza usualmente se calculan asumiendo que cierta 
...
<p><b>Nota:</b> El programa calcula automáticamente la división óptima en el eje de
...
estadísticas.
<p>En caso de calcular una mediana de un grupo de números enteros, usamos
...
<p>Usar la mediana en vez del promedio tiene unas pocas <b>consecuencias</b>:
<ul>
