...
<a href="#actions"><u> Acciones para ...</u></a>, lo que le permite realizar diversas acciones con el miembro deseado.</p>
</span>
...
<span class="member">
<p> Por supuesto, el perfil de otros miembros no puede ser modificado, y cada
...
<p>Información general del formulario:
<ul>
...
<p> El formulario es sencillo, y la mayoría de los campos se explican por sí mismos.<br>
...
legible.
<p> Existen las siguientes secciones: <br> 
