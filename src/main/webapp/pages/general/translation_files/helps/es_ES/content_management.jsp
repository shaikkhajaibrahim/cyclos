...
<p> Tenga en cuenta que usted no solo puede personalizar los archivos a nivel del sistema 
...
<p><i>¿Cómo hacerlo funcionar? </i> <br>
...
<p> La función permite modificar los siguientes archivos: 
<ul>
...
<p> Usted también puede insertar imágenes <u><a href="#insert_images"></u></a> 
...
<p> Para evitar o resolver ocasionales problemas, Cyclos siempre conservará una copia de la 
<a href="#edit_customized_file"><u>página original</u></a>, para que puede ser revertido fácilmente.</p>
<p>
...
<p> Cyclos brinda los siguientes archivos de hoja de estilo (css):
<ul>
	<li> <b> Style.css </b> <br>
...
<p> Para ver los efectos de la modificación de un archivo css, usted deberá 
...
<p> Si desea utilizar un nuevo archivo css, puede copiar todo el contenido a
...
<p> Si ha conseguido crear un buen archivo css, lo invitamos a que nos envíe
...
<p> Y la ubicación de la imagen será como esta:
<p><i>&lt;img src="&lt;html:rewrite
page="/pages/images/some_image.jpg"/&gt;"&gt;</i>

<p> La página sólo necesita la etiqueta 'html:rewrite" de ubicación de la imagen. 
...
<br>
Es posible sustituir una imagen del sistema en la siguiente <a href="#images_upload"><u>ventana</u></a> ("Actualizar imagen del sistema").</p>
<hr class="help">
...
<img border="0" src="${images}/delete.gif" width="16" height="16">&nbsp; correspondiente.<br>
<br>
Usted puede agregar una imagen personalizada en la siguiente <a href="#images_upload"><u>ventana</u></a> ("Nueva imagen").</p>
<hr class="help">
...
<br>
Si usted hace click sobre una imagen en miniatura (vista previa) de la lista, la misma se mostrará en su tamaño verdadero en una ventana emergente.<br>
Puede agregar una imagen personalizada en la siguiente <a href="#images_upload"><u>ventana</u></a> ("Nueva imagen de hojas de estilo").</p>
<hr class="help">
...
La nueva imagen aparecerá en la lista ubicada en la parte superior de la ventana.</p>
<!--<hr class="help">-->
<hr>
