...
En este módulo se detalla la configuración y las definiciones del sistema Cyclos. </p>
...
<ul>
	...
	Luego de una cantidad "x" de intentos fallidos de ingreso al sistema, se generará una alerta. 
	En el caso de que el miembro exista, una alerta de miembro se generará. 
	En el caso de que el miembro no exista, una alerta de sistema se generará.
</ul>
<hr>
