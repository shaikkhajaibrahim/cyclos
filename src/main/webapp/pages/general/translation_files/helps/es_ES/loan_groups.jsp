...
Todos los miembros también podrán ver y pagar el préstamo. </p>
...
Aquí puede ver los <a href="#loan_groups_top"><u>grupos de préstamo</u></a> a los que pertenecen los miembros.
Para ver más información sobre un grupo de préstamo, haga click en el ícono
<img border="0" src="${images}/view.gif" width="16" height="16"> de visualización.<br>

Para quitar un grupo de préstamo, haga click en el ícono
<img border="0" src="${images}/delete.gif" width="16" height="16"> de eliminación.
Esta acción sólo es posible si no hay préstamos abiertos para el grupo. <p>
Tenga en cuenta que los préstamos no los podrá ver aquí. 
Para ello, deberá ir al Perfil del usuario> Ver préstamos; o al 
...
<p>
<h3> Agregar miembro a grupo de préstamo</h3>
