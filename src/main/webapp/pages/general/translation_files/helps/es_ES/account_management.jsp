...
Toda la información relativa a las cuentas y transacciones, puede ser accedida a través de las funciones de la Administración de cuentas.</p>
...
Esta página muestra los <a href="#account_fees"><u>cargos de cuenta</u></a> existentes y habilitados en el sistema.<br>
Es desplegada la lista con los cargos de cuenta activos y sus datos correspondientes:
<ul>
	<li><b>Nombre.</b></li>
	<li><b>Monto.</b></li>
	<li><b>Última imputación:</b> Fecha y estado (fallido/exitoso) de su última imputación.</li>
	<li><b>Próxima ejecución:</b> Fecha de su próxima ejecución.</li>
</ul>
<p>
Los cargos de cuenta pueden ser tanto automáticos (agendados) como manuales. <br>
Los manuales se ejecutan al hacer click en el enlace &quot;Ejecutar ahora&quot;.<br>
Mientras se está ejecutando es posible detener su progreso, haciendo click en el enlace &quot;Cancelar&quot;. <br>
Un cargo cancelado o fallido por problemas técnicos, ejecutará siempre una &quot;Anulación&quot;.
Esto significa que se deshace la operación, y por lo tanto nunca habrá cargos de cuenta sin finalizar su ejecución (a medio ejecutar).<br>
...
<p>
Si un cargo de cuenta falla, se lanza una alerta que se agrega a la bitácora (log) de alertas
y el estado del cargo muestra que ha fallado. Los cargos fallidos pueden ser reanudados
haciendo click en el enlace &quot;Actualizar&quot; en el historial de cargos de cuenta.
<hr class="help">
...
Si la aplicación de un cargo de cuenta falló, entonces su estado fallido se muestra en dicho historial. 
Dichos cargos pueden ser reanudados haciendo click en el enlace &quot;Actualizar&quot;.
<hr class="help">
...
<ul>
	<li><b>Nombre de cargo de cuenta</b>: El nombre del cargo.<br>
	...
	<li><b>Dirección de pago</b>: Esto define la dirección de pago del cargo de cuenta,
	ya sea del miembro al sistema o en sentido contrario.<br>
	<li><b>Tipo de transacción generada</b>: El cargo de cuenta necesita un tipo de
	transacción. La transacción será del tipo de transacción elegido.<br>
	<li><b>Monto</b>: En caso de seleccionar &quot;Monto fijo&quot; en la
	&quot;Forma de cobro&quot;, este será el monto que se cobrará. De lo contrario, será
	el porcentaje a cobrar sobre el volúmen o el balance.<br>
	<li><b>Base libre</b>: Esta configuración no se mostrará en caso de haber seleccionado
	&quot;Monto fijo&quot; en la &quot;Forma de cobro&quot;. El porcentaje del cargo se
	calculará solamente por encima del monto ingresado en la base libre.<br>
	
	En el ejemplo anterior se aplicaría:
	<ul>
		<li><b>Forma de cobro:</b> &quot;Porcentaje sobre volúmen positivo&quot;
		<li><b>Monto:</b> 1%
	...
	&quot;Miembro a sistema&quot; en dirección de pago.<br>
	Esto determina que sucede si se le cobra a un miembro que no tiene suficiente crédito para pagar el cargo.<br>
	Las siguientes opciones están disponibles:
	<ul>
		...
		<li><b>Nunca (permitir saldo negativo):</b> En este caso se le cobra a todos los
		miembros, aunque no tengan saldo suficiente.
		
		<li><b>Siempre (no cobrarle al miembro automáticamente):</b> En este caso no se le
	...
	<br>
	<li><b>Modo de ejecución</b>: Aquí puede definir si el cargo de cuenta será agendado
	o ejecutado manualmente. Note que no se puede cambiar esta opción una vez creado el cargo, 
	es solamente para nuevos cargos.<br>
	...
	Si el modo es &quot;Agendado&quot;, el cobro se realiza automáticamente al
	momento configurado. <br>
	En ese caso se presentan las siguientes opciones extra:
	<ul>
		<li><b>Intervalo</b>: Es el tiempo de intervalo entre que se ejecuta el cargo.<br>
	...
	<br>
	<li><b>Grupos</b>: Aquí se eligen los grupos que pueden generar o recibir el cargo de la cuenta.
</ul>
<hr class="help">
...
Estos pagos son permitidos siempre.</p>
