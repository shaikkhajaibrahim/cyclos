...
<ul>
	...
	<li> <b> Tipos de transacción: </b> Aquí se indican los tipos de transacciones involucradas y generadas por este tipo de garantía.
	<br>
	Los tipos de transacciones a especificar son los correspondientes a:
		<ul>
			...
			<li> Préstamo </li>
			<li> Redirigido a: </li> Este tipo de transacción sólo será solicitado para el modelo "con obligación de pago".
		</ul>
</ul> 
