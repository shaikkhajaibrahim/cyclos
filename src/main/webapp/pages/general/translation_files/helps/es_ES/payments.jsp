...
<p><span class="member"> Los pagos pueden ser iniciados de tres (3) diferentes formas:<br>
<br>
...
<p> Un broker también puede autorizar 
...
<span class="admin">
<p><i> ¿Cómo hacerlos funcionar?</i><br>
...
<p> <a href="#payments"><u>Haga click aquí</u></a> para obtener una descripción general de las ventanas de pago.
<hr class="help">
</span>
...
Esto también es parte de la configuración.</p>
<hr class="help">
...
<p> La primer sección (parte superior) de la ventana muestra la siguiente información:
<ul>
	<li> <b> Saldo de la cuenta:</b> Saldo actual de la cuenta en su respectiva moneda.</li>
