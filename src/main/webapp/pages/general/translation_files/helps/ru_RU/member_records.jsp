<a NAME="top"></a>
<p class="head_description">Записи об участниках - это определяемые администрацией блоки информации, относящиеся к конкретным пользователям. Есть много параметров для определения и управления записями об участниках. <br>
...
<span class="admin"><p>Это руководство содержит небольшое меню <a href="#guidelines"><u>рекомендаций</u></a>, 
...
<span class="broker">
<p>Эти записи об участнике являются дополнительной информацией, связанной с каждым участником. Вы можете иметь разрешения к просмотру, редактированию и удалению этих записей. 
<p><i>Где это найти?</i><br>
...
<p>В дополнение к изменению настроек записи, вы также должны создать и изменить &quot;Спецполя&quot; в окне <a
