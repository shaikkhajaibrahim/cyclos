<span class="admin broker">                 
				 <DIV class=manualPage><SPAN class="admin broker">
                  <P class=head_description>Все настройки счетов и платежей 
                  производятся в разделе управления счетами.</P><I>Где это 
                  ...
                  каждой группе. 
                  <P></P><I>Где это найти?</I><BR>Доступ к управлению валютами 
...
<P>3. Последний из достойных рассмотрения способов оплаты труда - через учёт затраченного времени. Когда участник получает товар или услугу в перед (в кредит) и обеспечивает временем собственного труда он делает именно человека ключевым звеном экономических отношений и не материальные блага сами по себе. Это будет гарантом его востребованности обществом и стабильности обмена услуг в Системе. За отправную точку можно взять один час простого труда, при котором всё что человек вкладывает это свое время. Например: выгул собак, дежурство и т. п. Работы требующие дополнительных физических/интеллектуальных нагрузок или должного уровня профессионализма/образования могут оцениваться через коэффициент «сложности» который оговаривается участвующими сторонами сделки. В будущем «Человеко-Часы» могут стать общим основанием взаимодействия региональных систем дополнительных валют. Известная истина «Человек - мера всех вещей» торжествует в форме  «Человеческое время — мера отношений между людьми».  
                  ...
                  <P></P>Когда создается новый "Счет Участника", он еще не имеет 
                  ...
                  <P>Система содержит базу данных с набором <A 
                  href="/do/admin/manual?page=account_management#standard_accounts"><U>стандартных 
                  счетов</U></A>. 
                  <P><I>Где это найти?</I><BR>Счетами можно управлять 
                  ...
                  <P>База данных содержит следующие системные счета: 
                  <UL>
                  ...
                  типы счетов). 
                  <P>Чтобы создать новый счет участника или системы, нажмите на 
                  ...
                  <P></P><I>Где это найти?</I><BR>Типы платежей создаются и 
                  ...
                  <P>Примечание1: Разрешения к типам платежей устанавливаются 
                  по группам в "Меню: Пользователи и Группы &gt; Группы с разрешениями &gt; Изменить разрешения группы." 
                  <P>Примечание2: Если выбранный счет - это счет участника, 
                  ...
                  <P>Есть различные уровни полномочий, и их может быть более 
                  ...
                  <P>Это окно отображает все уровни полномочий для данного типа 
                  ...
                  <P>Если вы отмените выбор опции подтверждений в типе платежа, 
                  ...
                  <P>Если подтвержденные платежи генерируют другие платежи 
                  ...
                  отчетов. 
                  <P></P><I>Где это найти?</I><BR>Фильтры платежей всегда 
                  ...
                  <P></P><I>Где это найти?</I><BR>комиссионный сбор будет 
                  ...
                  <P></P><I>Где это найти?</I><BR>Так как абонентские сборы 
                  ...
                  border=0>&nbsp;. 
                  <P>Управление и просмотр абонентского сбора производится на 
                  ...
                  <P>Окно отобразит список с активными абонентскими сборами, дату 
                  последнего и следующего выполнения и их статус ("не 
                  выполнено", "завершено"). 
                  <P>Платежи абонентских сборов могут быть или автоматическими 
                  ...
                  <P>В случае, если сбор не выполнен успешно, появится 
                  ...
                  <P>Доступен следующий выбор настроек</B> 
                  <UL>
                  ...
                  <P><I>Где это найти?</I><BR>Доступ к разделу "Пределы состояния счёта" участника расположен в окне <A 
                  href="${pagePrefix}profiles#accounts_actions"><U>Действия 
                  для участника</U></A> (под личными данными участника). 
                  <P>С этой функцией участнику могут устанавливаться 
                  ...
                  <P>Функция "верхний предел состояния счёта" используется редко. 
