<a name="top"></a>
<p class="head_description">Документы - это страницы с информацией, размещаемой в разделах электронных кабинетов участников Системы. Вы можете выбирать документы из списка.
...
размещаемые для одной или более групп пользователей. Эти документы могут принимать индивидуальный вид для участников, так как информация в них зависит от данных в полях профиля участника, который открывает страницу. </p>
<span class="admin">
...
<p>По каждому создаваемому документу его доступность устанавливается в 
...
<p>Файл документа может быть в любом формате. Если вы выбрали "изменить
...
<p><b>Внимание</b>: Одно только создание документа не означает, что ваши
...
<p>Примечание 2: В разделе проекта приложения в wiki есть примеры динамических документов, блок &quot;конфигурация - дополнительные документы&quot; (&quot;configuration - custom documents&quot;). 
...
<p>Обычно такой документ представляет собой бланк или анкету. При наличии необходимых настроек, документ может вначале содержать для вас поля к заполнению, после чего указанные вами данные будут отображены в самом документе. </span>
