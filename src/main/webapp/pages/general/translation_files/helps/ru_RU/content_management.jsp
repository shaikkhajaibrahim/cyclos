<SPAN class=admin><A name=top></A>
                  <P class=head_description>Система позволяет вам 
                  ...
                  внешний вид можно настраивать. </P><A name=type_list></A>Вы можете настраивать 
                  ...
                  <P>Обратите также внимание, что вы можете установить 
                  ...
                  <P><I>Где это найти?</I><BR>Доступ к Управлению содержанием на 
                  ...
                  группах. 
                  <P><I>Как это работает?</I><BR>Вам нужно установить <A 
                  ...
                  <P>Функция позволяет изменить следующие статические файлы 
                  ...
                  <P>Чтобы избежать проблем, система всегда хранит копию <A 
                  href="/do/admin/manual?page=content_management#edit_customized_file"><U>исходных 
                  страниц</U></A>, которые можно легко восстановить. </P>
                  <P>Вы можете также добавлять <A 
                  href="/do/admin/manual?page=content_management#insert_images"><U>изображения</U></A> 
                  ...
                  аннотации файла css. 
                  <P>В системе есть следующие файлы таблицы стилей: 
                  <UL>
                  ...
                  <P>Чтобы увидеть эффект модификации css файла, необходимо 
                  ...
                  браузере. 
                  <P>Если вы хотите использовать новый css файл, просто 
                  ...
                  prefix="html" %&gt;</I> 
                  <P>И расположения изображения будет выглядеть как: 
                  <P><I>&lt;img src="&lt;html:rewrite 
                  page="/pages/images/some_image.jpg"/&gt;"&gt;</I> 
                  <P>Странице необходим только тег 'html:rewrite' для 
                  ...
                  <P>Это окно показывает список с файлами, которые были <A 
                  ...
                  . 
                  <P>В этом окне вы можете повторно изменить файл, который вы до 
                  ...
                  <P>Когда вы сохраните измененный преобразованный файл, 
                  ...
                  содержания. 
                  <P>Когда вы прекратите настройку файла (удаляя его из списка) 
                  ...
                  <P></P>Вы можете загрузить свои изображения с помощью "Меню: 
                  ...
                  <P>Это окно показывает список с текущими системными <A 
                  ...
                  <P>Это окно показывает список с дополнительными <A 
...
списка.</P>
                  ...
                  <P></P>Функция темы может быть найдена с помощью "Меню: 
                  Управление содержанием &gt; Темы". 
                  <HR>
                  <A name=select_theme></A>
                  <H3>Выбор темы</H3>
                  <P>Чтобы выбрать другую <A 
                  ...
                  новую тему. 
                  <P>Когда вы щелкните кнопку обозначенную "Удалить" тема будет 
                  ...
                  <P>С этой функцией вы можете импортировать <A 
                  href="/do/admin/manual?page=content_management#themes"><U>тему</U></A>. 
                  ...
                  <P>Если вы создали свою собственную <A 
                  href="/do/admin/manual?page=content_management#themes"><U>тему</U></A> 
                  (изменяя <A 
                  ...
                  <UL>
                    ...
                    телефоном </LI></UL>
                  <P><I>Если вы разработали свои собственные темы, то 
