...
Они могут использоваться для поиска участников, регистрации новых участников, просмотра пользователей онлайн или другой информации о состоянии участника.</p>
...
<p>Если существует группа брокеров с правами доступа к группе участника, которого вы создаете, вы можете привязать (по желанию) 
участника к брокеру
...
<p>После заполнения данных у вас есть выбор сохранить участника и добавить нового участника
...
<p>После заполнения данных у вас будет выбор сохранить участника и добавить нового участника еще (кнопка &quot;Сохранить и добавить нового участника&quot;), или же открыть
...
<p>Если вы желаете найти конкретных участников, вы можете заполнить различные поля (ни одно из них не обязательно для заполнения). Если вы нажмете на кнопку &quot;Поиск&quot;
...
<p>У вас есть возможность печати результатов поиска, нажав значок печати 
...
<p>Еще одна возможность - это скачать результаты поиска в файл, нажав значок "сохранить" (<img border="0" src="/pages/images/save.gif" width="16" height="16">&nbsp;).
...
<p>Примечание: В функции отчетов вы сможете получить более детальные 
...
<p>Форма очень проста: вы можете указать просто ключевое слово и/или ограничить поиск определенной группой админов. Если вы просто нажмете на кнопке &quot;Поиск&quot;
без указание какой-либо информации в полях, вы получите список всех администраторов.<br>
<p>Чтобы зарегистрировать нового администратора, используйте выпадающий список внизу формы. <a
...
<p>Форма очень проста. 
Любое поле с красной звездочкой <b>(*)</b> обязательно для заполнения. 
<p><p>После заведения данных, у вас будет возможность сохранить профиль админа, и завести нового (кнопка &quot;Сохранить и добавить нового админа&quot;) или открыть напрямую <a href="${pagePrefix}profiles"><u>страницу личных данных</u></a> нового админа (кнопка &quot;Сохранить и открыть личные данные&quot;).
<hr class="help">
</span>
...
<span class="member">
<p class="head_description">Данный раздел позволяет вам управлять своими контактами. </p>
