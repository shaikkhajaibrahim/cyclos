...
Счета-фактуры могут быть приняты или отклонены их получателем. Посылающий также может отменять их. При любом из этих действий, другая сторона получит соответствующее уведомление. Однако счета-фактуры поступающие со счетов Системы не могут быть отклонены.</p>
<p>
...
<p>Через &quot;Меню: Мой счет > Счета-фактуры&quot; можно просматривать и управлять входящими и исходящими счетами-фактурами.
</span>
...
<p>Для отправки счёта-фактуры заполните следующие поля:
<ul>
...
<p>Это окно позволяет просматривать <a href="#top"><u>счета-фактуры
...
<p>Вы можете задать следующие фильтры поиска:
<ul>
...
<p>Заметьте: При поиске счетов-фактур со статусом отличным от &quot;Открытый&quot;
...
нижнем окне</u></a>.
<p>В "Расширенном" виде можете определить все или некоторые критерии поиска. Их название говорит само за себя. <br>
...
<p>Это окно позволяет (админу или брокеру) просматривать входящие и исходящие <a href="#top"><u>счета-фактуры
</u></a> участника.
<p>Вы можете задать следующие фильтры поиска:
<ul>
	<li><b><a href="#status"><u>Состояние</u></a></b>
