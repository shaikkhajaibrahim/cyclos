...
<p>Используйте опции выбора для того, что вы хотите увидеть, затем нажмите 
&quot;Выполнить&quot;.
...
<ul>
	...
	<p>Для всех различных категорий рекомендаций таблица содержит информацию о том, как часто какая категория предоставлялась.
</ul>
<hr class="help">
...
<p>Выбрав вы выберите много опций, проведение расчетов займет некоторое время. Пожалуйста, будьте терпеливы. <p>
...
<p>ОБРАТИТЕ ВНИМАНИЕ, что вам нужно пройти через заполнение формы в заданном порядке, сверху вниз. Опции платежного фильтра, например, будут пустыми, если вы вначале не выберете тип счета. <p>
Внизу страницы вы можете <a href="#results"><u>распечатать или скачать</u></a> результаты. 
<p>
