                <SPAN class=admin>
                  <P class=head_description>Оповещения служат для уведомления 
                  ...
                  <P>Если вы не заполняете поля редактирования, то вы получите 
                  ...
                  вызвало ошибку. 
                  <P><B>Примечание:</B> Ошибка в приложении - это не обязательно 
