...
<p><i>Где это находится?</i><br>
<p><span class="member">Платежи совершаемые через главную веб-страницу могут быть совершены с тремя способами. Два - из главного меню:</b> 
<ul>
...
<p>Брокер может также <a href="#authorized"><u>подтверждать</u></a> платежи от других участников; это возможно через главное меню &quot;Меню: Брокерство > Платежи на подтверждение&quot; и &quot;Меню: Брокерство > Подтвержденные платежи&quot;.<br>
...
<span class="admin">
<p><i>Как работает платёжная система?</i><br>
...
<p>Нажмите &quot;Выполнить&quot; для запуска платежа. Средства будут непосредственно переведены с вашего счёта на счёт другой стороны. Платёж отобразится в ведомости каждого: для отправителя (плательщика) - красным, со знаком &quot;-&quot; и для получателя - синим, со знаком &quot;+&quot;.
<hr class="help">
...
<p>Для запланированных платежей возможен поиск: &quot;Меню: Счета >
...
.
<p>Всплывающее меню &quot;Запланированный&quot; может принимать три следующих значения:
<ul>
...
<p>Если у вас имеются соответствующие разрешения, внизу будут находиться две клавиши:
<ul>
...
<p>Следующие подробности будут показаны:
<ul>
...
<p>Функция подтверждения платежей включается следующим образом:
<ol>
...
<p>Вы можете задать следующие критерии поиска:
<ul>
...
<p>Нажмите значок просмотра <img border="0" src="${images}/view.gif" width="16"
...
<p>Это происходит так: вы вводите Имя, Сумму, Описание, жмёте &quot;Выполнить&quot; - запрос на платёж будет отправлен по СМС каналу. Участник получает СМС, отвечает на него своим СМС с Пин-кодом, этим самым подтверждая своё согласие на отправку запрашиваемого платежа. После отправки запроса на платёж, его состояние меняется. (смотрите помощь далее). Когда участник подтверждает платёж своим ответом по СМС - состояние платежа меняется на &quot;Выплачено&quot; (и товар может быть передан/послан покупателю).
<hr class="help">
...
<p>Каждые 5 сек. страница обновляется автоматически.
<hr class="help">
...
<p>В верхней части окна отображается следующая информация:
<ul>
...
<p><span class="broker admin"> В случае если платёж нуждается в подтверждении, у вас появится выбор: принять или отклонить платёж. Потребуется ввести комментарии. Если выбрать кнопку-флажок &quot;Показать участнику&quot; - комментарии будут видны участнику, иначе - только вам и администратору.
</span>
<span class="admin">
