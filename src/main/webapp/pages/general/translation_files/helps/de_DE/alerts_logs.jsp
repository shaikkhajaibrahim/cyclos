...
<span class="admin"> 
<p class="head_description">Diese Meldungen sind dazu da, den Administrator über verschiedene 
Ereignisse zu informieren, wie z.B. Systemfehler, Vorgänge in Zusammenhang mit 
Mitgliedern (Anzahl der Anmeldeversuche für ein Konto, Erreichen des Kreditlimits etc.).</p>

<i>Wo ist es zu finden?</i><br>
Meldungen und Protokolle sind zugänglich über &quot;Menü: Meldungen&quot;.<br>
<p><i>Wie werden die Meldungen aktiviert?</i><br>
<a
...
<p><b>Anmerkung:</b> Ein Anwendungsfehler ist nicht notwendigerweise ein Softwarefehler. 
