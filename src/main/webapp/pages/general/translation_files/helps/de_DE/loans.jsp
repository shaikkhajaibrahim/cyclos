...
<a name="top"></a>
<p class="head_description">Darlehen können für Cyclos den grundlegenden Kreditmechanismus 
...
<span class="admin">
<p><i>Wo ist es zu finden, wie können Darlehen verwendet werden?</i><br>
...
<ol>
	...
	<p>Einen neuen Überweisungstyp für die <b>Rückzahlung von Darlehen</b> richten 
	Sie wie folgt ein:
	<ul>
...
<p>Wenn Sie das Kontrollkästchen &quot;Ist Darlehen&quot;gewählt haben, dann ist der von 
...
fortfahren können. 
<p>Verfügbar sind drei verschiedene <a href="#loan_types"><u>Darlehenstypen</u></a>;
...
<p>Drei verschiedene <a href="#top"><u>Darlehenstypen</u></a> sind verfügbar:
...
<p>Um ein Darlehen zu bewilligen, müssen die folgenden Felder ausgefüllt werden: 
<ul>
...
<p>Anmerkung: Falls notwendig, ist es möglich  <a href="${pagePrefix}custom_fields"><u>zusätzliche 
...
Optionsschaltfläche &quot;<a href="#open"><u>Offen</u></a>&quot; oder &quot;
<a href="#closed"><u>Geschlossen</u></a>&quot;. Das 
...
<p>Das Drucken-Symbol <img border="0" src="${images}/print.gif" width="16"
...
und der Möglichkeit, der <span class="admin">or <a href="#discard"><u>Erledigung</u></a></span>
...
<p>Ist das Darlehen eines mit  <a href="#loan_types"><u>mehrfachen Rückzahlungen</u></a> 
...
<p><span class="admin"> Verwenden Sie eine der Schaltflächen um die Rückzahlung zu tätigen oder das 
...
<a name="component"></a>
<b>Darlehenskomponenten</b>
<p>
Eine von mehreren aufeinander folgenden Zahlungen zur Tilgung einer Schuld. Ist die Rückzahlung 
