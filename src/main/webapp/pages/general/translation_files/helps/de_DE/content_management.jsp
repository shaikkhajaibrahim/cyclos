...
<p>
Die Funktion ermöglicht die Änderung der folgenden statischen Dateien (möglicherweise ist 
...
Systembild aktualisieren</u></a> unten.</p>
<hr class="help">
...
Neues benutzerdefiniertes Bild</u></a> unten.</p>
<hr class="help">
...
in einem Popup-Fenster. Um ein benutzerdefiniertes Bild hinzufügen können Sie unter <a
	href="#images_upload"><u>Neues CSS-Bild</u></a> unten.</p>
<hr class="help">
...
<p><i>Wenn Sie Ihr eigenes Theme entwickeln, denken Sie bitte daran, es auch an das 
