...
<p class="head_description">Cyclos enthält einen Bereich für die statistische Analyse 
Ihrer Daten. <br>
...
immer möglich - die Genauigkeit der Zahlen angeben.</p>
<i>Wo ist es zu finden?</i><br>
Sie finden diesen Abschnitt über  &quot;Menü: Berichte > Statistische Analyse&quot;.
<p><i>Wie können Statistiken aktiviert werden?</i>
...
&quot;Berichte&quot;, Kontrollkästchen &quot;Statistiken&quot;.<p>
...
<p><b><u>Warnung:</u> Denken Sie bitte daran, dass die Berechnung statistischer Daten für 
...
<p>The &quot;Hauptzeitraum&quot; ist der Zeitraum, für den die Statistiken berechnet werden. 
...
<p>Je nachdem welche Elemente Sie wählen, kann es sein, dass nicht alle Filter-Bearbeitungsfelder 
...
<ul>
	...
	<p>Einrichten eines neuen Zahlungsfilters für Statistiken: 
	<ol>
...
<p>Nicht alle Filter werden für alle Arten von Statistiken verwendet. Die Ergebnisseite zeigt 
...
<p>Wenn Sie mit Ihrer Maus über eine Markierung in der Grafik fahren, wird Ihnen der 
...
<p>Die Tabelle enthält folgende Zeilen:
<ul>
...
Bitte lesen Sie den <a href="#results"><u>allgemeinen Abschnitt zu Ergebnissen</u></a>, für die 
generellen Regeln in Cyclos-Statistiken.
<p>Die einzelne Zeile zeigt die <a href="#grossProduct"><u>Umsatz</u></a> für die
...
Bitte lesen Sie den <a href="#results"><u>allgemeinen Abschnitt zu Ergebnissen</u></a>, für die 
generellen Regeln in Cyclos-Statistiken.
<p>Die einzelne Zeile zeigt die <a href="#numberOfTransactions"><u>Anzahl der Überweisungen</u></a> 
...
Bitte lesen Sie den <a href="#results"><u>allgemeinen Abschnitt zu Ergebnissen</u></a>, für die 
generellen Regeln in Cyclos-Statistiken.
<p>Die einzelne Zeile zeigt den  <a href="#median"><u>Mittelwert</u></a> des Betrages pro Überweisung, 
in Übereinstimmung mit den von Ihnen spezifizierten <a href="#filters"><u>Filtern</u></a>.
<hr class="help">
...
Bitte lesen Sie den <a href="#results"><u>allgemeinen Abschnitt zu Ergebnissen</u></a>, für die 
generellen Regeln in Cyclos-Statistiken.
<p>Die einzelne Zeile zeigt den Höchstbetrag pro Überweisung, in Übereinstimmung mit den von 
...
<p>Bitte beachten Sie, dass sich die ersten drei Angaben auf das Ende des Zeitraums beziehen, 
...
Bitte lesen Sie den <a href="#results"><u>allgemeinen Abschnitt zu Ergebnissen</u></a>, für die 
generellen Regeln in Cyclos-Statistiken.
<p>Wenn Sie  &quot;Über einen Zeitraum&quot; wählen, erscheint eine historische Übersicht der gewählten 
...
Bitte lesen Sie den <a href="#results"><u>allgemeinen Abschnitt zu Ergebnissen</u></a>, für die 
generellen Regeln in Cyclos-Statistiken.
<p>Diese Tabelle zeigt den <a href="#median"><u>Mittelwert</u></a> <a href="#grossProduct"> der 
...
<p>Für &quot;Vergleichszeiträume&quot;, zeigen die Spalten die Ergebnisse beider angeforderter
...
Bitte lesen Sie den <a href="#results"><u>allgemeinen Abschnitt zu Ergebnissen</u></a>, für die 
generellen Regeln in Cyclos-Statistiken.
<p>Diese Tabelle zeigt die  <a href="#median"><u>mittlere</u></a> <a
...
Alles natürlich je nach den von Ihnen spezifizierten  <a href="#filters"><u>Filtern</u></a>.
<p>Für &quot;Vergleichszeiträume&quot;, zeigen die Spalten die Ergebnisse beider angeforderter Zeiträume, 
...
Bitte lesen Sie den <a href="#results"><u>allgemeinen Abschnitt zu Ergebnissen</u></a>, für die 
generellen Regeln in Cyclos-Statistiken.
<p>Hier erscheint lediglich eine Spalte, die anzeigt, welcher Prozentsatz der Mitglieder während 
...
Bitte lesen Sie den <a href="#results"><u>allgemeinen Abschnitt zu Ergebnissen</u></a>, für die 
generellen Regeln in Cyclos-Statistiken.
<p>Hier erscheint lediglich eine Zeile, die die Anzahl der Anmeldungen pro Mitglied während des 
...
Bitte lesen Sie den <a href="#results"><u>allgemeinen Abschnitt zu Ergebnissen</u></a>, für die 
generellen Regeln in Cyclos-Statistiken.
<p>Diese Tabelle zeigt eine Übersicht der  <a href="#median"><u>mittleren</u></a> <a
...
Bitte lesen Sie den <a href="#results"><u>allgemeinen Abschnitt zu Ergebnissen</u></a>, für die 
generellen Regeln in Cyclos-Statistiken.
<p>Diese Tabelle zeigt die  <a href="#median"><u>mittleren</u></a> <a href="#numberOfTransactions"><u>
...
Bitte lesen Sie den <a href="#results"><u>allgemeinen Abschnitt zu Ergebnissen</u></a>, für die 
generellen Regeln in Cyclos-Statistiken.
<p>Diese Tabelle zeigt eine Übersicht des Mitgliedsprozentsatzes, die innerhalb eines 
<a href="#periods"><u>Zeitraums</u></a>, keinen Handel betrieben haben, während des von Ihnen 
spezifizierten Zeitabschnitts. 
<p>Ein Mitglied wird als &quot;nicht Handel treibend&quot; betrachtet, wenn es in dem von 
...
Bitte lesen Sie den <a href="#results"><u>allgemeinen Abschnitt zu Ergebnissen</u></a>, für die 
generellen Regeln in Cyclos-Statistiken.
<p>Diese Tabelle verschafft Ihnen einen Überblick über den Verlauf der  <a href="#median">
...
Bitte lesen Sie den <a href="#results"><u>allgemeinen Abschnitt zu Ergebnissen</u></a>, für die 
generellen Regeln in Cyclos-Statistiken.
<p>Diese Grafik zeigt ein  <a href="#histo"><u>Balkendiagramm</u></a> der <a
...
Bitte lesen Sie den <a href="#results"><u>allgemeinen Abschnitt zu Ergebnissen</u></a>, für die 
generellen Regeln in Cyclos-Statistiken.
<p>Diese Grafik zeigt ein  <a href="#histo"><u>Balkendiagramm</u></a> der 
...
Bitte lesen Sie den <a href="#results"><u>allgemeinen Abschnitt zu Ergebnissen</u></a>, für die 
generellen Regeln in Cyclos-Statistiken.
<p>Diese Grafik zeigt ein  <a href="#histo"><u>Balkendiagramm</u></a> der Anzahl der Anmeldungen pro 
...
Bitte lesen Sie den <a href="#results"><u>allgemeinen Abschnitt zu Ergebnissen</u></a>, für die 
generellen Regeln in Cyclos-Statistiken..
<p>Diese Tabelle zeigt Ihnen die 10 Mitglieder mit dem höchsten  <a href="#grossProduct">
...
Bitte lesen Sie den <a href="#results"><u>allgemeinen Abschnitt zu Ergebnissen</u></a>, für die 
generellen Regeln in Cyclos-Statistiken.
<p>Diese Tabelle zeigt Ihnen die 10 Mitglieder mit der höchsten  <a	href="#numberOfTransactions">
...
Bitte lesen Sie den <a href="#results"><u>allgemeinen Abschnitt zu Ergebnissen</u></a>, für die 
generellen Regeln in Cyclos-Statistiken.
<p>Diese Tabelle zeigt Ihnen die 10 Mitglieder mit der höchsten Anzahl an Anmeldungen innerhalb 
des spezifizierten  Haupt-<a href="#periods"><u>Zeitraums</u></a>.
<hr class="help">

<p>
<h2>Ergebnisse Mitgliedsaktivitäten</h2>
</p>
<p></p>
...
Bitte lesen Sie den <a href="#results"><u>allgemeinen Abschnitt zu Ergebnissen</u></a>, für die 
generellen Regeln in Cyclos-Statistiken.
<p>Diese Tabelle zeigt eine Übersicht der eingehenden und ausgehenden Zahlungen für das spezifizierte 
Systemkonto. Die letzte Spalte zeigt die Differenz zwischen Einnahmen und Ausgaben. 
<p>Die von Ihnen spezifizierten Zahlungs-<a href="#filters"><u>Filter</u></a> erscheinen in 
...
<p>Wenn Sie nur einen Zahlungsfilter gewählt haben, so wird dieser Zahlungsfilter in die darin 
...
Bitte lesen Sie den <a href="#results"><u>allgemeinen Abschnitt zu Ergebnissen</u></a>, für die 
generellen Regeln in Cyclos-Statistiken.
<p>Diese Tabelle oder Grafik zeigt eine Übersicht über die Einkünfte (wenn Sie Einkünfte gewählt haben) 
...
<p>Um die Übersicht zu behalten, raten wir dazu, bei der Gestaltung dieser Tabelle/Grafik nicht zu 
...
Bitte lesen Sie den <a href="#results"><u>allgemeinen Abschnitt zu Ergebnissen</u></a>, für die 
generellen Regeln in Cyclos-Statistiken.
<p>Diese Tabelle zeigt eine Übersicht des Verlaufs, in den Kategorien von Einkünften oder 
...
<p>Ein Vertrauensbereich ist ein Anzeichen für die Genauigkeit der Daten. Er bedeutet, 
...
<p>Die Berechnung von Vertrauensbereichen basiert normalerweise auf der Annahme einer 
...
<p>In Statistiken basiert ein Resultat auf einer Reihe von Beobachtungen, die der 
...
<p>Dies ist die Summe aller <b>eingehenden</b> Überweisungen über einen gewissen 
<a href="#periods"><u>Zeitraum</u></a>. Also alle während eines Zeitraums eingenommenen Einheiten.
<hr class='help'>

<a name="histo"></a> <b>Diagramm</b>
<p>Ein Balkendiagramm ist eine Grafik, die darstellt, wie sich eine bestimmte Beobachtung 
...
<p><b>Anmerkung:</b> : Das Programm berechnet automatisch eine optimale Unterteilung der X-Achse 
...
<p>Normalerweise wird der Mittelwert oder der Durchschnittswert verwendet, um einen auf einer Reihe 
...
<p>Wird der Mittelwert aus einer Reihe von ganzen Zahlen errechnet, verwenden wir eine ausgleichende 
...
<p>Die Verwendung des Mittelwertes statt des Durchschnitts hat einige <b>Konsequenzen</b>:
<ul>
...
<p>Dies sind Mitglieder mit 0 Überweisungen. Es gibt also weder eingehende noch 
ausgehende Überweisungen. 
<hr class='help'>

<a name="N"></a> <b>n</b>
<p>die Anzahl der Elemente in einer Zahlenreihe (n = Grundgesamtheit).
<hr class='help'>

<a name="numberOfTransactions"></a> <b>Anzahl der Überweisungen </b>
<p>Im Gegensatz zu den <a href="#grossProduct"><u>Umsatz</u></a>, werden für die 
Summe der Überweisungen eines Mitglieds sowohl eingehende als auch ausgehende Überweisungen 
eingerechnet. 
<hr class='help'>

<a name="p"></a> <b>p-Wert</b>
<p>Beim Vergleich zweier oder mehrerer  <a href="#periods"><u>Zeiträume</u></a>, wird 
...
<p>Ein statistischer Test wird normalerweise durchgeführt, wenn Sie wissen wollen ,ob 
