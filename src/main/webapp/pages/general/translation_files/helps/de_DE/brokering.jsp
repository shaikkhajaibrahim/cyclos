...
Innerhalb eines Systems kann es unterschiedliche Typen von Brokergruppen geben. </span></p>
Brokern ist es möglich, mit den einzelnen Mitgliedern <a href="#commission_contracts">
<u>Verträge</u></a> über die Kommission abzuschließen.

<p><span class="broker"> <i>Wo ist es zu finden?</i><br>
...
<p><span class="admin"> <i>Wo ist es zu finden?</i> <br>
...
<p><i>Wie werden die Broker-Funktionen aktiviert?</i><br>
...
<p><b>Anmerkung:</b> Es macht keinen Sinn, Brokern oder Mitgliedern Zugang zu 
...
<ul>
	...
	Bei bestehenden <a href="#commission_contract"><u>Brokerverträgen</u></a> können die 
...
Änderungen, oder durch individuelle <a href="#commission_contract"><u>Verträge</u></a> 
zwischen Brokern und Mitgliedern, aufgehoben.
...
<a href="#commission_contract"><u>Verträge</u></a> die von Ihnen hier getätigten 
Einstellungsänderungen aufheben.
<p>
...
<img border="0" src="${images}/calendar.gif" width="16" height="16">&nbsp;verwenden.<p> 
