...
<p><span class="member">Zahlungen im Haupt-Kommunikationsweg können von drei verschiedenen Orten
...
<p>Ein Broker kann auch Zahlungen eines Mitglieds  <a href="#authorized"><u>autorisieren</u></a>. 
...
<span class="admin">
<p><i>Wie werden Zahlungen aktiviert?</i><br>
...
tätigen. 
<p><a href="#payments"><u>Hier klicken</u></a>, um eine allgemeine Beschreibung der Zahlungsfenster 
zu sehen. 
<hr class="help">
</span>
...
<ol>
	<li><b>Berechtigungen:</b> Zuerst müssen Sie die  <a
		href="${pagePrefix}groups#manage_group_permissions_member"><u>Berechtigungen</u></a> für 
...
Es enthält eine Beschreibung der dazu nötigen speziellen Felder im Fenster
<a href="#payments"><u>Zahlung</u></a>.
<p>Das Auswahlfeld &quot;geplant&quot; enthält drei mögliche Werte: 
<ul>
...
<p>Wenn Sie die Berechtigungen haben, sind zwei Schaltflächen im unteren Teil des Fensters 
verfügbar. 
<ul>
...
möglich.
<p>Autorisierte Zahlungen können wie folgt aktiviert werde: 
<ol>
...
<p>Autorisierte Zahlungen finden Sie:
<ul>
...
<p>Die folgenden Suchkriterien können Sie festlegen: 
<ul>
...
In diesem Fenster können über ein anderes Medium (<a href="#accessing_channels"><u>
Kommunikationsweg</u></a>) um Zahlung ersuchen. 
...
<p>Der erste (obere) Abschnitt des Fensters zeigt die folgenden Informationen: 
<ul>
