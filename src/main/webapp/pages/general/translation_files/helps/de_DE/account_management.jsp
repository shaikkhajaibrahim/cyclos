...
<p class="head_description">Alle Konfigurationen in Zusammenhang mit Konten und 
Überweisungen können in den Kontoverwaltungsfunktionen getätigt werden.</p>
...
Zahlungsfilter.
<p>Die Cyclos-Standardkonfiguration bietet eine Reihe von <a href="#standard_accounts"><u>
...
<p>Die Standardkonfiguration bietet die folgenden Standard-Systemkonten:
<ul>
...
<p>Um ein neues Mitglieds- oder Systemkonto einzurichten, klicken Sie bitte auf die
...
<p>Anmerkung 1: Die Berechtigungen für einen Überweisungstyp sind pro Gruppe definiert, 
und können im &quot;Menü: Benutzer und Gruppen > Gruppen > Symbol: Berechtigungen bearbeiten&quot;
eingestellt werden.
<p>Anmerkung 2: Ist das gewählte Konto ein Mitgliedskonto, so sind die spezifischen 
...
<br>
<p><b><a href="#account_fees"><u>Periodische Gebühren</u></a></b>
<ul>
...
<p><b><a href="#transaction_fees"><u>Überweisungsgebühren</u></a></b>.
...
<p>Verschiedene Ebenen der Autorisierung sind möglich, und es gibt möglicherweise 
...
<p>Dieses Fenster zeigt alle Autorisierungsebenen für den Überweisungstyp. Ist keine 
...
<p>Wenn Sie die Autorisierungsoption im Überweisungstyp deaktivieren, sperren Sie damit 
...
<p>Wenn eine autorisierte Zahlung andere Zahlungen generiert (z.B. ein Darlehen mit 
...
<ul>
  ...
  <br><br>
	...
	die Gebühr nicht belastet und das System wird sie ignorieren.<br>
	<br>
	<li><b>Wird abgebucht von:</b> Hier können Sie definieren, wessen Konto belastet wird. Dies 
	kann ein Systemkonto des Ursprungs (Auftraggeber), das Zielkonto (Empfänger) oder ein 
	festgelegtes Mitglied sein.<br>
	<br>
	<li><b>Wird erhalten von:</b> Hier können Sie definieren, wer die Gebühr erhalten wird. 
	Dies kann ein Systemkonto des Ursprungs (Auftraggeber), das Zielkonto (Empfänger) oder 
	ein festgelegtes Mitglied sein.<br>
	<br>
	...
	Überweisungstypen gezeigt, auch in anderen Währungen.<br>
	<br>
	...
	Einrichtung der Gebühr selbst geschieht (lesen Sie bitte dazu die Anmerkung oberhalb).<br>
	<br>
	...
	gewählt haben).	Falls Sie im vorherigen Bearbeitungsfeld irgend etwas anderes gewählt haben, 
	erscheint dieses Feld nicht.<br>
	<br>
...
Sie einen Kontotyp und klicken Sie auf das Bearbeiten-Symbol <img border="0" src="${images}/edit.gif"
	width="16" height="16">.
<p>Verwaltung und Übersicht der Kontogebühren finden Sie auf der Seite Kontenübersicht 
...
<p>Das Fenster zeigt eine Liste der aktiven (freigegebenen) Kontogebühren, deren letztes 
und nächstes Durchführungsdatum sowie deren Status (&quot;Fehlgeschlagen&quot;,
&quot;Erfolgreich&quot;).
<p>Kontogebühren können entweder automatisch (planmäßig) oder manuell ausgeführt werden. 
Manuell auszuführende Kontogebühren werden nur dann ausgeführt, wenn der Link 
&quot;Jetzt ausführen&quot; angeklickt wird. Während der Ausführung der Kontogebühr 
kann durch Anklicken des Links &quot;Abbrechen&quot; die Ausführung der Kontogebühr 
unterbrochen werden.<br>
Eine abgebrochene Gebühr oder eine aus technischen Gründen fehlgeschlagene Gebühr führt 
immer zu einem &quot;Rollback&quot;. Es gibt also niemals halb-ausgeführte Kontogebühren. 
Nach der letzten erfolgreichen Ausführung der Kontogebühren wird das letzte Ausführungsdatum 
eingestellt, und ein Eintrag erscheint im <a href="#account_fee_history">
<u>Kontogebühr-Verlauf</u></a> (siehe Fenster unten).
<p>Ist eine Kontogebühr fehlgeschlagen, erscheint eine Meldung im Meldungsprotokoll, und der 
Status wird eine fehlgeschlagene Gebühr anzeigen. Durch Anklicken des Links 
&quot;Erneut abbuchen&quot; im Kontogebührenverlauf kann eine fehlgeschlagene Gebühr erneut 
ausgeführt werden.
<hr class="help">

<a name="account_fee_history"></a>
<h3>Kontogebühren-Verlauf</h3>
Diese Seite zeigt alle in der Vergangenheit abgebuchten <a href="#account_fees"><u>Kontogebühren</u></a>. 
Ist eine Kontogebühr fehlgeschlagen, erscheint eine Meldung im Meldungsprotokoll, und der 
Status wird eine fehlgeschlagene Gebühr anzeigen. Durch Anklicken des Links 
&quot;Erneut abbuchen&quot; im Kontogebührenverlauf kann eine fehlgeschlagene Gebühr erneut 
ausgeführt werden.
<hr class="help">
...
<p>Die folgenden Konfigurationsoptionen sind verfügbar:</b>
<ul>
	...
	<br>
	<li><b>Freigeben ab:</b> wählen Sie hier, wann der erste Berechnungszeitraum beginnen 
	soll. Um das Zeitauswahlfeld zu benutzen, klicken Sie bitte auf das Kalender-Symbol
	<img border="0" src="${images}/calendar.gif" width="16"	height="16">.<br>
	Wenn Sie dies getan haben, können Sie die nächste Ausführung überprüfen, unter 
	&quot;Menü: Konten > Kontogebühren&quot;.<br>
	<br>
	...
	<ul>
		...
		Der zu zahlende	Betrag basiert auf Zeitraum und Betrag. Der Zins bzw. die 
		Liquiditätsgebühr von 1% auf ein Mitgliedsguthaben von 100 Einheiten beträgt für 
		einen Monat 1 Einheit.
	...
	bestimmten Betrag geltend zu machen.<br>
...
<p>
Mit dieser Funktion können individuelle Kreditlimits für Mitglieder eingestellt werden. 
...
<p>Das obere Kreditlimit ist eine nur selten benutzte Funktion. Erreicht ein Mitglied das 
