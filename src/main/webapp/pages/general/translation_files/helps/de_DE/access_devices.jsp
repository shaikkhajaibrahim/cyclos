...
<p class="head_description"> Ein Zugangsgerät ist ein Zahlungshilfsmittel 
...
kann zwar mehrere Karten besitzen, aber nur eine aktive Karte.<br>
<br>
...
Die Karte basiert auf einem <a href="#edit_card_type"><u>Kartentyp</u></a>
einer Art Vorlage für die Karten.</p>
</span>
...
unter Brokering-Aktionen im Profil gefunden werden.</span>
...
Um einen Karte generieren zu können, muss ein &quot;Kartentyp&quot; existieren, und dieser 
...
Auf dieser Seite können Sie einen Kartentyp erstellen oder bearbeiten. Ein Kartentyp kann nur 
...
Software (oder jedes andere Gerät mit ). Ein POS befindet sich normalerweise direkt im 
