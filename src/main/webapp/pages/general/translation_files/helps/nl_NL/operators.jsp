...
<a name="top"></a>
<p class="head_description">The operators function allows a member to define
...
login&quot; checkbox.
<p><b>Note:</b> If you customize the login page, be sure to keep the code
...
<p>You can also create a new operator. This is done by selecting an operator
...
<span class="member notOperator">
<p>If this very operator is logged in at the moment you check this screen,
...
<p>The operators that belong to this group may receive these autorisaties
...
<br>
<p>Clicking the &quot;Remove permanently&quot; option will remove the
