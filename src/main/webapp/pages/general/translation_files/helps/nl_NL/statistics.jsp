...
<p class="head_description">Cyclos has a section for statistical analysis of
your data. <br>
...
<p><b><u>Warning:</u> Please be aware that statistical calculations on large
...
<p>The &quot;Main Period&quot; is the period over which the statistics are
...
&quot;filters&quot;.
<p>Depending on which items you chose, not all filter edits may be visible.
...
<ul>
	...
	<p>To create a new payment filter for statistics:
	<ol>
...
<p>Not all filters are used for all types of statistics. Usually, in the
...
<p>If you hoover your mouse above a bar in the graph, the numeric value of
...
<p>The following rows are shown in this table:
<ul>
...
Please see the <a href="#results"><u>general section on results</u></a> for
general conventions in cyclos statistics.
<p>The single row shows the <a href="#grossProduct"><u>Gross Product</u></a>
...
Please see the <a href="#results"><u>general section on results</u></a> for
general conventions in cyclos statistics.
<p>The single row shows the <a href="#numberOfTransactions"><u>number
...
Please see the <a href="#results"><u>general section on results</u></a> for
general conventions in cyclos statistics.
<p>The single rows shows the <a href="#median"><u>median</u></a> amount per
...
Please see the <a href="#results"><u>general section on results</u></a> for
general conventions in cyclos statistics.
<p>The single rows shows the highest amount per transaction according to the
...
Please see the <a href="#results"><u>general section on results</u></a> for
general conventions in cyclos statistics.
<p>The following rows are shown:
<ul>
...
<p>Note that the first three items are <i>at the end of the period</i>,
...
Please see the <a href="#results"><u>general section on results</u></a> for
general conventions in cyclos statistics.
<p>If you selected &quot;through time&quot; a historical overview of the
...
Please see the <a href="#results"><u>general section on results</u></a> for
general conventions in cyclos statistics.
<p>This table shows the <a href="#median"><u>median</u></a> <a href="#grossProduct"><u>gross
...
specified.
<p>For &quot;compare periods&quot;, the columns show the results for the two
...
Please see the <a href="#results"><u>general section on results</u></a> for
general conventions in cyclos statistics.
<p>This table shows the <a href="#median"><u>median</u></a> <a
...
Please see the <a href="#results"><u>general section on results</u></a> for
general conventions in cyclos statistics.
<p>Only one row is shown, indicating the percentage of members who did not
...
Please see the <a href="#results"><u>general section on results</u></a> for
general conventions in cyclos statistics.
<p>Only one row is shown, indicating the number of logins over the <a
...
Please see the <a href="#results"><u>general section on results</u></a> for
general conventions in cyclos statistics.
<p>This table gives an overview of the <a href="#median"><u>medain</u></a> <a
...
Please see the <a href="#results"><u>general section on results</u></a> for
general conventions in cyclos statistics.
<p>This table gives an overview of the percentage of members not trading
during a <a href="#periods"><u>period</u></a>, over the time range you
specified.
<p>A member is considered &quot;not trading&quot; if he didn't perform any transaction
...
Please see the <a href="#results"><u>general section on results</u></a> for
general conventions in cyclos statistics.
<p>This table gives a historical overview of the <a href="#median"><u>median</u></a>
...
Please see the <a href="#results"><u>general section on results</u></a> for
general conventions in cyclos statistics.
<p>This graph gives a <a href="#histo"><u>histogram</u></a> of the <a
...
Please see the <a href="#results"><u>general section on results</u></a> for
general conventions in cyclos statistics.
<p>This graph gives a <a href="#histo"><u>histogram</u></a> of the number of
...
Please see the <a href="#results"><u>general section on results</u></a> for
general conventions in cyclos statistics.
<p>This table gives the ten members with the highest <a href="#grossProduct"><u>gross
...
Please see the <a href="#results"><u>general section on results</u></a> for
general conventions in cyclos statistics.
<p>This table gives the ten members with the highest <a
...
Please see the <a href="#results"><u>general section on results</u></a> for
general conventions in cyclos statistics.
<p>This table gives the ten members with the highest number of logins during
...
Please see the <a href="#results"><u>general section on results</u></a> for
general conventions in cyclos statistics.
<p>This table gives an overview of incoming and outgoing payments for the
specified system account. The final column gives the difference between income
and expenditure.
<p>The payment <a href="#filters"><u>filters</u></a> you specified are shown
...
<p>If you selected only one payment filter, then this filter is split up
...
Please see the <a href="#results"><u>general section on results</u></a> for
general conventions in cyclos statistics.
<p>This table or graph gives an overview of the income (in case you selected
...
specified.
<p>In order to keep an overview, we advise not to select too many
...
Please see the <a href="#results"><u>general section on results</u></a> for
general conventions in cyclos statistics.
<p>This table gives an overview of income (or expenditure) categories
...
<p>A confidence interval is an indication of the precision of the data. It
...
<p>Confidence intervals are usually calculated on the assumption of some <a
...
<p>In statistics, a result is based on a set of observations, from which you
...
<p>This is the sum of all <b>incoming</b> transaction amounts over a certain
<a href="#periods"><u>period</u></a>. So all the units earned over a period.
<hr class='help'>

<a name="histo"></a> <b>Histogram</b>
<p>A Histogram is a graph showing how observations are spread over a
...
value.
<p><b>Note:</b> The program automatically calculates the optimal division of
...
<p>Normally, the mean or average would be used to indicate the value of a
...
<p>In case of calculating a median from a set of integers (= whole numbers),
...
case of integers.
<p>Using the median in stead of the average has a few <b>consequences</b>:
<ul>
...
<p>These are members having 0 transactions. So no transactions coming in as
well as no transactions going out.
<hr class='help'>

<a name="N"></a> <b>n</b>
<p>the number of items in a set of numbers.
<hr class='help'>

<a name="numberOfTransactions"></a> <b>Number of transactions</b>
<p>In contrast to the <a href="#grossProduct"><u>gross product</u></a>, for
the sum of someones transactions, both incoming and outgoing transactions of a
member are counted.
<hr class='help'>

<a name="p"></a> <b>P-value</b>
<p>When comparing two or more <a href="#periods"><u>period</u></a>s, a
...
<p>A statistical test is usually performed if you want to know if two (or
