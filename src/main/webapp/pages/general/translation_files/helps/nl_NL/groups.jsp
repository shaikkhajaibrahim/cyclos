...
<p class="head_description">Cyclos has a categorization of users in groups.
...
<p>The fact that a Member can only be in one group does not mean that all
...
<p>Cyclos ships with a set of standard groups. Normally, these groups should
...
<p><span class="admin"> <i>Waar te vinden</i><br>
...
groups</u></a>.
<p>After you have submitted the change of group, it is placed in the history
...
<p>After you have submitted the change, it is placed in the history box, in
...
change, the date and the actual group change which was performed (&quot;from
group x to y&quot;).
<p>This way the administrators can have a quick overview of what happened
...
<p>In this window there is also the possibility to remove an administrator
...
<p>Note that you cannot set autorisaties here; group properties and settings
...
overview</u></a>, but you may also use the shortcut button below the window labeled
&quot;Group Permissions&quot;.<br>
<p>Member group settings are ordered by category. The following categories
...
overview</u></a>, but you may also use the shortcut button below the window labeled
&quot;Group Permissions&quot;.<br>
<p>Broker group settings are ordered by category. The following categories
are availible; you may click the links to get details about the fields in these
categories:
<ul>
...
<p>Note: After creating a group it is not possible to change the type and
...
<p>You can also detach an account type for this group by clicking the <img
...
<p>You may also associate a new account type to this group, by clicking the
...
<p>This window gives an overview of customized files for this group. If no
...
.
<p>Note: When you want to include pictures in the static files they will
...
<p>The autorisaties structure is quite straightforward. Most functions have
...
<p>In the first select box (&quot;Manages groups:&quot;) you can select one
...
<p>The following autorisaties can be set - you may want to use the links for
more information:
<ul>
...
<p>If the function has specific autorisaties (apart from manage and view) the
