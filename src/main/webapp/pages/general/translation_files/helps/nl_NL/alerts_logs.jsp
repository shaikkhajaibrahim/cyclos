...
<span class="admin"> 
<p class="head_description">Alerts are for notifying administrators of
various events including system errors, and events concerning members (number of
login attempts with an account, reaching credit limit, etc).</p>
...
caused the error.
<p><b>Note:</b> An application error is not necessarily a bug. Because of
