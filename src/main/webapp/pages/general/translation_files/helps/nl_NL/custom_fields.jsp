...
<p class="head_description">Often, organizations running cyclos want their
...
.
<p>The list show all the custom fields which are defined for this subject.<br>
...
<p>The name and configuration of the fields can be modified by selecting the
...
<p>Selecting the &quot;Change field order&quot; Submit button gives you the
...
<a href="${pagePrefix}member_records"><u>member records</u></a>
.
<p>Here you can define the order that the custom fields will show up in the
...
<p>You can delete a value by selecting the delete icon. This only works when
