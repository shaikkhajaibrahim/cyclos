...
shown.
<p>Use the checkboxes to select what you want to view, and then click
&quot;submit&quot;.
...
<ul>
	...
	<p>For all different reference categories, the table shows how often this
...
<p>If you check a lot of checkboxes, it could take a few seconds to make the
calculations. So please have patience.<p>
...
much data.
<p>NOTE that you have to go through the form in the given order, from top to
bottom. The payment filter box may for example be empty if you do not first
select an account type. <p>
At the bottom of the page, you can <a href="#results"><u>print or download</u></a> the results.
<p>
...
local settings help</u></a> for more information on this configuration.</span><p>
