...
<p><i>Waar te vinden?</i><br>
<p><span class="member">In de webtoegang kan een betaling vanaf drie plaatsen
worden gestart. 
<ul>
...
<p>A broker can also <a href="#geautoriseerd"><u>authorize</u></a> payments of
...
<p>If you have the autorisaties, two buttons may be available at the bottom
of the window:
<ul>
...
<p>You can find geautoriseerd payments at the following locations in the
software:
<ul>
...
<p><span class="broker admin"> Als de transactie moet worden geautoriseerd,
