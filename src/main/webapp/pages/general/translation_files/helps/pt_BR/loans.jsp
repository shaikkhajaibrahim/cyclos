...
<a name="top"></a>
<p class="head_description">Empréstimos podem prover um mecanismo
...
<span class="admin">
<p><i>Onde encontrar / Como ativar.</i><br>
...
<ol>
	...
	também.
	<p>Um novo tipo de transação para o <b>pagamento de volta do
...
ícone de voltar.)</i>
<p>Se você marcou a caixa &quot;é empréstimo&quot; significa que o <a
	href="${pagePrefix}account_management#transaction_types"><u>tipo
...
primeiro.
<p>Existem três <a href="#loan_types"><u>tipos de
...
<p>Existem três <a href="#top"><u>tipos de empréstimos</u></a>
disponíveis;
<ul>
	<li><b>Empréstimo simples (pagamento único):</b> Deve ser pagado
	de volta na data (ou antes) específica. Se o seu empréstimo for desse
...
<p>Os seguintes campos devem ser preenchidos para conceder um
empréstimo:
<ul>
...
<p>Note: É possível criar <a href="${pagePrefix}custom_fields"><u>campos
...
empréstimo.
<p>O ícone imprimir (<img border="0" src="${images}/print.gif"
...
<p>Se o empréstimo for um empréstimo com <a href="#loan_types"><u>pagamentos
...
<p><span class="admin">Use um dos botões para pagar ou
...
<b>Parcela</b>
de um empréstimo
<p>Um de um número sucessivo de pagamentos em liquidação de um
...
Arquivos
<b>CSV</b>
<p>CSV significa &quot;comma separated values&quot; valores
