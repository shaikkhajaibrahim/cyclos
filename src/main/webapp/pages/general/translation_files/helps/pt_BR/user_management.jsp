...
<span class="admin">
<p class="head_description">Estas páginas são as funções de
...
<p>Caso exista um grupo de corretores que possua permissões de
...
<p>Após preencher os dados, você tem a opção de salvar o membro e
...
abrir diretamente o <a href="${pagePrefix}profiles"><u>perfil</u></a> do
novo membro (botão &quot;Salvar e abrir perfil&quot;).
<p>Para registrar um novo membro, você pode receber uma <a
...
<p>Se você deseja procurar por um membro, você pode preencher vários
...
<p>Para registrar um novo membro, você terá que usar a caixa de
...
resultado da busca.
<p>Você possui a opção de imprimir o resultado, clicando no ícone de
...
<p>Outra possibilidade é baixar o resultado em um arquivo, clicando
...
<p>Note: Na função de relatórios você poderá obter <a
...
<p>O formulário é bastante simples: Você pode especificar apenas uma
...
<p>Para registrar um novo administrador você terá que usar a caixa
...
<p>O formulário é bastante simples. Qualquer campo com um asterisco
(*) vermelho é obrigatório.
<p>
<p>Após preencher os dados você terá a opção de salvar o
...
<p><A NAME="contacts"></A>
<h3>Contatos</h3>
<p class="head_description">Esta tela lhe permite gerenciar seus
contatos.</p>
