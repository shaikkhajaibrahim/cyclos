...
<a name="top"></a>
<p class="head_description">Documentos são páginas com informações que
...
<p>Para cada documento criado, a visibilidade tem que ser definida
...
arquivo.
<p>O arquivo do documento pode ser em qualquer formato. No caso de
...
atual do documento.
<p><b>Atenção</b>: Apenas criando um documento não quer dizer que os
...
<p>Nota 2: Existem exemplos de documentos dinâmicos disponíveis no
...
imprimidos.
<p>Se especificado pela administração, o documento pode mostrar
