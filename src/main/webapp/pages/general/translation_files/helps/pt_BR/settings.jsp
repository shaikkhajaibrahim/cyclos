...
<p class="head_description">As configurações do Cyclos definem
qualquer configuração a nível de sistema.</p>
<i>Onde encontrar.</i>
<br>
...
<b>SMS: </b>
<p>Se você ativar SMS, o cyclos irá permitir pagamento, faturas e
...
original.
<p>Tenha muito cuidado, se você estornar uma transação que é
relativa a um empréstimo, isto pode resultar em erros caso o empréstimo
tenha sido pago.
<p><b>Tarefas agendadas: </b> Esta configuração é normalmente usada
...
Para poder fazer alterações clique no botão &quot;alterar&quot;; Para
salvar as alterações clique em &quot;enviar&quot;.
<p>As seguintes configurações são possíveis:
<ul>
...
<p>Você pode editar uma cliente de serviço clicando no ícone de
