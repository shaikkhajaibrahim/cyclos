...
<a name="top"></a>
<p class="head_description">Um perfil é um conjunto de informações
...
várias ações a partir do perfil de alguém.</p>
</span>
...
<p>A maioria dos itens é bastante simples. Se você esta vendo o
...
alterações.
<span class="member">
<p>É claro que o perfil de outros membros não pode ser modificado, e
...
<p>Algumas informações gerais do formulário:
<ul>
...
<p>Este formulário é bastante simples, e a maioria dos itens são
...
<p>As janelas de ajuda dão um resumo do máximo de ações disponíveis.
...
cima para baixo.)
<p>Ações e perfis para operadores são explicados no arquivo de ajuda
de operadores.
<hr>
...
<p>As seguintes seções existem. Clique nos links para ir à descrição
