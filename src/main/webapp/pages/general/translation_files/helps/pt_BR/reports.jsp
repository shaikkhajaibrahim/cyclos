...
<p class="head_description">Relatórios permitem a você ter uma visão
...
<ul>
	...
	<p>Para todas categorias diferentes de referências, a tabela mostra
...
<p>Se você marcar muitas opções, este pode demorar alguns segundos
para realizar os cálculos, Portanto tenha paciência.
<p>No final da página você pode <a href="#results"><u>imprimir
ou baixar (gravar)</u></a> os resultados.
<p>As seguintes opções estão disponíveis:
<ul>
...
dados.
<p>Observe que você deve ir através do formulário na ordem dada, de
cima para baixa. A caixa para filtro de pagamento pode estar vazia, caso
você não tenha escolhido um tipo de conta antes.
<p>No final da página, você pode <a href="#results"><u>imprimir
ou baixar (gravar)</u></a> os resultados.
<p>No formulário, você pode especificar os seguintes elementos:
<ul>
...
<p>Esta janela permite que você obtenha uma visão geral das
