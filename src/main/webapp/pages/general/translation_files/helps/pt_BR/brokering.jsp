...
<p class="head_description">O membro de um tipo de grupo de
...
<p><b>Observe</b> que não faz sentido dar acesso as comissões aos
...
<p>A comissão tem as seguintes configurações:
<ul>
...
<p>Se a administração não definiu nenhuma configuração de comissão,
esta janela estará vazia. Neste caso você deve notifica-los.
<p>Você pode mudar suas configurações clicando no botão
...
<p><span class="broker"> Dependendo da configuração do
...
<P><span class="member">Se o estado for &quot;pendente&quot;,
...
<p>Você deve definir a &quot;data de início&quot;, &quot;data de
...
<p>Uma vez ativo, o contrato de comissão não pode ser apagado.
