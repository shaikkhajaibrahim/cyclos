...
<span class="admin">
<p class="head_description"> Alertas são para notificar
...
com uma determinada conta, atingindo o limite de crédito, etc).</p>
...
<p>Se você não preencher nenhum campo, você obterá uma visão geral
...
<p><b>Nota:</b> Uma erro de sistema não é necessariamente um bug.
