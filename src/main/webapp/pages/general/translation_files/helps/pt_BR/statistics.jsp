...
<p class="head_description">Cyclos possui uma seção para análise
...
onde nunca é possível a exatidão dos números.</p>
<i>Onde encontrar.</i>
<br>
Você pode acessar esta seção através do &quot;Menu: Relatório > Análise
estatística&quot;.
<p><i>Como ativar.</i> As estatísticas possuem uma <a
...
&quot;estatísticas&quot;.
<p>Se você quiser pode usar certos <a
...
<p><b><u>Cuidado:</u> Por favor lembre-se que cálculos
...
<p>O &quot;período principal&quot; é o período sobre o qual as
...
&quot;filtros&quot;.
<p>Dependendo de quais itens você escolher, nem todos os filtros
...
<ul>
	...
	<p>Para criar um novo filtro de pagamento para estatísticas:
	<ol>
...
<p>Nem todos os filtros são usados para todos os tipos de
...
nos gráficos.
<p>Se você posicionar o mouse sobre uma barra da gráfico, o valor
...
<p>As seguintes linhas são exibidas nesta tabela:
<ul>
...
Por favor veja a <a href="#results"><u>seção de resultados
gerais</u></a> para convenções gerais nas estatísticas do cyclos.
<p>As únicas linhas mostram o <a href="#grossProduct"><u>produto
...
Por favor veja a <a href="#results"><u>seção de resultados
gerais</u></a> para convenções gerais nas estatísticas do cyclos.
<p>As únicas linhas mostram o <a href="#numberOfTransactions"><u>número
...
Por favor veja a <a href="#results"><u>seção de resultados
gerais</u></a> para convenções gerais nas estatísticas do cyclos.
<p>As únicas linhas mostram o valor <a href="#median"><u>mediano</u></a>
...
Por favor veja a <a href="#results"><u>seção de resultados
gerais</u></a> para convenções gerais nas estatísticas do cyclos.
<p>As únicas linhas mostram o valor máximo por transação, de acordo
...
Por favor veja a <a href="#results"><u>seção de resultados
gerais</u></a> para convenções gerais nas estatísticas do cyclos.
<p>As seguintes colunas são exibidas:
<ul>
...
<p>Observe que os primeiros três itens são <i>no final do
...
Por favor veja a <a href="#results"><u>seção de resultados
gerais</u></a> para convenções gerais nas estatísticas do cyclos.
<p>Se você escolheu &quot;através do tempo&quot; uma visão geral
...
Por favor veja a <a href="#results"><u>seção de resultados
gerais</u></a> para convenções gerais nas estatísticas do cyclos.
<p>Esta tabela mostra a <a href="#median"><u>mediana</u></a> do <a
...
que você escolheu.
<p>Para &quot;comparação de períodos&quot;, as colunas mostram o
...
Obviamente, tudo de acordo com os <a href="#filters"><u>filtros</u></a>
que você escolheu.
<p>Para &quot;comparação de períodos&quot;, as colunas mostram os
...
Por favor veja a <a href="#results"><u>seção de resultados
gerais</u></a> para convenções gerais nas estatísticas do cyclos.
<p>Apenas uma linha é exibida, indicando a porcentagem de membros
...
Por favor veja a <a href="#results"><u>seção de resultados
gerais</u></a> para convenções gerais nas estatísticas do cyclos.
<p>Apenas uma linha é exibida, indicando o número de acesso por
...
Por favor veja a <a href="#results"><u>seção de resultados
gerais</u></a> para convenções gerais nas estatísticas do cyclos.
<p>Esta tabela da uma visão geral da <a href="#median"><u>mediana</u></a>
...
Por favor veja a <a href="#results"><u>seção de resultados
gerais</u></a> para convenções gerais nas estatísticas do cyclos.
<p>Esta tabela da uma visãp geral da porcentagem de membros não
transacionando durante um <a href="#periods"><u>período</u></a>, sobre o
intervalo de tempo especificado.
<p>Um membro é considerado &quot;não transacionando&quot; caso ele
...
Por favor veja a <a href="#results"><u>seção de resultados
gerais</u></a> para convenções gerais nas estatísticas do cyclos.
<p>Esta tabela da uma visão geral histórica da <a href="#median"><u>mediana</u></a>
...
Por favor veja a <a href="#results"><u>seção de resultados
gerais</u></a> para convenções gerais nas estatísticas do cyclos.
<p>Este gráfico da um <a href="#histo"><u>histograma</u></a> do <a
...
Por favor veja a <a href="#results"><u>seção de resultados
gerais</u></a> para convenções gerais nas estatísticas do cyclos.
<p>Este gráfico da um <a href="#histo"><u>histograma</u></a> do
...
Por favor veja a <a href="#results"><u>seção de resultados
gerais</u></a> para convenções gerais nas estatísticas do cyclos.
<p>Esta tabela da os dez membros com os maiores <a
...
Por favor veja a <a href="#results"><u>seção de resultados
gerais</u></a> para convenções gerais nas estatísticas do cyclos.
<p>Esta tabela da os dez membros com os maiores números de acessos
...
Por favor veja a <a href="#results"><u>seção de resultados
gerais</u></a> para convenções gerais nas estatísticas do cyclos.
<p>Esta tabela da uma visão geral dos pagamentos de entrada e saída
para a conta de sistema especificada. A coluna final mostra a diferença
entre receita e despesa.
<p>Os <a href="#filters"><u>filtros</u></a> de pagamentos que você
...
<p>Se você selecionar apenas um filtro de pagamento, então este
...
Por favor veja a <a href="#results"><u>seção de resultados
gerais</u></a> para convenções gerais nas estatísticas do cyclos.
<p>Esta tabela ou gráfico da uma visão geral da receita (no caso de
...
<p>Para manter uma visão geral, sugerimos não selecionar muitos
...
Por favor veja a <a href="#results"><u>seção de resultados
gerais</u></a> para convenções gerais nas estatísticas do cyclos.
<p>Esta tabela da uma visão geral das categorias de receitas (ou
...
<p>Um intervalo de confiança é uma indicação da precisão dos dados.
...
<p>Intervalos de confiança são normalmente calculados na suposição
...
<p>Em estatísticas, um resultado é baseado em um conjunto de
...
<p>Produto bruto é a soma dos valores de todas as transações de <b>entrada</b>
sobre um certo <a href="#periods"><u>período</u></a>. Assim todas as
unidades ganhas em um período.
<hr class='help'>

<a name="histo"></a> <b>Histograma</b>
<p>Um histograma é um gráfico mostrando quantas observações são
...
<p><b>Nota:</b> O programa calcula automaticamente a melhor divisão
...
<p>Normalmente, o meio ou a média seria usado para indicar o valor
...
<p>No caso do cálculo da mediana de um conjunto de inteiros (= todos
...
inteiros.
<p>Usar a mediana em vez da média tem poucas <b>consequências</b>:
<ul>
...
<p>Estes são membros que tem 0 transações. Assim nenhuma transação
de entrada bem como nenhuma de saída.
<hr class='help'>

<a name="N"></a> <b>n</b>
<p>o número de itens em um conjunto de números.
<hr class='help'>

<a name="numberOfTransactions"></a> <b>Número de transações</b>
<p>Ao contrário do <a href="#grossProduct"><u>produto bruto</u></a>,
para a soma de algumas transações, ambas transações de entrada e saída
de um membro são contadas.
<hr class='help'>

<a name="p"></a> <b>Valor-p</b>
<p>Ao comparar dois ou mais <a href="#periods"><u>períodos</u></a>,
...
<p>Um teste estatístico é normalmente realizado se você quiser saber
