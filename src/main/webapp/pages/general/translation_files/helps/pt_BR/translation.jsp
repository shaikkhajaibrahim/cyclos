...
<span class="admin">
<p class="head_description">Cyclos suporta diferentes idiomas, e
...
cyclos, e todas as notificações enviadas por email.</p>
...
de conteúdo</u></a>.
<p>Nota2: Se você quiser alterar o idioma do cyclos, este não é o
...
<p>Se você não estiver contente com uma tradução, como ela aparece
...
<p>Você também pode adicionar ou remover completamente um par de
...
<p>É possível também adicionar uma nova chave de tradução; caso você
...
<p>Note: Se você quiser alterar o idioma do cyclos, este não é o
lugar. O idioma pode ser alterado no bloco de
&quot;internacionalização&quot; das <a
	href="${pagePrefix}settings#local"><u>Menu: Configurações >
configurações locais</u></a>.<br>
...
selecionadas&quot;.
<p>Observe que remover chaves pode ser complicado, você deve ler
...
<p>Primeiro você deve decidir sobre &quot;oque fazer&quot;. Existe
quatro opções:
<ul>
...
<p>Note: Não é necessário que o arquivo a ser importado contenha
...
<p>No cyclos, para cada idioma existe um arquivo de idioma. Este
...
<p>As chaves de tradução são colocadas nas páginas da aplicação;
...
<p>Os valores de tradução são palavras e termos em seu próprio
