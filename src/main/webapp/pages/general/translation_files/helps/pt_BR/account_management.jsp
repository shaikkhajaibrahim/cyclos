...
<p class="head_description">Todas as configurações relacionadas à
contas e transações pode ser feita na função de gerenciamento de contas.</p>
...
<p>Cyclos Vem com um banco de dados com varias <a
...
ativa-las.
<p>O banco de dados vêm com as seguintes Contas de sistema padrões:
...
<p>Para criar uma nova conta de membro ou de sistema você deverá
...
<p>Nota1: As permissões de um tipo de transação são definidas por
grupo e podem ser configuradas no &quot;Menu: Usuários & grupos > Grupos
de permissões > editar permissões do grupo.&quot;
<p>Nota2: Se a conta selecionada for uma conta de membro as
...
<p><b><a href="#account_fees"><u>Taxas periódicas</u></a> (=
...
<p><b><a href="#transaction_fees"><u>Taxas de transação</u></a></b>.
...
autorização</u></a>.
<p>Existem vários níveis possíveis de autorização, e pode existir
...
<p>Esta janela mostrará todos os níveis de autorização para o tipo
...
<p>Se você desmarcar a opção de autorização no tipo de transação,
...
aparecer.
<p>Se um pagamento autorizado gera outros pagamentos ( ex.
...
clique no ícone de edição <img border="0" src="${images}/edit.gif"
	width="16" height="16">&nbsp;.
<p>A administração e visão geral das taxas de contas é feita através
...
<p>A janela mostrará uma lista com as taxas de contas ativas
(habilitadas), a última e a próxima data de execução e o seu estado.
(&quot;falhou&quot;, &quot;concluída&quot;).
<p>Cada taxa de conta pode ser automática (agendada) ou manual.
...
<p>Se uma taxa de conta falhou, um alerta sera mostrado nos alertas
...
<p>As seguintes opções de configurações estão disponíveis:</b>
<ul>
...
<p>Com esta função, um limite de crédito individual, pode ser
...
<p>O limite superior de crédito é uma função raramente usada. Quando
