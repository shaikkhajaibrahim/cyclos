...
<p class="head_description">A função de contabilidade pode ser usada
para unir &quot;contas externas&quot;, como contas bancárias ou contas
de outros sistemas monetários, à contas do sistema Cyclos.
<p>Como a função de contabilidade permite ter um espelhamento
...
transações.
<p>Um uso típico do módulo de contabilidade é para controlar o
...
<p>É possível gerar automaticamente tipos de transações específicas
...
<p>O controle do &quot;respaldo&quot; é apenas um exemplo de uso do
...
trocar o estado de um empréstimo em um sistema local.</p>
...
(Contabilidade)&quot;.
<p>Antes de estar apto a importar novas transações externas no
...
<P>Quando você ver esta janela pela primeiro vez não terá nenhum
...
<p>Uma vez que exista itens na lista você pode fazer algumas
operações.
<ul>
...
<p><b>Obs:</b> Você pode usar um campo apenas uma vez. Isto
...
<p>A janela funciona de uma maneira simples. Você pode apenas clicar
...
<p>As seguintes ações são possíveis em cada transação.
<ul>
	<li><img border="0" src="${images}/preview.gif" width="16"
...
listadas.
<p>Nota: Apenas as transações que são resultados de uma busca da
...
<p>Esta janela da uma visão geral dos pagamentos processados. Em
...
<p>Existe três tipos de processamento.
<ul>
