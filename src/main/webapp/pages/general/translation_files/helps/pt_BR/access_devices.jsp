...
<a name="top"></a>
<p class="head_description">Um dispositivo de acesso é um meio de
...
cartão</u></a> que é como um modelo para o cartão.</p>
</span>
...
<p><b>Obs:</b> As ações para cartões irão solicitar a senha de
