...
<p class="head_description">Cyclos possui uma categorização dos
...
<p>O fato do membro poder estar apenas em um grupo não significa que
...
<p>Cyclos vem com uma série de grupos padrões. Normalmente estes
...
sistema.
<p><span class="admin"> <i>Onde encontrar.</i><br>
...
<p>O grupo de removidos atua meramente como a função de um arquivo.
...
<p>Veja a <a href="${pagePrefix}brokering"><u>seção de
...
&quot;enviar&quot;.
<p>Clique aqui para uma visão geral sobre<a href="#member_groups"><u>grupos
de membros</u></a>.
<p>Após enviar sua troca de grupo, ela é colocada na caixa de
...
<p>Algumas observações em alterações de grupos:
<ul>
...
<p>Após ter efetuado a alteração, ela é colocada na caixa de
histórico, em ordem cronológica, a mais nova no topo. O histórico de
comentários mostra acima qualquer comentário, uma linha de estado com o
nome do administrador que efetuou a troca, a data e a atual troca de
grupo que foi feita (&quot; do grupo X para o Y&quot;).
<p>Deste forma os administradores pode ter uma rápida visão geral
...
<p>Nesta janela existe a opção de remover um administrador
...
criar novos grupos.
<p>Você pode clicar nos seguintes itens para cada grupo listado:
<ul>
...
<p>Observe que você não pode definir permissões aqui; Propriedades
...
<p>As seguintes configurações do grupo estão disponíveis:
<ul>
...
mas você também pode usar o botão de atalho abaixo da janela chamado
&quot;Permissões do grupo&quot;.
<p>As configurações do grupo de membro estão ordenadas por
...
<a href="#edit_member_group"><u>modificar grupo de membro </u></a>
&quot;.
<p>Todas essas configurações e referem aos <a
...
mas você também pode usar o botão de atalho abaixo da janela chamado
&quot;Permissões do grupo&quot;.
<p>As configurações do grupo de corretor estão ordenadas por
categorias. As seguintes categorias estão disponíveis; Você pode clicar
nos links para obter detalhes sobre os campos destas categorias:
<ul>
	<li><b><a href="#group_details"><u>Detalhes do grupo</u></a></b>
...
<p>Note: Após criar um grupo não é possível alterar o tipo e o
estado do grupo.
<hr class="help">
</span>
...
cada grupo.
<p>Você pode modificar as configurações de da conta clicando no
...
<p>Você também pode remover um tipo de conta deste grupo clicando no
...
<p>Você pode associar um novo tipo de conta para este grupo,
...
customizados&quot;.
<p>Esta janela mostra uma visão geral dos arquivos customizados para
...
aqui</u></a>.
<p>Note: Quando você quiser inserir imagens em arquivos estáticos,
...
<p class="sub_description">No cyclos, as permissões são organizadas
...
contabilidade, administradores de vales, etc.. </p>
...
<p>A estrutura das permissões é bastante simples. A maioria das
...
apagar.
<p>Na primeira caixa de seleção (&quot;Gerenciar grupos:&quot;) você
...
<p>As seguintes permissões podem ser definidas - você pode usar os
...
<p>Se a função possuir permissões específicas (além das de ver e
