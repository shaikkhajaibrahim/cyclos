...
<p class="head_description">Cyclos permite a você mudar a interface
...
e aparências podem ser manipulados.</p>
...
para faze-lo.
<p>Note que você não pode apenas customizar arquivos a nível de
...
<p>A função permite modificar os seguintes arquivos estáticos (esta
...
<p>Você também pode inserir <a href="#insert_images"><u>imagens</u></a>
...
<p>Para evitar problemas o Cyclos sempre irá manter uma cópia da <a
	href="#edit_customized_file"><u> página original</u></a> que pode ser
revertida facilmente.</p>
<p>Você também pode inserir <a href="#insert_images"><u>imagens</u></a>
...
<p>Cyclos tem os seguintes arquivos de estilo:
<ul>
	<li><b>style.css</b><br>
...
<p>Para ver o efeito das mudanças do arquivo CSS você vai precisar
...
<p>Se você quiser usar um novo arquivo css, você pode apenas copiar
...
acima.
<p>Se você tiver conseguido fazer um arquivo CSS agradável, você é
...
%&gt;</i>
<p>e a localização da imagem sera algo como:
<p><i>&lt;img src="&lt;html:rewrite
page="/pages/images/some_image.jpg"/&gt;"&gt;</i>
<p>A página precisa apenas da tag 'html:rewrite' para a localização
...
<p>Esta janela mostra uma lista com os arquivos que ja foram <a
...
<p>Nesta janela você pode modificar novamente um arquivo que já
...
&quot;enviar&quot;.
<p>Quando você salvar as alterações do arquivo customizado, o
...
conteúdo original.
<p>Quando você para de customizar um arquivo (removendo ele da
...
<p>Esta janela mostrará uma lista com as <a href="#images"><u>imagens</u></a>
...
substituir uma imagem de sistema através da janela <a
	href="#images_upload"><u> atualizar imagem de sistema</u></a> abaixo.</p>
<hr class="help">
...
mensagens.
<p>Você pode apagar uma imagem clicando no ícone <img border="0"
	src="${images}/delete.gif" width="16" height="16">&nbsp;apagar.<br>
Você pode adicionar uma imagem customizada através da janela <a
	href="#images_upload"><u>nova imagem customizada</u></a> abaixo.</p>
<hr class="help">

<A NAME="style_images"></A>
<h3>Imagens de folha de estilo</h3>
<p>Imagens de folha de estilo são <a href="#images"><u>imagens</u></a>
...
Você pode adicionar uma imagem de folha de estilo através da janela <a
	href="#images_upload"><u>nova imagem de folha de estilo</u></a> abaixo.</p>
<hr class="help">

<A NAME="images_upload"></A>
<h3>Envio de imagens</h3>
<p>No caso de uma <a href="#system_images"><u>imagem de
...
imagem irá aparecer na janela acima.</p>
<hr class="help">
...
<p>Para selecionar outro <a href="#themes"><u>tema</u></a> você deve
...
<p>Quando você clicar no botão &quot;Remover&quot; o tema
...
<p>Com esta função você pode importar um <a href="#themes"><u>tema</u></a>.
...
<p>Se você criou o seu próprio <a href="#themes"><u>tema</u></a>
...
<p><i>Se você desenvolveu o seu próprio tema, considere envia-lo
