...
<a name="top"></a>
<p class="head_description">A função de operadores permite aos
...
procurar por pagamentos feitos por operadores.</p>
...
<p><span class="admin"> <i>Como ativar.</i><br>
...
operadores&quot;.
<p><b>Note:</b> Se você customizar a página de acesso, tenha cuidado
...
<p><b>Note 2:</b> O módulo de operadores e as suas operações são
...
<p>Você também pode criar um novo operador. Isto é feito
...
<p>Caso este operador esteja conectado neste momento, isto será
...
<p>As seguintes ações estão disponíveis:
<UL>
...
item.
<p>O operador que pertence a este grupo pode receber estas
permissões (dependem das configurações do sistema e das suas próprias
permissões):
<p><b>Conta de membro</b>
<ul>
...
<p>Clicando na opção &quot;Remover permanentemente&quot; irá remover
