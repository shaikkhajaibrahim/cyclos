...
<p class="head_description">Frequentemente, organizações que usam o
...
.
<p>A lista mostra todos os campos customizados que estão definidos
...
<p>O nome e configuração dos campos pode ser modificado, clicando no
...
visibilidade.
<p>Clicando no botão &quot;Alterar ordem dos campos&quot; você terá
...
<a href="${pagePrefix}member_records"><u>registros de membros</u></a>
.
<p>Aqui você pode definir a ordem em que os campos customizados irão
...
<p>Você pode apagar um valor clicando no ícone apagar. Isto funciona
...
<p>Se o seu campo possuir um <a href="#parent_field"><u>campo
