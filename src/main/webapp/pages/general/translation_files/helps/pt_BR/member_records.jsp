...
<a NAME="top"></a>
<p class="head_description">Registros de membros são tipos de
...
maneiras deles serem exibidos. (explicado depois).</p>
<span class="admin">
<p>Este manual possui um pequeno menu de <a href="#guidelines"><u>orientação</u></a>
...
<span class="broker">
<p>Esses registros de membros são informações adicionais associadas
...
<p>Em adicional para modificar as propriedades de um registro, você
