...
<p class="head_description">Cyclos possui uma senha para acesso, e
...
.
<p><span class="broker admin"> A senha de acesso de um membro
...
<p>A senha de transação é gerenciada na página de gerenciamento do
...
<p>Um administrador (com as permissões apropriadas) pode reiniciar
...
<p>Você também pode reiniciar a senha de transação através do botão
...
&quot;Enviar&quot;.
<p>Quando a senha PIN é informada de forma errada, ela pode ser
