...
<a name="top"></a>
<p class="head_description">Cyclos permite a você &quot;enviar
...
nunca podem rejeitar uma fatura enviada de contas de sistema.</p>
...
<p>No &quot;Menu Conta > Faturas eletrônicas&quot; você pode ver e
...
<p>Você terá que preencher os seguintes campos:
<ul>
...
<p>Esta janela da a você a opção de ter uma visão geral das <a
...
<p>Você pode filtrar pelos seguintes campos:
<ul>
...
abaixo</u></a>.
<p>Note: Procurar por faturas com um estado diferente de
...
<p>Na opção avançado você refina a busca usando alguns ou todos os
...
<p>Esta janela da a você uma visão geral das <a href="#top"><u>faturas
...
<p>Note: Procurar por faturas com o estado diferente de
