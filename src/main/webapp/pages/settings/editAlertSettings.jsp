    ...
    <tr>
        <td colspan="2" align="left" class="tdContentTableForms">
            <table class="defaultTable">
                <tr>
                    <td class="label" width="30%"><bean:message key="settings.alert.alertNewPendingMembers"/></td>
                    <td><html:checkbox property="setting(alertNewPendingMembers)" value="true" styleClass="checkbox InputBoxDisabled" disabled="true"/></td>
                </tr>
                <tr>
                    <td class="label"><bean:message key="settings.alert.givenVeryBadRefs"/></td>
                    <td>
                ...
                <c:if test="${cyclos:granted('systemSettings', 'manageAlert')}">
	                <tr>
