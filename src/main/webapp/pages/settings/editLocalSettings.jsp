...
<html:hidden property="setting(charset)" />
            ...
            <fieldset>
		        ...
		        <table class="defaultTable">
					<tr>
                   		...
                   		<td><html:checkbox property="setting(enableTransactionNumber)" styleId="transactionNumberCheck" styleClass="checkbox InputBoxDisabled" disabled="true" value="true" /></td>
                   	</tr>
