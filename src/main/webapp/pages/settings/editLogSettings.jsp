    ...
    <tr>
        <td colspan="2" align="left" class="tdContentTableForms">
            <table class="defaultTable">
                <tr>
                    <td class="label" width="30%"><bean:message key="settings.log.traceLevel"/></td>
                    <td>
                ...
                <tr>
                    <td class="label" width="30%"><bean:message key="settings.log.transactionLevel"/></td>
                    <td>
                ...
                <tr>
                    <td class="label" width="30%"><bean:message key="settings.log.accountFeeLevel"/></td>
                    <td>
                ...
                <tr>
                    <td class="label" width="30%"><bean:message key="settings.log.scheduledTaskLevel"/></td>
                    <td>
                ...
                <c:if test="${cyclos:granted('systemSettings', 'manageLog')}">
	                <tr>
