		...
		<tr>
		    <td colspan="4" align="left" class="tdContentTableForms">
	    	  	<cyclos:layout columns="4" className="defaultTable">
					...
					<c:if test="${canAcceptLoan}">
	                	<bean:message key="guarantee.automaticLoanAuthorization"/><html:checkbox property="automaticLoanAuthorization" value="true"></html:checkbox>
	                </c:if>
					
					<input type="submit" class="button" value="<bean:message key="guarantee.action.accept"/>"></cyclos:cell>
				</cyclos:layout>
			</td>
		</tr>
	</table>
