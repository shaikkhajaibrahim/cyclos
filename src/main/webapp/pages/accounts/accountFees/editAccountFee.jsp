...
<script>
	...
	var disablingConfirmation = null;
	<c:if test="${shouldConfirmWhenDisabling}">
		disablingConfirmation = "<cyclos:escapeJS><bean:message key="accountFee.disableConfirmation" /></cyclos:escapeJS>";
	</c:if>
</script>
    ...
    <tr>
        <td colspan="2" align="left" class="tdContentTableForms">
            <table class="defaultTable">
				...
				<tr id="trTolerance" style="display:none">
					<td class="label"><bean:message key='accountFee.tolerance'/></td>
					<td>
                    	<html:text styleId="toleranceNumberText" property="accountFee(tolerance).number" maxlength="2" styleClass="tiny number InputBoxDisabled" readonly="true"/>
                    	<html:select styleId="toleranceFieldSelect" property="accountFee(tolerance).field" styleClass="InputBoxDisabled" disabled="true">
	                   		<c:forEach var="field" items="${toleranceFields}">
