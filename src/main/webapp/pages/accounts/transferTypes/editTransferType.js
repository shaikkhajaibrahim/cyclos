...
Behaviour.register({
	...
	'#isLoanCheckBox': function(checkbox) {
		checkbox.onclick = updateLoanFields;
	},
	...
	'#availabilitySelect': function(select) {
		select.onchange = updateAvailabilityFields;
	},
	...
	'img.fieldDetails': function(img) {
		setPointer(img);
		img.onclick = function() {
			self.location = pathPrefix + "/editCustomField?fieldId=" + img.getAttribute("fieldId") + "&transferTypeId=" + transferTypeId;
		}
	},
	...
	'img.removeField': function(img) {
		...
		img.onclick = function() {
			if (confirm(removeFieldConfirmationMessage)) {
				...
				self.location = pathPrefix + "/removeCustomField?fieldId=" + fieldId + "&transferTypeId=" + transferTypeId;
			}
		}
	},
	...
	'#saveLinkedCustomFieldButton': function(button) {
		button.onclick = function() {
			...
			var params = $H({
				...
				'accountTypeId': getValue('accountTypeId'),
