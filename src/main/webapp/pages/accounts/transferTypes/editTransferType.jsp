    ...
    <tr>
        <td colspan="2" align="left" class="tdContentTableForms">
            <table class="defaultTable">
				...
				<tr id="trAllowsScheduledPayments" style="display:none">
				...
				<tr class="trScheduling" style="display:none">
				...
				<c:if test="${!isSystemAccount && (isInsert || !transferType.toSystem)}">
					<tr id="trRequiresFeedback" style="${isInsert ? 'display:none' : ''}">
					...
					<tr class="feedbackRequired" style="display:none">
				...
				<tr>
					<td align="right" colspan="2">
						<c:if test="${cyclos:granted('systemAccounts', 'manage')}">					
	                ...
	                <c:forEach var="field" items="${customFields}">
		                ...
		                <tr class="<t:toggle>ClassColor1|ClassColor2</t:toggle>">
		                    ...
		                    <td align="center" nowrap="nowrap">
		                    	<c:choose><c:when test="${cyclos:granted('systemAccounts', 'manage')}">
		                    		<c:choose><c:when test="${owned}">
...
<c:if test="${not isInsert && transferType.requiresAuthorization}">
	...
	<c:if test="${insertNewLevel && cyclos:granted('systemAccounts', 'manage')}">
