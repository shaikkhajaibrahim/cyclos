				...
				<cyclos:layout columns="4" className="defaultTable">
					...
					<c:if test="${isAdmin and (not empty dRate or not empty aRate)}">
						...
						<c:if test="${not empty aRate}">
							<cyclos:cell width="20%" className="headerLabel"><bean:message key="account.aRate"/></cyclos:cell>
						...
						<c:if test="${not empty dRate}">
							<cyclos:cell width="20%" className="headerLabel"><bean:message key="account.dRate"/></cyclos:cell>
							<cyclos:cell width="30%">
			...
			<table class="defaultTable">
				...
				<c:forEach var="entry" items="${accountHistory}">
					...
					<tr class="<t:toggle>ClassColor1|ClassColor2</t:toggle>">
						...
						<td align="center"><cyclos:format date="${transfer.processDate == null ? transfer.date : transfer.processDate}"/></td>
						<td align="left">
