		...
		<tr>
			<td colspan="2" align="left" class="tdContentTableForms">
				<cyclos:layout columns="4" className="defaultTable">
					...
					<!-- Expiration From -->
					<cyclos:cell className="nestedLabel"><span class="label"><bean:message key='card.expirationPeriod.from'/></span></cyclos:cell>
				            ...
				            <table class="defaultTable">
				                ...
				                <c:forEach var="card" items="${cards}">
				                	<tr class="<t:toggle>ClassColor1|ClassColor2</t:toggle>">
					                    ...
					                    <td align="left"><cyclos:format date="${card.expirationDate}"/></td>
...
<c:if test="${listOnly && (cyclos:granted('adminMemberCards', 'generate') || cyclos:granted('brokerCards', 'generate')) && ((!isFromMenu && isBroker) || !isBroker)}">
