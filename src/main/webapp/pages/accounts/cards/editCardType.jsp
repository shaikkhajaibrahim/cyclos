    ...
    <tr>
        <td colspan="2" align="left" class="tdContentTableForms">
            <table class="defaultTable">
   				<tr>
            		<td class="label" width="25%"><bean:message key="cardType.name"/></td>
				...
				<tr>
            		...
            		<td>
	                    ...
	                    <span class="fieldDecoration">0 never expires</span>
					</td>            		
            	</tr>
            	<tr>
            	...
            	<tr>
            		...
            		<td>
            			<c:forEach var="cardSecurityCode" items="${cardSecurityCodes}">
                    		<html:radio property="cardType(cardSecurityCode)" value="${cardSecurityCode}" styleClass="radio cardSecurityCodeSelect" disabled="true"/><bean:message key="cardType.cardSecurityCode.${cardSecurityCode}"/>
                   		</c:forEach>            			
            		</td>
            	</tr>
            	...
            	<tr class="trSecCode" style="display:none">
            		<td class="label">
            			<bean:message key="cardType.cardSecurityCodeLength" />&nbsp;<span class="label"><bean:message key="global.min" /></span>
            		</td>
            		<td>
