            ...
            <table class="defaultTable">
                <tr>
                    ...
                    <td>
                   		<c:forEach var="tradeType" items="${tradeTypes}">
                    		<label><html:radio property="ad(tradeType)" value="${tradeType}" styleClass="radio" disabled="true"/><bean:message key="ad.tradeType.${tradeType}"/></label>
                   		</c:forEach>
                    </td>
                ...
                <c:if test="${editable}">
			        ...
			        <tr class="trPicture" style="display:none">
						...
						<td colspan="2">						
							<html:file property="picture" styleId= "pictureFile" styleClass="InputBoxDisabled upload" disabled="true"/>
						</td>
					</tr>
			        <tr class="trPicture" style="display:none">
