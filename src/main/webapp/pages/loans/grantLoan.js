...
function setResponsible() {
	var params = $H();
	params['context'] = 'LOAN';
	params['toOwnerId'] = getValue("responsibleSelect");
	params['loanData'] = "true";
...
Behaviour.register({
	...
	'#showProjectionButton': function(button) {
		button.onclick = function() {
			var params = $H();
			params['transferType'] = getValue('transferType');
			params['amount'] = getValue('amount');
			params['date'] = getValue('dateText');
			params['firstExpirationDate'] = getValue('loan(firstRepaymentDate)');
			params['paymentCount'] = getValue('loan(paymentCount)');
	...
	'#calculatePaymentsButton': function(button) {
		button.onclick = function() {
			...
			params['amount'] = getValue('amount');
			params['date'] = getValue('dateText');
			params['firstExpirationDate'] = getValue('firstExpirationDate');
			params['paymentCount'] = getValue('paymentCount');
